...
If your want to run kubenav in your Kubernetes cluster, simply run the following commands and open [localhost:14122](http://localhost:14122) in your browser:
