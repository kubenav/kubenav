...
part 'addonlist_k3s_v1.g.dart';

///AddonList is a list of Addon
@JsonSerializable()
class AddonlistK3SV1 {
  ...
  @JsonKey(name: 'kind')
  AddonlistK3SV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  AddonlistK3SV1Metadata? metadata;
  ...
  factory AddonlistK3SV1.fromJson(Map<String, dynamic> json) =>
      _$AddonlistK3SV1FromJson(json);

  Map<String, dynamic> toJson() => _$AddonlistK3SV1ToJson(this);
}
...
final itemKindValues = EnumValues({'Addon': ItemKind.ADDON});
...
class Spec {
  ...
  Spec({this.checksum, this.source});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum AddonlistK3SV1Kind {
  @JsonValue('AddonList')
  ADDON_LIST,
}

final addonlistK3Sv1KindValues = EnumValues({
  'AddonList': AddonlistK3SV1Kind.ADDON_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class AddonlistK3SV1Metadata {
  ...
  factory AddonlistK3SV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$AddonlistK3SV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$AddonlistK3SV1MetadataToJson(this);
}
