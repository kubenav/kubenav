...
part of 'addonlist_k3s_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AddonlistK3SV1 _$AddonlistK3SV1FromJson(Map<String, dynamic> json) =>
    AddonlistK3SV1(
      ...
      items: (json['items'] as List<dynamic>)
          ...
          .toList(),
      kind: $enumDecodeNullable(_$AddonlistK3SV1KindEnumMap, json['kind']),
      metadata: json['metadata'] == null
          ? null
          : AddonlistK3SV1Metadata.fromJson(
              json['metadata'] as Map<String, dynamic>,
            ),
    );

Map<String, dynamic> _$AddonlistK3SV1ToJson(AddonlistK3SV1 instance) =>
    <String, dynamic>{
      'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
      'items': instance.items,
      'kind': _$AddonlistK3SV1KindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$ApiVersionEnumMap = {ApiVersion.K3_S_CATTLE_IO_V1: 'k3s.cattle.io/v1'};

const _$AddonlistK3SV1KindEnumMap = {
  AddonlistK3SV1Kind.ADDON_LIST: 'AddonList',
};
...
const _$ItemKindEnumMap = {ItemKind.ADDON: 'Addon'};
...
AddonlistK3SV1Metadata _$AddonlistK3SV1MetadataFromJson(
...
Map<String, dynamic> _$AddonlistK3SV1MetadataToJson(
  AddonlistK3SV1Metadata instance,
) => <String, dynamic>{
