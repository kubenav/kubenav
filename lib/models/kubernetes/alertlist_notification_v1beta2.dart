...
part 'alertlist_notification_v1beta2.g.dart';

///AlertList is a list of Alert
@JsonSerializable()
class AlertlistNotificationV1Beta2 {
  ...
  @JsonKey(name: 'kind')
  AlertlistNotificationV1Beta2Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  AlertlistNotificationV1Beta2Metadata? metadata;
  ...
  factory AlertlistNotificationV1Beta2.fromJson(Map<String, dynamic> json) =>
      _$AlertlistNotificationV1Beta2FromJson(json);

  Map<String, dynamic> toJson() => _$AlertlistNotificationV1Beta2ToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
enum ApiVersion {
  @JsonValue('notification.toolkit.fluxcd.io/v1beta2')
  NOTIFICATION_TOOLKIT_FLUXCD_IO_V1_BETA2,
}
...
final itemKindValues = EnumValues({'Alert': ItemKind.ALERT});
...
final eventSeverityValues = EnumValues({
...
final eventSourceKindValues = EnumValues({
  'Bucket': EventSourceKind.BUCKET,
  'GitRepository': EventSourceKind.GIT_REPOSITORY,
  'HelmChart': EventSourceKind.HELM_CHART,
  'HelmRelease': EventSourceKind.HELM_RELEASE,
  'HelmRepository': EventSourceKind.HELM_REPOSITORY,
  'ImagePolicy': EventSourceKind.IMAGE_POLICY,
  'ImageRepository': EventSourceKind.IMAGE_REPOSITORY,
  'ImageUpdateAutomation': EventSourceKind.IMAGE_UPDATE_AUTOMATION,
  'Kustomization': EventSourceKind.KUSTOMIZATION,
  'OCIRepository': EventSourceKind.OCI_REPOSITORY,
});
...
class ProviderRef {
  ...
  ProviderRef({required this.name});

  factory ProviderRef.fromJson(Map<String, dynamic> json) =>
      _$ProviderRefFromJson(json);

  Map<String, dynamic> toJson() => _$ProviderRefToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum AlertlistNotificationV1Beta2Kind {
  @JsonValue('AlertList')
  ALERT_LIST,
}

final alertlistNotificationV1Beta2KindValues = EnumValues({
  'AlertList': AlertlistNotificationV1Beta2Kind.ALERT_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class AlertlistNotificationV1Beta2Metadata {
  ...
  factory AlertlistNotificationV1Beta2Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$AlertlistNotificationV1Beta2MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$AlertlistNotificationV1Beta2MetadataToJson(this);
}
