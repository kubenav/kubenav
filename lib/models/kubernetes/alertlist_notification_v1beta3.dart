...
part 'alertlist_notification_v1beta3.g.dart';

///AlertList is a list of Alert
@JsonSerializable()
class AlertlistNotificationV1Beta3 {
  ...
  @JsonKey(name: 'kind')
  AlertlistNotificationV1Beta3Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  AlertlistNotificationV1Beta3Metadata? metadata;

  AlertlistNotificationV1Beta3({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory AlertlistNotificationV1Beta3.fromJson(Map<String, dynamic> json) =>
      _$AlertlistNotificationV1Beta3FromJson(json);

  Map<String, dynamic> toJson() => _$AlertlistNotificationV1Beta3ToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum AlertlistNotificationV1Beta3Kind {
  @JsonValue('AlertList')
  ALERT_LIST,
}

final alertlistNotificationV1Beta3KindValues = EnumValues({
  'AlertList': AlertlistNotificationV1Beta3Kind.ALERT_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class AlertlistNotificationV1Beta3Metadata {
  ...
  AlertlistNotificationV1Beta3Metadata({
  ...
  factory AlertlistNotificationV1Beta3Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$AlertlistNotificationV1Beta3MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$AlertlistNotificationV1Beta3MetadataToJson(this);
}
