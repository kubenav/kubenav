...
part of 'alertlist_notification_v1beta3.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

AlertlistNotificationV1Beta3 _$AlertlistNotificationV1Beta3FromJson(
  ...
  kind: $enumDecodeNullable(
    _$AlertlistNotificationV1Beta3KindEnumMap,
    json['kind'],
  ),
  metadata: json['metadata'] == null
      ? null
      : AlertlistNotificationV1Beta3Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$AlertlistNotificationV1Beta3ToJson(
  AlertlistNotificationV1Beta3 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$AlertlistNotificationV1Beta3KindEnumMap[instance.kind],
...
const _$AlertlistNotificationV1Beta3KindEnumMap = {
  AlertlistNotificationV1Beta3Kind.ALERT_LIST: 'AlertList',
};
...
_$AlertlistNotificationV1Beta3MetadataFromJson(Map<String, dynamic> json) =>
    AlertlistNotificationV1Beta3Metadata(
...
Map<String, dynamic> _$AlertlistNotificationV1Beta3MetadataToJson(
  AlertlistNotificationV1Beta3Metadata instance,
) => <String, dynamic>{
