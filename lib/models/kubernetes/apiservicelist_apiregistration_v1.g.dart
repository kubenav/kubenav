...
part of 'apiservicelist_apiregistration_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ApiservicelistApiregistrationV1 _$ApiservicelistApiregistrationV1FromJson(
  Map<String, dynamic> json,
) => ApiservicelistApiregistrationV1(
  ...
  kind: $enumDecodeNullable(
    _$ApiservicelistApiregistrationV1KindEnumMap,
    json['kind'],
  ),
  metadata: json['metadata'] == null
      ? null
      : ApiservicelistApiregistrationV1Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$ApiservicelistApiregistrationV1ToJson(
  ApiservicelistApiregistrationV1 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$ApiservicelistApiregistrationV1KindEnumMap[instance.kind],
  'metadata': instance.metadata,
};

const _$ApiVersionEnumMap = {
  ApiVersion.APIREGISTRATION_K8_S_IO_V1: 'apiregistration.k8s.io/v1',
};

const _$ApiservicelistApiregistrationV1KindEnumMap = {
  ApiservicelistApiregistrationV1Kind.API_SERVICE_LIST: 'APIServiceList',
};
...
const _$ItemKindEnumMap = {ItemKind.API_SERVICE: 'APIService'};
...
ApiservicelistApiregistrationV1Metadata
_$ApiservicelistApiregistrationV1MetadataFromJson(Map<String, dynamic> json) =>
    ApiservicelistApiregistrationV1Metadata(
...
Map<String, dynamic> _$ApiservicelistApiregistrationV1MetadataToJson(
  ApiservicelistApiregistrationV1Metadata instance,
) => <String, dynamic>{
