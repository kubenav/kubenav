...
part 'bucketlist_source_v1.g.dart';

///BucketList is a list of Bucket
@JsonSerializable()
class BucketlistSourceV1 {
  ...
  @JsonKey(name: 'kind')
  BucketlistSourceV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  BucketlistSourceV1Metadata? metadata;
  ...
  factory BucketlistSourceV1.fromJson(Map<String, dynamic> json) =>
      _$BucketlistSourceV1FromJson(json);

  Map<String, dynamic> toJson() => _$BucketlistSourceV1ToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum BucketlistSourceV1Kind {
  @JsonValue('BucketList')
  BUCKET_LIST,
}

final bucketlistSourceV1KindValues = EnumValues({
  'BucketList': BucketlistSourceV1Kind.BUCKET_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class BucketlistSourceV1Metadata {
  ...
  factory BucketlistSourceV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$BucketlistSourceV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$BucketlistSourceV1MetadataToJson(this);
}
