...
part 'bucketlist_source_v1beta2.g.dart';

///BucketList is a list of Bucket
@JsonSerializable()
class BucketlistSourceV1Beta2 {
  ...
  @JsonKey(name: 'kind')
  BucketlistSourceV1Beta2Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  BucketlistSourceV1Beta2Metadata? metadata;

  BucketlistSourceV1Beta2({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory BucketlistSourceV1Beta2.fromJson(Map<String, dynamic> json) =>
      _$BucketlistSourceV1Beta2FromJson(json);

  Map<String, dynamic> toJson() => _$BucketlistSourceV1Beta2ToJson(this);
}
...
final itemKindValues = EnumValues({'Bucket': ItemKind.BUCKET});
...
class Spec {
  ...
  SpecCertSecretRef? certSecretRef;
...
class AccessFrom {
  ...
  @JsonKey(name: 'namespaceSelectors')
  List<NamespaceSelector?> namespaceSelectors;

  AccessFrom({required this.namespaceSelectors});

  factory AccessFrom.fromJson(Map<String, dynamic> json) =>
      _$AccessFromFromJson(json);

  Map<String, dynamic> toJson() => _$AccessFromToJson(this);
}
...
class NamespaceSelector {
  ...
  NamespaceSelector({this.matchLabels});
...
@JsonSerializable()
class SpecCertSecretRef {
  ///Name of the referent.
  @JsonKey(name: 'name')
  String name;

  SpecCertSecretRef({required this.name});

  factory SpecCertSecretRef.fromJson(Map<String, dynamic> json) =>
      _$SpecCertSecretRefFromJson(json);

  Map<String, dynamic> toJson() => _$SpecCertSecretRefToJson(this);
}
...
class Sts {
  ...
  @JsonKey(name: 'certSecretRef')
  StsCertSecretRef? certSecretRef;
  ...
  factory Sts.fromJson(Map<String, dynamic> json) => _$StsFromJson(json);

  Map<String, dynamic> toJson() => _$StsToJson(this);
}
...
class StsCertSecretRef {
  ...
  StsCertSecretRef({required this.name});

  factory StsCertSecretRef.fromJson(Map<String, dynamic> json) =>
      _$StsCertSecretRefFromJson(json);

  Map<String, dynamic> toJson() => _$StsCertSecretRefToJson(this);
}
...
final stsProviderValues = EnumValues({
  'aws': StsProvider.AWS,
  'ldap': StsProvider.LDAP,
});
...
class StsSecretRef {
  ...
  StsSecretRef({required this.name});

  factory StsSecretRef.fromJson(Map<String, dynamic> json) =>
      _$StsSecretRefFromJson(json);

  Map<String, dynamic> toJson() => _$StsSecretRefToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum BucketlistSourceV1Beta2Kind {
  @JsonValue('BucketList')
  BUCKET_LIST,
}

final bucketlistSourceV1Beta2KindValues = EnumValues({
  'BucketList': BucketlistSourceV1Beta2Kind.BUCKET_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class BucketlistSourceV1Beta2Metadata {
  ...
  BucketlistSourceV1Beta2Metadata({
  ...
  factory BucketlistSourceV1Beta2Metadata.fromJson(Map<String, dynamic> json) =>
      _$BucketlistSourceV1Beta2MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$BucketlistSourceV1Beta2MetadataToJson(this);
}
