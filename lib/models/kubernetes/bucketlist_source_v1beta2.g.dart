...
part of 'bucketlist_source_v1beta2.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

BucketlistSourceV1Beta2 _$BucketlistSourceV1Beta2FromJson(
  ...
  items: (json['items'] as List<dynamic>)
      ...
      .toList(),
  kind: $enumDecodeNullable(_$BucketlistSourceV1Beta2KindEnumMap, json['kind']),
  metadata: json['metadata'] == null
      ? null
      : BucketlistSourceV1Beta2Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$BucketlistSourceV1Beta2ToJson(
  BucketlistSourceV1Beta2 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$BucketlistSourceV1Beta2KindEnumMap[instance.kind],
...
const _$BucketlistSourceV1Beta2KindEnumMap = {
  BucketlistSourceV1Beta2Kind.BUCKET_LIST: 'BucketList',
};
...
BucketlistSourceV1Beta2Metadata _$BucketlistSourceV1Beta2MetadataFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$BucketlistSourceV1Beta2MetadataToJson(
  BucketlistSourceV1Beta2Metadata instance,
) => <String, dynamic>{
