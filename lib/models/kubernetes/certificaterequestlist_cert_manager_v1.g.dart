...
part of 'certificaterequestlist_cert_manager_v1.dart';
...
_$CertificaterequestlistCertManagerV1FromJson(Map<String, dynamic> json) =>
    CertificaterequestlistCertManagerV1(
      ...
      kind: $enumDecodeNullable(
        _$CertificaterequestlistCertManagerV1KindEnumMap,
        json['kind'],
      ),
      metadata: json['metadata'] == null
          ? null
          : CertificaterequestlistCertManagerV1Metadata.fromJson(
              json['metadata'] as Map<String, dynamic>,
            ),
    );

Map<String, dynamic> _$CertificaterequestlistCertManagerV1ToJson(
  CertificaterequestlistCertManagerV1 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$CertificaterequestlistCertManagerV1KindEnumMap[instance.kind],
...
const _$CertificaterequestlistCertManagerV1KindEnumMap = {
...
const _$ItemKindEnumMap = {ItemKind.CERTIFICATE_REQUEST: 'CertificateRequest'};
...
_$CertificaterequestlistCertManagerV1MetadataFromJson(
...
Map<String, dynamic> _$CertificaterequestlistCertManagerV1MetadataToJson(
  CertificaterequestlistCertManagerV1Metadata instance,
) => <String, dynamic>{
