...
part 'clusterrolebindinglist_rbac_v1.g.dart';

///ClusterRoleBindingList is a collection of ClusterRoleBindings
@JsonSerializable()
class ClusterrolebindinglistRbacV1 {
  ...
  @JsonKey(name: 'kind')
  ClusterrolebindinglistRbacV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  ClusterrolebindinglistRbacV1Metadata? metadata;

  ClusterrolebindinglistRbacV1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory ClusterrolebindinglistRbacV1.fromJson(Map<String, dynamic> json) =>
      _$ClusterrolebindinglistRbacV1FromJson(json);

  Map<String, dynamic> toJson() => _$ClusterrolebindinglistRbacV1ToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
  @JsonValue('ClusterRoleBinding')
  CLUSTER_ROLE_BINDING,
}

final itemKindValues = EnumValues({
  'ClusterRoleBinding': ItemKind.CLUSTER_ROLE_BINDING,
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ClusterrolebindinglistRbacV1Kind {
  @JsonValue('ClusterRoleBindingList')
  CLUSTER_ROLE_BINDING_LIST,
}

final clusterrolebindinglistRbacV1KindValues = EnumValues({
  'ClusterRoleBindingList':
      ClusterrolebindinglistRbacV1Kind.CLUSTER_ROLE_BINDING_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class ClusterrolebindinglistRbacV1Metadata {
  ...
  ClusterrolebindinglistRbacV1Metadata({
  ...
  factory ClusterrolebindinglistRbacV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$ClusterrolebindinglistRbacV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ClusterrolebindinglistRbacV1MetadataToJson(this);
}
