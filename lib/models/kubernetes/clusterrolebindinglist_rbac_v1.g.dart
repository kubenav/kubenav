...
part of 'clusterrolebindinglist_rbac_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ClusterrolebindinglistRbacV1 _$ClusterrolebindinglistRbacV1FromJson(
  ...
  kind: $enumDecodeNullable(
    _$ClusterrolebindinglistRbacV1KindEnumMap,
    json['kind'],
  ),
  metadata: json['metadata'] == null
      ? null
      : ClusterrolebindinglistRbacV1Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$ClusterrolebindinglistRbacV1ToJson(
  ClusterrolebindinglistRbacV1 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$ClusterrolebindinglistRbacV1KindEnumMap[instance.kind],
...
const _$ClusterrolebindinglistRbacV1KindEnumMap = {
...
const _$ItemKindEnumMap = {ItemKind.CLUSTER_ROLE_BINDING: 'ClusterRoleBinding'};
...
_$ClusterrolebindinglistRbacV1MetadataFromJson(Map<String, dynamic> json) =>
    ClusterrolebindinglistRbacV1Metadata(
...
Map<String, dynamic> _$ClusterrolebindinglistRbacV1MetadataToJson(
  ClusterrolebindinglistRbacV1Metadata instance,
) => <String, dynamic>{
