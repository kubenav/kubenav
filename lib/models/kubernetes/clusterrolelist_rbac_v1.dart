...
part 'clusterrolelist_rbac_v1.g.dart';

///ClusterRoleList is a collection of ClusterRoles
@JsonSerializable()
class ClusterrolelistRbacV1 {
  ...
  @JsonKey(name: 'kind')
  ClusterrolelistRbacV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  ClusterrolelistRbacV1Metadata? metadata;
  ...
  factory ClusterrolelistRbacV1.fromJson(Map<String, dynamic> json) =>
      _$ClusterrolelistRbacV1FromJson(json);

  Map<String, dynamic> toJson() => _$ClusterrolelistRbacV1ToJson(this);
}
...
class AggregationRule {
  ...
  ///will be added
  @JsonKey(name: 'clusterRoleSelectors')
  List<ClusterRoleSelector?>? clusterRoleSelectors;

  AggregationRule({this.clusterRoleSelectors});

  factory AggregationRule.fromJson(Map<String, dynamic> json) =>
      _$AggregationRuleFromJson(json);

  Map<String, dynamic> toJson() => _$AggregationRuleToJson(this);
}

@JsonSerializable()
class ClusterRoleSelector {
  ...
  ClusterRoleSelector({this.matchExpressions, this.matchLabels});

  factory ClusterRoleSelector.fromJson(Map<String, dynamic> json) =>
      _$ClusterRoleSelectorFromJson(json);

  Map<String, dynamic> toJson() => _$ClusterRoleSelectorToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
  @JsonValue('ClusterRole')
  CLUSTER_ROLE,
}

final itemKindValues = EnumValues({'ClusterRole': ItemKind.CLUSTER_ROLE});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ClusterrolelistRbacV1Kind {
  @JsonValue('ClusterRoleList')
  CLUSTER_ROLE_LIST,
}

final clusterrolelistRbacV1KindValues = EnumValues({
  'ClusterRoleList': ClusterrolelistRbacV1Kind.CLUSTER_ROLE_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class ClusterrolelistRbacV1Metadata {
  ...
  factory ClusterrolelistRbacV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$ClusterrolelistRbacV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$ClusterrolelistRbacV1MetadataToJson(this);
}
