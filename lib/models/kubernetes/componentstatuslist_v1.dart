...
part 'componentstatuslist_v1.g.dart';

///Status of all the conditions for the component as a list of ComponentStatus objects.
///Deprecated: This API is deprecated in v1.19+
@JsonSerializable()
class ComponentstatuslistV1 {
  ...
  @JsonKey(name: 'kind')
  ComponentstatuslistV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  ComponentstatuslistV1Metadata? metadata;

  ComponentstatuslistV1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory ComponentstatuslistV1.fromJson(Map<String, dynamic> json) =>
      _$ComponentstatuslistV1FromJson(json);

  Map<String, dynamic> toJson() => _$ComponentstatuslistV1ToJson(this);
}
...
class Item {
  ...
  Item({this.apiVersion, this.conditions, this.kind, this.metadata});
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
  @JsonValue('ComponentStatus')
  COMPONENT_STATUS,
}

final itemKindValues = EnumValues({
  'ComponentStatus': ItemKind.COMPONENT_STATUS,
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ComponentstatuslistV1Kind {
  @JsonValue('ComponentStatusList')
  COMPONENT_STATUS_LIST,
}

final componentstatuslistV1KindValues = EnumValues({
  'ComponentStatusList': ComponentstatuslistV1Kind.COMPONENT_STATUS_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class ComponentstatuslistV1Metadata {
  ...
  factory ComponentstatuslistV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$ComponentstatuslistV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$ComponentstatuslistV1MetadataToJson(this);
}
