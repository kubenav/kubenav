...
part of 'componentstatuslist_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ComponentstatuslistV1 _$ComponentstatuslistV1FromJson(
  ...
  items: (json['items'] as List<dynamic>)
      ...
      .toList(),
  kind: $enumDecodeNullable(_$ComponentstatuslistV1KindEnumMap, json['kind']),
  metadata: json['metadata'] == null
      ? null
      : ComponentstatuslistV1Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$ComponentstatuslistV1ToJson(
  ComponentstatuslistV1 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$ComponentstatuslistV1KindEnumMap[instance.kind],
  'metadata': instance.metadata,
};

const _$ApiVersionEnumMap = {ApiVersion.V1: 'v1'};

const _$ComponentstatuslistV1KindEnumMap = {
  ComponentstatuslistV1Kind.COMPONENT_STATUS_LIST: 'ComponentStatusList',
};
...
const _$ItemKindEnumMap = {ItemKind.COMPONENT_STATUS: 'ComponentStatus'};
...
ComponentstatuslistV1Metadata _$ComponentstatuslistV1MetadataFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$ComponentstatuslistV1MetadataToJson(
  ComponentstatuslistV1Metadata instance,
) => <String, dynamic>{
