...
part 'configmaplist_v1.g.dart';

///ConfigMapList is a resource containing a list of ConfigMap objects.
@JsonSerializable()
class ConfigmaplistV1 {
  ...
  @JsonKey(name: 'kind')
  ConfigmaplistV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  ConfigmaplistV1Metadata? metadata;
  ...
  factory ConfigmaplistV1.fromJson(Map<String, dynamic> json) =>
      _$ConfigmaplistV1FromJson(json);

  Map<String, dynamic> toJson() => _$ConfigmaplistV1ToJson(this);
}
...
final itemKindValues = EnumValues({'ConfigMap': ItemKind.CONFIG_MAP});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ConfigmaplistV1Kind {
  @JsonValue('ConfigMapList')
  CONFIG_MAP_LIST,
}

final configmaplistV1KindValues = EnumValues({
  'ConfigMapList': ConfigmaplistV1Kind.CONFIG_MAP_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class ConfigmaplistV1Metadata {
  ...
  factory ConfigmaplistV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$ConfigmaplistV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$ConfigmaplistV1MetadataToJson(this);
}
