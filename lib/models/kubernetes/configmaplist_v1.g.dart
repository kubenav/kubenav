...
part of 'configmaplist_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ConfigmaplistV1 _$ConfigmaplistV1FromJson(Map<String, dynamic> json) =>
    ConfigmaplistV1(
      ...
      items: (json['items'] as List<dynamic>)
          ...
          .toList(),
      kind: $enumDecodeNullable(_$ConfigmaplistV1KindEnumMap, json['kind']),
      metadata: json['metadata'] == null
          ? null
          : ConfigmaplistV1Metadata.fromJson(
              json['metadata'] as Map<String, dynamic>,
            ),
    );

Map<String, dynamic> _$ConfigmaplistV1ToJson(ConfigmaplistV1 instance) =>
    <String, dynamic>{
      'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
      'items': instance.items,
      'kind': _$ConfigmaplistV1KindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$ApiVersionEnumMap = {ApiVersion.V1: 'v1'};

const _$ConfigmaplistV1KindEnumMap = {
  ConfigmaplistV1Kind.CONFIG_MAP_LIST: 'ConfigMapList',
};
...
const _$ItemKindEnumMap = {ItemKind.CONFIG_MAP: 'ConfigMap'};
...
ConfigmaplistV1Metadata _$ConfigmaplistV1MetadataFromJson(
...
Map<String, dynamic> _$ConfigmaplistV1MetadataToJson(
  ConfigmaplistV1Metadata instance,
) => <String, dynamic>{
