...
part of 'controllerrevisionlist_apps_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ControllerrevisionlistAppsV1 _$ControllerrevisionlistAppsV1FromJson(
  ...
  kind: $enumDecodeNullable(
    _$ControllerrevisionlistAppsV1KindEnumMap,
    json['kind'],
  ),
  metadata: json['metadata'] == null
      ? null
      : ControllerrevisionlistAppsV1Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$ControllerrevisionlistAppsV1ToJson(
  ControllerrevisionlistAppsV1 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$ControllerrevisionlistAppsV1KindEnumMap[instance.kind],
  'metadata': instance.metadata,
};

const _$ApiVersionEnumMap = {ApiVersion.APPS_V1: 'apps/v1'};

const _$ControllerrevisionlistAppsV1KindEnumMap = {
...
const _$ItemKindEnumMap = {ItemKind.CONTROLLER_REVISION: 'ControllerRevision'};
...
_$ControllerrevisionlistAppsV1MetadataFromJson(Map<String, dynamic> json) =>
    ControllerrevisionlistAppsV1Metadata(
...
Map<String, dynamic> _$ControllerrevisionlistAppsV1MetadataToJson(
  ControllerrevisionlistAppsV1Metadata instance,
) => <String, dynamic>{
