...
part 'cronjoblist_batch_v1.g.dart';

///CronJobList is a collection of cron jobs.
@JsonSerializable()
class CronjoblistBatchV1 {
  ...
  @JsonKey(name: 'items')
  List<CronjoblistBatchV1Item?> items;
  ...
  @JsonKey(name: 'kind')
  CronjoblistBatchV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  CronjoblistBatchV1Metadata? metadata;
  ...
  factory CronjoblistBatchV1.fromJson(Map<String, dynamic> json) =>
      _$CronjoblistBatchV1FromJson(json);

  Map<String, dynamic> toJson() => _$CronjoblistBatchV1ToJson(this);
}
...
final apiVersionValues = EnumValues({'batch/v1': ApiVersion.BATCH_V1});

@JsonSerializable()
class CronjoblistBatchV1Item {
  ///APIVersion defines the versioned schema of this representation of an object. Servers
  ///should convert recognized schemas to the latest internal value, and may reject
  ///unrecognized values. More info:
  ///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
  ...
  factory CronjoblistBatchV1Item.fromJson(Map<String, dynamic> json) =>
      _$CronjoblistBatchV1ItemFromJson(json);

  Map<String, dynamic> toJson() => _$CronjoblistBatchV1ItemToJson(this);
}
...
final itemKindValues = EnumValues({'CronJob': ItemKind.CRON_JOB});
...
class ItemSpec {
  ...
  ///
  ///- "Allow" (default): allows CronJobs to run concurrently; - "Forbid": forbids concurrent
  ///runs, skipping next run if previous run hasn't finished yet; - "Replace": cancels
  ...
  @JsonKey(name: 'concurrencyPolicy')
  ConcurrencyPolicy? concurrencyPolicy;

  ///The number of failed finished jobs to retain. Value must be non-negative integer.
  ///Defaults to 1.
  @JsonKey(name: 'failedJobsHistoryLimit')
  int? failedJobsHistoryLimit;

  ///JobTemplateSpec describes the data a Job should have when created from a template
  @JsonKey(name: 'jobTemplate')
  ...
  @JsonKey(name: 'startingDeadlineSeconds')
  int? startingDeadlineSeconds;

  ///The number of successful finished jobs to retain. Value must be non-negative integer.
  ///Defaults to 3.
  @JsonKey(name: 'successfulJobsHistoryLimit')
  ...
  ///default to the time zone of the kube-controller-manager process. The set of valid time
  ///zone names and the time zone offset is loaded from the system-wide time zone database by
  ///the API server during CronJob validation and the controller manager during execution. If
  ///no system-wide time zone database can be found a bundled version of the database is used
  ///instead. If the time zone name becomes invalid during the lifetime of a CronJob or due to
  ///a change in host configuration, the controller will stop creating new new Jobs and will
  ///create a system event with the reason UnknownTimeZone. More information can be found in
...
final concurrencyPolicyValues = EnumValues({
...
class JobTemplate {
  ...
  ///users must create.
  @JsonKey(name: 'metadata')
  JobTemplateMetadata? metadata;

  ///JobSpec describes how the job execution will look like.
  @JsonKey(name: 'spec')
  JobTemplateSpec? spec;

  JobTemplate({this.metadata, this.spec});

  factory JobTemplate.fromJson(Map<String, dynamic> json) =>
      _$JobTemplateFromJson(json);

  Map<String, dynamic> toJson() => _$JobTemplateToJson(this);
}
...
class JobTemplateMetadata {
  ...
  factory JobTemplateMetadata.fromJson(Map<String, dynamic> json) =>
      _$JobTemplateMetadataFromJson(json);

  Map<String, dynamic> toJson() => _$JobTemplateMetadataToJson(this);
}
...
class JobTemplateSpec {
  ...
  ///Specifies the number of retries before marking this job failed. Defaults to 6, unless
  ///backoffLimitPerIndex (only Indexed Job) is specified. When backoffLimitPerIndex is
  ///specified, backoffLimit defaults to 2147483647.
  ...
  ///
  ///Possible enum values:
  ///- `"Indexed"` is a Job completion mode. In this mode, the Pods of a Job get an associated
  ///completion index from 0 to (.spec.completions - 1). The Job is considered complete when a
  ///Pod completes for each completion index.
  ///- `"NonIndexed"` is a Job completion mode. In this mode, the Job is considered complete
  ///when there have been .spec.completions successfully completed Pods. Pod completions are
  ...
  ///3986. The value cannot exceed 63 characters. This field is immutable.
  ...
  ///and Failed are allowed values when podFailurePolicy is not in use.
  ///
  ///Possible enum values:
  ///- `"Failed"` means to wait until a previously created Pod is fully terminated (has phase
  ///Failed or Succeeded) before creating a replacement Pod.
  ///- `"TerminatingOrFailed"` means that we recreate pods when they are terminating (has a
  ...
  factory JobTemplateSpec.fromJson(Map<String, dynamic> json) =>
      _$JobTemplateSpecFromJson(json);

  Map<String, dynamic> toJson() => _$JobTemplateSpecToJson(this);
}
...
final completionModeValues = EnumValues({
  'Indexed': CompletionMode.INDEXED,
  'NonIndexed': CompletionMode.NON_INDEXED,
});
...
class PodFailurePolicy {
  ...
  @JsonKey(name: 'rules')
  List<PodFailurePolicyRule?> rules;

  PodFailurePolicy({required this.rules});

  factory PodFailurePolicy.fromJson(Map<String, dynamic> json) =>
      _$PodFailurePolicyFromJson(json);

  Map<String, dynamic> toJson() => _$PodFailurePolicyToJson(this);
}
...
class PodFailurePolicyRule {
  ...
  ///- `"FailIndex"` This is an action which might be taken on a pod failure - mark the Job's
  ///index as failed to avoid restarts within this index. This action can only be used when
  ///backoffLimitPerIndex is set.
  ///- `"FailJob"` This is an action which might be taken on a pod failure - mark the pod's
  ...
  List<OnPodCondition?>? onPodConditions;
  ...
  factory PodFailurePolicyRule.fromJson(Map<String, dynamic> json) =>
      _$PodFailurePolicyRuleFromJson(json);

  Map<String, dynamic> toJson() => _$PodFailurePolicyRuleToJson(this);
}
...
final actionValues = EnumValues({
  'Count': Action.COUNT,
  'FailIndex': Action.FAIL_INDEX,
  'FailJob': Action.FAIL_JOB,
...
class OnExitCodes {
  ...
  OnExitCodesOperator onExitCodesOperator;
  ...
  OnExitCodes({
    this.containerName,
    required this.onExitCodesOperator,
    required this.values,
  });

  factory OnExitCodes.fromJson(Map<String, dynamic> json) =>
      _$OnExitCodesFromJson(json);

  Map<String, dynamic> toJson() => _$OnExitCodesToJson(this);
}
...
final onExitCodesOperatorValues = EnumValues({
  'In': OnExitCodesOperator.IN,
  'NotIn': OnExitCodesOperator.NOT_IN,
});

@JsonSerializable()
class OnPodCondition {
  ...
  OnPodCondition({this.status, required this.type});

  factory OnPodCondition.fromJson(Map<String, dynamic> json) =>
      _$OnPodConditionFromJson(json);

  Map<String, dynamic> toJson() => _$OnPodConditionToJson(this);
}
...
///- `"TerminatingOrFailed"` means that we recreate pods when they are terminating (has a
///metadata.deletionTimestamp) or failed.
enum PodReplacementPolicy {
  @JsonValue('Failed')
  FAILED,
  @JsonValue('TerminatingOrFailed')
  TERMINATING_OR_FAILED,
}

final podReplacementPolicyValues = EnumValues({
  'Failed': PodReplacementPolicy.FAILED,
  'TerminatingOrFailed': PodReplacementPolicy.TERMINATING_OR_FAILED,
});
...
class SuccessPolicy {
  ...
  ///"SuccessCriteriaMet" condition is added, and the lingering pods are removed. The terminal
  ///state for such a Job has the "Complete" condition. Additionally, these rules are
  ///evaluated in order; Once the Job meets one of the rules, other rules are ignored. At most
  ///20 elements are allowed.
  @JsonKey(name: 'rules')
  List<SuccessPolicyRule?> rules;

  SuccessPolicy({required this.rules});

  factory SuccessPolicy.fromJson(Map<String, dynamic> json) =>
      _$SuccessPolicyFromJson(json);

  Map<String, dynamic> toJson() => _$SuccessPolicyToJson(this);
}
...
class SuccessPolicyRule {
  ...
  SuccessPolicyRule({this.succeededCount, this.succeededIndexes});

  factory SuccessPolicyRule.fromJson(Map<String, dynamic> json) =>
      _$SuccessPolicyRuleFromJson(json);

  Map<String, dynamic> toJson() => _$SuccessPolicyRuleToJson(this);
}
...
class Status {
  ...
  Status({this.active, this.lastScheduleTime, this.lastSuccessfulTime});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum CronjoblistBatchV1Kind {
  @JsonValue('CronJobList')
  CRON_JOB_LIST,
}

final cronjoblistBatchV1KindValues = EnumValues({
  'CronJobList': CronjoblistBatchV1Kind.CRON_JOB_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class CronjoblistBatchV1Metadata {
  ...
  factory CronjoblistBatchV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$CronjoblistBatchV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$CronjoblistBatchV1MetadataToJson(this);
}
