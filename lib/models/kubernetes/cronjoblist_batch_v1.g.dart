...
part of 'cronjoblist_batch_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CronjoblistBatchV1 _$CronjoblistBatchV1FromJson(Map<String, dynamic> json) =>
    CronjoblistBatchV1(
      ...
      items: (json['items'] as List<dynamic>)
          .map(
            (e) => e == null
                ? null
                : CronjoblistBatchV1Item.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
      kind: $enumDecodeNullable(_$CronjoblistBatchV1KindEnumMap, json['kind']),
      metadata: json['metadata'] == null
          ? null
          : CronjoblistBatchV1Metadata.fromJson(
              json['metadata'] as Map<String, dynamic>,
            ),
    );

Map<String, dynamic> _$CronjoblistBatchV1ToJson(CronjoblistBatchV1 instance) =>
    <String, dynamic>{
      'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
      'items': instance.items,
      'kind': _$CronjoblistBatchV1KindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$ApiVersionEnumMap = {ApiVersion.BATCH_V1: 'batch/v1'};

const _$CronjoblistBatchV1KindEnumMap = {
  CronjoblistBatchV1Kind.CRON_JOB_LIST: 'CronJobList',
};

CronjoblistBatchV1Item _$CronjoblistBatchV1ItemFromJson(
...
Map<String, dynamic> _$CronjoblistBatchV1ItemToJson(
  CronjoblistBatchV1Item instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
...
const _$ItemKindEnumMap = {ItemKind.CRON_JOB: 'CronJob'};
...
ItemSpec _$ItemSpecFromJson(Map<String, dynamic> json) => ItemSpec(
  concurrencyPolicy: $enumDecodeNullable(
    _$ConcurrencyPolicyEnumMap,
    json['concurrencyPolicy'],
  ),
  failedJobsHistoryLimit: (json['failedJobsHistoryLimit'] as num?)?.toInt(),
  jobTemplate: JobTemplate.fromJson(
    json['jobTemplate'] as Map<String, dynamic>,
  ),
  schedule: json['schedule'] as String,
  startingDeadlineSeconds: (json['startingDeadlineSeconds'] as num?)?.toInt(),
  successfulJobsHistoryLimit: (json['successfulJobsHistoryLimit'] as num?)
      ?.toInt(),
...
Map<String, dynamic> _$ItemSpecToJson(ItemSpec instance) => <String, dynamic>{
  'concurrencyPolicy': _$ConcurrencyPolicyEnumMap[instance.concurrencyPolicy],
  'failedJobsHistoryLimit': instance.failedJobsHistoryLimit,
  'jobTemplate': instance.jobTemplate,
  'schedule': instance.schedule,
  'startingDeadlineSeconds': instance.startingDeadlineSeconds,
  'successfulJobsHistoryLimit': instance.successfulJobsHistoryLimit,
  'suspend': instance.suspend,
  'timeZone': instance.timeZone,
};

const _$ConcurrencyPolicyEnumMap = {
  ConcurrencyPolicy.ALLOW: 'Allow',
  ConcurrencyPolicy.FORBID: 'Forbid',
  ConcurrencyPolicy.REPLACE: 'Replace',
};

JobTemplate _$JobTemplateFromJson(Map<String, dynamic> json) => JobTemplate(
  metadata: json['metadata'] == null
      ? null
      : JobTemplateMetadata.fromJson(json['metadata'] as Map<String, dynamic>),
  spec: json['spec'] == null
      ? null
      : JobTemplateSpec.fromJson(json['spec'] as Map<String, dynamic>),
);

Map<String, dynamic> _$JobTemplateToJson(JobTemplate instance) =>
    <String, dynamic>{'metadata': instance.metadata, 'spec': instance.spec};

JobTemplateMetadata _$JobTemplateMetadataFromJson(
  Map<String, dynamic> json,
) => JobTemplateMetadata(
  annotations: (json['annotations'] as Map<String, dynamic>?)?.map(
    (k, e) => MapEntry(k, e as String?),
...
Map<String, dynamic> _$JobTemplateMetadataToJson(
  JobTemplateMetadata instance,
) => <String, dynamic>{
  'annotations': instance.annotations,
  'creationTimestamp': instance.creationTimestamp?.toIso8601String(),
  'deletionGracePeriodSeconds': instance.deletionGracePeriodSeconds,
...
JobTemplateSpec _$JobTemplateSpecFromJson(
  Map<String, dynamic> json,
) => JobTemplateSpec(
  ...
  completionMode: $enumDecodeNullable(
    _$CompletionModeEnumMap,
    json['completionMode'],
  ),
  ...
  podFailurePolicy: json['podFailurePolicy'] == null
      ? null
      : PodFailurePolicy.fromJson(
          json['podFailurePolicy'] as Map<String, dynamic>,
        ),
  podReplacementPolicy: $enumDecodeNullable(
    _$PodReplacementPolicyEnumMap,
  ...
  successPolicy: json['successPolicy'] == null
      ? null
      : SuccessPolicy.fromJson(json['successPolicy'] as Map<String, dynamic>),
  suspend: json['suspend'] as bool?,
  template: Template.fromJson(json['template'] as Map<String, dynamic>),
  ttlSecondsAfterFinished: (json['ttlSecondsAfterFinished'] as num?)?.toInt(),
);

Map<String, dynamic> _$JobTemplateSpecToJson(JobTemplateSpec instance) =>
    <String, dynamic>{
      ...
      'podReplacementPolicy':
          _$PodReplacementPolicyEnumMap[instance.podReplacementPolicy],
...
const _$CompletionModeEnumMap = {
  ...
  CompletionMode.NON_INDEXED: 'NonIndexed',
};

const _$PodReplacementPolicyEnumMap = {
  PodReplacementPolicy.FAILED: 'Failed',
  PodReplacementPolicy.TERMINATING_OR_FAILED: 'TerminatingOrFailed',
};
    ...
    PodFailurePolicy(
      rules: (json['rules'] as List<dynamic>)
          .map(
            (e) => e == null
                ? null
                : PodFailurePolicyRule.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
    );
...
PodFailurePolicyRule _$PodFailurePolicyRuleFromJson(
  ...
  onExitCodes: json['onExitCodes'] == null
      ? null
      : OnExitCodes.fromJson(json['onExitCodes'] as Map<String, dynamic>),
  onPodConditions: (json['onPodConditions'] as List<dynamic>?)
      ?.map(
        (e) => e == null
            ? null
            : OnPodCondition.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
);
...
const _$ActionEnumMap = {
  Action.COUNT: 'Count',
  Action.FAIL_INDEX: 'FailIndex',
  Action.FAIL_JOB: 'FailJob',
  Action.IGNORE: 'Ignore',
};

OnExitCodes _$OnExitCodesFromJson(Map<String, dynamic> json) => OnExitCodes(
  containerName: json['containerName'] as String?,
  onExitCodesOperator: $enumDecode(
    _$OnExitCodesOperatorEnumMap,
    json['operator'],
  ),
...
Map<String, dynamic> _$OnExitCodesToJson(OnExitCodes instance) =>
    <String, dynamic>{
      'containerName': instance.containerName,
      'operator': _$OnExitCodesOperatorEnumMap[instance.onExitCodesOperator]!,
      'values': instance.values,
    };

const _$OnExitCodesOperatorEnumMap = {
  OnExitCodesOperator.IN: 'In',
  OnExitCodesOperator.NOT_IN: 'NotIn',
};

OnPodCondition _$OnPodConditionFromJson(Map<String, dynamic> json) =>
    OnPodCondition(
      status: json['status'] as String?,
      type: json['type'] as String,
    );

Map<String, dynamic> _$OnPodConditionToJson(OnPodCondition instance) =>
    <String, dynamic>{'status': instance.status, 'type': instance.type};
    ...
    SuccessPolicy(
      rules: (json['rules'] as List<dynamic>)
          .map(
            (e) => e == null
                ? null
                : SuccessPolicyRule.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
    );
...
CronjoblistBatchV1Metadata _$CronjoblistBatchV1MetadataFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$CronjoblistBatchV1MetadataToJson(
  CronjoblistBatchV1Metadata instance,
) => <String, dynamic>{
