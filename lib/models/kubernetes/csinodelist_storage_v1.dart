...
part 'csinodelist_storage_v1.g.dart';

///CSINodeList is a collection of CSINode objects.
@JsonSerializable()
class CsinodelistStorageV1 {
  ...
  @JsonKey(name: 'kind')
  CsinodelistStorageV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  CsinodelistStorageV1Metadata? metadata;
  ...
  factory CsinodelistStorageV1.fromJson(Map<String, dynamic> json) =>
      _$CsinodelistStorageV1FromJson(json);

  Map<String, dynamic> toJson() => _$CsinodelistStorageV1ToJson(this);
}
...
final itemKindValues = EnumValues({'CSINode': ItemKind.CSI_NODE});
...
class Allocatable {
  ...
  Allocatable({this.count});

  factory Allocatable.fromJson(Map<String, dynamic> json) =>
      _$AllocatableFromJson(json);

  Map<String, dynamic> toJson() => _$AllocatableToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum CsinodelistStorageV1Kind {
  @JsonValue('CSINodeList')
  CSI_NODE_LIST,
}

final csinodelistStorageV1KindValues = EnumValues({
  'CSINodeList': CsinodelistStorageV1Kind.CSI_NODE_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class CsinodelistStorageV1Metadata {
  ...
  factory CsinodelistStorageV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$CsinodelistStorageV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$CsinodelistStorageV1MetadataToJson(this);
}
