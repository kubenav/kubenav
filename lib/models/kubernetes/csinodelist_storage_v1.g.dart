...
part of 'csinodelist_storage_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

CsinodelistStorageV1 _$CsinodelistStorageV1FromJson(
  Map<String, dynamic> json,
) => CsinodelistStorageV1(
  ...
  items: (json['items'] as List<dynamic>)
      ...
      .toList(),
  kind: $enumDecodeNullable(_$CsinodelistStorageV1KindEnumMap, json['kind']),
  metadata: json['metadata'] == null
      ? null
      : CsinodelistStorageV1Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$CsinodelistStorageV1ToJson(
  CsinodelistStorageV1 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$CsinodelistStorageV1KindEnumMap[instance.kind],
...
const _$CsinodelistStorageV1KindEnumMap = {
  CsinodelistStorageV1Kind.CSI_NODE_LIST: 'CSINodeList',
};
...
const _$ItemKindEnumMap = {ItemKind.CSI_NODE: 'CSINode'};
...
Spec _$SpecFromJson(Map<String, dynamic> json) => Spec(
  drivers: (json['drivers'] as List<dynamic>)
      .map((e) => e == null ? null : Driver.fromJson(e as Map<String, dynamic>))
      .toList(),
);
...
Driver _$DriverFromJson(Map<String, dynamic> json) => Driver(
  allocatable: json['allocatable'] == null
      ? null
      : Allocatable.fromJson(json['allocatable'] as Map<String, dynamic>),
  name: json['name'] as String,
...
Allocatable _$AllocatableFromJson(Map<String, dynamic> json) =>
    Allocatable(count: (json['count'] as num?)?.toInt());

Map<String, dynamic> _$AllocatableToJson(Allocatable instance) =>
    <String, dynamic>{'count': instance.count};

CsinodelistStorageV1Metadata _$CsinodelistStorageV1MetadataFromJson(
  Map<String, dynamic> json,
) => CsinodelistStorageV1Metadata(
...
Map<String, dynamic> _$CsinodelistStorageV1MetadataToJson(
  CsinodelistStorageV1Metadata instance,
) => <String, dynamic>{
