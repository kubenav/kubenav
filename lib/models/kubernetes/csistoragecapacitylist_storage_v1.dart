...
part 'csistoragecapacitylist_storage_v1.g.dart';

///CSIStorageCapacityList is a collection of CSIStorageCapacity objects.
@JsonSerializable()
class CsistoragecapacitylistStorageV1 {
  ...
  @JsonKey(name: 'kind')
  CsistoragecapacitylistStorageV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  CsistoragecapacitylistStorageV1Metadata? metadata;
  ...
  factory CsistoragecapacitylistStorageV1.fromJson(Map<String, dynamic> json) =>
      _$CsistoragecapacitylistStorageV1FromJson(json);

  Map<String, dynamic> toJson() =>
      _$CsistoragecapacitylistStorageV1ToJson(this);
}
...
class Item {
  ...
  @JsonKey(name: 'kind')
  ItemKind? kind;
  @JsonKey(name: 'maximumVolumeSize')
  dynamic maximumVolumeSize;
  ...
  @JsonKey(name: 'nodeTopology')
  NodeTopology? nodeTopology;

  ///storageClassName represents the name of the StorageClass that the reported capacity
  ///applies to. It must meet the same requirements as the name of a StorageClass object
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
  @JsonValue('CSIStorageCapacity')
  CSI_STORAGE_CAPACITY,
}

final itemKindValues = EnumValues({
  'CSIStorageCapacity': ItemKind.CSI_STORAGE_CAPACITY,
});
...
class NodeTopology {
  ...
  NodeTopology({this.matchExpressions, this.matchLabels});

  factory NodeTopology.fromJson(Map<String, dynamic> json) =>
      _$NodeTopologyFromJson(json);

  Map<String, dynamic> toJson() => _$NodeTopologyToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum CsistoragecapacitylistStorageV1Kind {
  @JsonValue('CSIStorageCapacityList')
  CSI_STORAGE_CAPACITY_LIST,
}

final csistoragecapacitylistStorageV1KindValues = EnumValues({
...
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class CsistoragecapacitylistStorageV1Metadata {
  ...
  factory CsistoragecapacitylistStorageV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$CsistoragecapacitylistStorageV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$CsistoragecapacitylistStorageV1MetadataToJson(this);
}
