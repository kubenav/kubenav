...
part 'daemonsetlist_apps_v1.g.dart';

///DaemonSetList is a collection of daemon sets.
@JsonSerializable()
class DaemonsetlistAppsV1 {
  ...
  @JsonKey(name: 'items')
  List<DaemonsetlistAppsV1Item?> items;
  ...
  @JsonKey(name: 'kind')
  DaemonsetlistAppsV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  DaemonsetlistAppsV1Metadata? metadata;
  ...
  factory DaemonsetlistAppsV1.fromJson(Map<String, dynamic> json) =>
      _$DaemonsetlistAppsV1FromJson(json);

  Map<String, dynamic> toJson() => _$DaemonsetlistAppsV1ToJson(this);
}
...
class DaemonsetlistAppsV1Item {
  ...
  factory DaemonsetlistAppsV1Item.fromJson(Map<String, dynamic> json) =>
      _$DaemonsetlistAppsV1ItemFromJson(json);

  Map<String, dynamic> toJson() => _$DaemonsetlistAppsV1ItemToJson(this);
}
...
final itemKindValues = EnumValues({'DaemonSet': ItemKind.DAEMON_SET});
...
class UpdateStrategy {
  ...
  ///- `"RollingUpdate"` Replace the old daemons by new ones using rolling update i.e replace
  ///them on each node one after the other.
  @JsonKey(name: 'type')
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum DaemonsetlistAppsV1Kind {
  @JsonValue('DaemonSetList')
  DAEMON_SET_LIST,
}

final daemonsetlistAppsV1KindValues = EnumValues({
  'DaemonSetList': DaemonsetlistAppsV1Kind.DAEMON_SET_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class DaemonsetlistAppsV1Metadata {
  ...
  factory DaemonsetlistAppsV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$DaemonsetlistAppsV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$DaemonsetlistAppsV1MetadataToJson(this);
}
