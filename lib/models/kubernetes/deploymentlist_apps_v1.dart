...
part 'deploymentlist_apps_v1.g.dart';

///DeploymentList is a list of Deployments.
@JsonSerializable()
class DeploymentlistAppsV1 {
  ...
  @JsonKey(name: 'items')
  List<DeploymentlistAppsV1Item?> items;
  ...
  @JsonKey(name: 'kind')
  DeploymentlistAppsV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  DeploymentlistAppsV1Metadata? metadata;
  ...
  factory DeploymentlistAppsV1.fromJson(Map<String, dynamic> json) =>
      _$DeploymentlistAppsV1FromJson(json);

  Map<String, dynamic> toJson() => _$DeploymentlistAppsV1ToJson(this);
}
...
final apiVersionValues = EnumValues({'apps/v1': ApiVersion.APPS_V1});

@JsonSerializable()
class DeploymentlistAppsV1Item {
  ///APIVersion defines the versioned schema of this representation of an object. Servers
  ///should convert recognized schemas to the latest internal value, and may reject
  ///unrecognized values. More info:
  ///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
  ...
  factory DeploymentlistAppsV1Item.fromJson(Map<String, dynamic> json) =>
      _$DeploymentlistAppsV1ItemFromJson(json);

  Map<String, dynamic> toJson() => _$DeploymentlistAppsV1ItemToJson(this);
}
...
final itemKindValues = EnumValues({'Deployment': ItemKind.DEPLOYMENT});
...
class ItemSpec {
  ...
  ///Defaults to 600s.
  @JsonKey(name: 'progressDeadlineSeconds')
...
class Strategy {
  ...
  ///- `"RollingUpdate"` Replace the old ReplicaSets by new one using rolling update i.e
  ///gradually scale down the old ReplicaSets and scale up the new one.
  @JsonKey(name: 'type')
  StrategyType? type;

  Strategy({this.rollingUpdate, this.type});
...
class RollingUpdate {
  ...
  RollingUpdate({this.maxSurge, this.maxUnavailable});
...
final strategyTypeValues = EnumValues({
  'Recreate': StrategyType.RECREATE,
  'RollingUpdate': StrategyType.ROLLING_UPDATE,
});
...
class Status {
  ...
  ///Total number of non-terminating pods targeted by this deployment (their labels match the
  ///selector).
  @JsonKey(name: 'replicas')
  int? replicas;

  ///Total number of terminating pods targeted by this deployment. Terminating pods have a
  ///non-null .metadata.deletionTimestamp and have not yet reached the Failed or Succeeded
  ///.status.phase.
  ///
  ///This is a beta field and requires enabling DeploymentReplicaSetTerminatingReplicas
  ///feature (enabled by default).
  @JsonKey(name: 'terminatingReplicas')
  ...
  ///Total number of non-terminating pods targeted by this deployment that have the desired
  ///template spec.
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum DeploymentlistAppsV1Kind {
  @JsonValue('DeploymentList')
  DEPLOYMENT_LIST,
}

final deploymentlistAppsV1KindValues = EnumValues({
  'DeploymentList': DeploymentlistAppsV1Kind.DEPLOYMENT_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class DeploymentlistAppsV1Metadata {
  ...
  factory DeploymentlistAppsV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$DeploymentlistAppsV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$DeploymentlistAppsV1MetadataToJson(this);
}
