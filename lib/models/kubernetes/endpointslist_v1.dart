...
part 'endpointslist_v1.g.dart';

///EndpointsList is a list of endpoints. Deprecated: This API is deprecated in v1.33+.
@JsonSerializable()
class EndpointslistV1 {
  ...
  @JsonKey(name: 'kind')
  EndpointslistV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  EndpointslistV1Metadata? metadata;
  ...
  factory EndpointslistV1.fromJson(Map<String, dynamic> json) =>
      _$EndpointslistV1FromJson(json);

  Map<String, dynamic> toJson() => _$EndpointslistV1ToJson(this);
}
...
class Item {
  ...
  Item({this.apiVersion, this.kind, this.metadata, this.subsets});
...
final itemKindValues = EnumValues({'Endpoints': ItemKind.ENDPOINTS});
...
class Subset {
  ...
  List<NotReadyAddress?>? notReadyAddresses;

  ///Port numbers available on the related IP addresses.
  @JsonKey(name: 'ports')
  List<Port?>? ports;

  Subset({this.addresses, this.notReadyAddresses, this.ports});
...
class Address {
  ...
  AddressTargetRef? targetRef;

  Address({this.hostname, required this.ip, this.nodeName, this.targetRef});
...
class AddressTargetRef {
  ...
  factory AddressTargetRef.fromJson(Map<String, dynamic> json) =>
      _$AddressTargetRefFromJson(json);

  Map<String, dynamic> toJson() => _$AddressTargetRefToJson(this);
}
...
class NotReadyAddress {
  ...
  ///object.
  @JsonKey(name: 'targetRef')
  NotReadyAddressTargetRef? targetRef;
  ...
  factory NotReadyAddress.fromJson(Map<String, dynamic> json) =>
      _$NotReadyAddressFromJson(json);

  Map<String, dynamic> toJson() => _$NotReadyAddressToJson(this);
}

@JsonSerializable()
class NotReadyAddressTargetRef {
  ///API version of the referent.
  @JsonKey(name: 'apiVersion')
  String? apiVersion;
  ...
  factory NotReadyAddressTargetRef.fromJson(Map<String, dynamic> json) =>
      _$NotReadyAddressTargetRefFromJson(json);

  Map<String, dynamic> toJson() => _$NotReadyAddressTargetRefToJson(this);
}
...
class Port {
  ...
  Port({this.appProtocol, this.name, required this.port, this.protocol});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum EndpointslistV1Kind {
  @JsonValue('EndpointsList')
  ENDPOINTS_LIST,
}

final endpointslistV1KindValues = EnumValues({
  'EndpointsList': EndpointslistV1Kind.ENDPOINTS_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class EndpointslistV1Metadata {
  ...
  factory EndpointslistV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$EndpointslistV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$EndpointslistV1MetadataToJson(this);
}
