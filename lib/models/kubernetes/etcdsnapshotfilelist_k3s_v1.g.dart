...
part of 'etcdsnapshotfilelist_k3s_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

EtcdsnapshotfilelistK3SV1 _$EtcdsnapshotfilelistK3SV1FromJson(
  ...
  kind: $enumDecodeNullable(
    _$EtcdsnapshotfilelistK3SV1KindEnumMap,
    json['kind'],
  ),
  metadata: json['metadata'] == null
      ? null
      : EtcdsnapshotfilelistK3SV1Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$EtcdsnapshotfilelistK3SV1ToJson(
  EtcdsnapshotfilelistK3SV1 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$EtcdsnapshotfilelistK3SV1KindEnumMap[instance.kind],
  'metadata': instance.metadata,
};

const _$ApiVersionEnumMap = {ApiVersion.K3_S_CATTLE_IO_V1: 'k3s.cattle.io/v1'};

const _$EtcdsnapshotfilelistK3SV1KindEnumMap = {
  EtcdsnapshotfilelistK3SV1Kind.ETCD_SNAPSHOT_FILE_LIST: 'ETCDSnapshotFileList',
};
...
const _$ItemKindEnumMap = {ItemKind.ETCD_SNAPSHOT_FILE: 'ETCDSnapshotFile'};
...
S3 _$S3FromJson(Map<String, dynamic> json) => S3(
  ...
  bucketLookup: json['bucketLookup'] as String?,
  endpoint: json['endpoint'] as String?,
  endpointCa: json['endpointCA'] as String?,
  insecure: json['insecure'] as bool?,
  prefix: json['prefix'] as String?,
  region: json['region'] as String?,
  skipSslVerify: json['skipSSLVerify'] as bool?,
);

Map<String, dynamic> _$S3ToJson(S3 instance) => <String, dynamic>{
  'bucket': instance.bucket,
  'bucketLookup': instance.bucketLookup,
  'endpoint': instance.endpoint,
  'endpointCA': instance.endpointCa,
...
Status _$StatusFromJson(Map<String, dynamic> json) => Status(
  ...
  readyToUse: json['readyToUse'] as bool?,
  size: json['size'],
);
...
Map<String, dynamic> _$StatusToJson(Status instance) => <String, dynamic>{
  ...
  'readyToUse': instance.readyToUse,
  'size': instance.size,
};
...
EtcdsnapshotfilelistK3SV1Metadata _$EtcdsnapshotfilelistK3SV1MetadataFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$EtcdsnapshotfilelistK3SV1MetadataToJson(
  EtcdsnapshotfilelistK3SV1Metadata instance,
) => <String, dynamic>{
