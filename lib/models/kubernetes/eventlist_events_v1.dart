...
part 'eventlist_events_v1.g.dart';

///EventList is a list of Event objects.
@JsonSerializable()
class EventlistEventsV1 {
  ...
  @JsonKey(name: 'kind')
  EventlistEventsV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  EventlistEventsV1Metadata? metadata;
  ...
  factory EventlistEventsV1.fromJson(Map<String, dynamic> json) =>
      _$EventlistEventsV1FromJson(json);

  Map<String, dynamic> toJson() => _$EventlistEventsV1ToJson(this);
}
...
class DeprecatedSource {
  ...
  DeprecatedSource({this.component, this.host});

  factory DeprecatedSource.fromJson(Map<String, dynamic> json) =>
      _$DeprecatedSourceFromJson(json);

  Map<String, dynamic> toJson() => _$DeprecatedSourceToJson(this);
}
...
final itemKindValues = EnumValues({'Event': ItemKind.EVENT});
...
class Regarding {
  ...
  factory Regarding.fromJson(Map<String, dynamic> json) =>
      _$RegardingFromJson(json);

  Map<String, dynamic> toJson() => _$RegardingToJson(this);
}
...
class Series {
  ...
  Series({required this.count, required this.lastObservedTime});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum EventlistEventsV1Kind {
  @JsonValue('EventList')
  EVENT_LIST,
}

final eventlistEventsV1KindValues = EnumValues({
  'EventList': EventlistEventsV1Kind.EVENT_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class EventlistEventsV1Metadata {
  ...
  factory EventlistEventsV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$EventlistEventsV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$EventlistEventsV1MetadataToJson(this);
}
