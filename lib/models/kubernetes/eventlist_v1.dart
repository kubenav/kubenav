...
class EventlistV1 {
  ...
  @JsonKey(name: 'kind')
  EventlistV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  EventlistV1Metadata? metadata;

  EventlistV1({this.apiVersion, required this.items, this.kind, this.metadata});

  factory EventlistV1.fromJson(Map<String, dynamic> json) =>
      _$EventlistV1FromJson(json);

  Map<String, dynamic> toJson() => _$EventlistV1ToJson(this);
}
...
class Item {
  ...
  @JsonKey(name: 'reportingComponent')
...
class InvolvedObject {
  ...
  factory InvolvedObject.fromJson(Map<String, dynamic> json) =>
      _$InvolvedObjectFromJson(json);

  Map<String, dynamic> toJson() => _$InvolvedObjectToJson(this);
}
...
class Series {
  ...
  Series({this.count, this.lastObservedTime});
...
class Source {
  ...
  Source({this.component, this.host});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum EventlistV1Kind {
  @JsonValue('EventList')
  EVENT_LIST,
}

final eventlistV1KindValues = EnumValues({
  'EventList': EventlistV1Kind.EVENT_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class EventlistV1Metadata {
  ...
  factory EventlistV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$EventlistV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$EventlistV1MetadataToJson(this);
}
