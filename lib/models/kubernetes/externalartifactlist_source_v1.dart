...
part 'externalartifactlist_source_v1.g.dart';

///ExternalArtifactList is a list of ExternalArtifact
@JsonSerializable()
class ExternalartifactlistSourceV1 {
  ...
  ///List of externalartifacts. More info:
  ...
  @JsonKey(name: 'kind')
  ExternalartifactlistSourceV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  ExternalartifactlistSourceV1Metadata? metadata;
  ...
  factory ExternalartifactlistSourceV1.fromJson(Map<String, dynamic> json) =>
      _$ExternalartifactlistSourceV1FromJson(json);

  Map<String, dynamic> toJson() => _$ExternalartifactlistSourceV1ToJson(this);
}
...
final itemKindValues = EnumValues({
  'ExternalArtifact': ItemKind.EXTERNAL_ARTIFACT,
});
...
class StatusClass {
  ...
  StatusClass({this.artifact, this.conditions});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ExternalartifactlistSourceV1Kind {
  @JsonValue('ExternalArtifactList')
  EXTERNAL_ARTIFACT_LIST,
}

final externalartifactlistSourceV1KindValues = EnumValues({
...
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class ExternalartifactlistSourceV1Metadata {
  ...
  factory ExternalartifactlistSourceV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$ExternalartifactlistSourceV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ExternalartifactlistSourceV1MetadataToJson(this);
}
