...
part 'gitrepositorylist_source_v1beta2.g.dart';

///GitRepositoryList is a list of GitRepository
@JsonSerializable()
class GitrepositorylistSourceV1Beta2 {
  ...
  @JsonKey(name: 'kind')
  GitrepositorylistSourceV1Beta2Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  GitrepositorylistSourceV1Beta2Metadata? metadata;
  ...
  factory GitrepositorylistSourceV1Beta2.fromJson(Map<String, dynamic> json) =>
      _$GitrepositorylistSourceV1Beta2FromJson(json);

  Map<String, dynamic> toJson() => _$GitrepositorylistSourceV1Beta2ToJson(this);
}
...
class Spec {
  ...
  @JsonKey(name: 'gitImplementation')
...
final gitImplementationValues = EnumValues({
  'go-git': GitImplementation.GO_GIT,
  'libgit2': GitImplementation.LIBGIT2,
});
...
class Verify {
  ...
  Verify({required this.mode, required this.secretRef});
...
final modeValues = EnumValues({'head': Mode.HEAD});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum GitrepositorylistSourceV1Beta2Kind {
  @JsonValue('GitRepositoryList')
  GIT_REPOSITORY_LIST,
}

final gitrepositorylistSourceV1Beta2KindValues = EnumValues({
  'GitRepositoryList': GitrepositorylistSourceV1Beta2Kind.GIT_REPOSITORY_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class GitrepositorylistSourceV1Beta2Metadata {
  ...
  factory GitrepositorylistSourceV1Beta2Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$GitrepositorylistSourceV1Beta2MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$GitrepositorylistSourceV1Beta2MetadataToJson(this);
}
