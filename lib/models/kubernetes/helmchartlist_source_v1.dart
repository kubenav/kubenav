...
part 'helmchartlist_source_v1.g.dart';

///HelmChartList is a list of HelmChart
@JsonSerializable()
class HelmchartlistSourceV1 {
  ...
  @JsonKey(name: 'kind')
  HelmchartlistSourceV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  HelmchartlistSourceV1Metadata? metadata;

  HelmchartlistSourceV1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory HelmchartlistSourceV1.fromJson(Map<String, dynamic> json) =>
      _$HelmchartlistSourceV1FromJson(json);

  Map<String, dynamic> toJson() => _$HelmchartlistSourceV1ToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum HelmchartlistSourceV1Kind {
  @JsonValue('HelmChartList')
  HELM_CHART_LIST,
}

final helmchartlistSourceV1KindValues = EnumValues({
  'HelmChartList': HelmchartlistSourceV1Kind.HELM_CHART_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class HelmchartlistSourceV1Metadata {
  ...
  factory HelmchartlistSourceV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$HelmchartlistSourceV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$HelmchartlistSourceV1MetadataToJson(this);
}
