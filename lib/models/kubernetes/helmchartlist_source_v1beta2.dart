...
part 'helmchartlist_source_v1beta2.g.dart';

///HelmChartList is a list of HelmChart
@JsonSerializable()
class HelmchartlistSourceV1Beta2 {
  ...
  @JsonKey(name: 'kind')
  HelmchartlistSourceV1Beta2Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  HelmchartlistSourceV1Beta2Metadata? metadata;
  ...
  factory HelmchartlistSourceV1Beta2.fromJson(Map<String, dynamic> json) =>
      _$HelmchartlistSourceV1Beta2FromJson(json);

  Map<String, dynamic> toJson() => _$HelmchartlistSourceV1Beta2ToJson(this);
}
...
final itemKindValues = EnumValues({'HelmChart': ItemKind.HELM_CHART});
...
class Spec {
  ...
  ///Chart dependencies, which are not bundled in the umbrella chart artifact, are not
  ///verified.
  @JsonKey(name: 'verify')
  Verify? verify;
...
class SourceRef {
  ...
  SourceRef({this.apiVersion, required this.kind, required this.name});
...
class StatusClass {
  ...
  @JsonKey(name: 'observedChartName')
  ...
  @JsonKey(name: 'observedSourceArtifactRevision')
  ...
  @JsonKey(name: 'observedValuesFiles')
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum HelmchartlistSourceV1Beta2Kind {
  @JsonValue('HelmChartList')
  HELM_CHART_LIST,
}

final helmchartlistSourceV1Beta2KindValues = EnumValues({
  'HelmChartList': HelmchartlistSourceV1Beta2Kind.HELM_CHART_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class HelmchartlistSourceV1Beta2Metadata {
  ...
  factory HelmchartlistSourceV1Beta2Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$HelmchartlistSourceV1Beta2MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$HelmchartlistSourceV1Beta2MetadataToJson(this);
}
