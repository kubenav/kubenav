...
part 'helmreleaselist_helm_v2.g.dart';

///HelmReleaseList is a list of HelmRelease
@JsonSerializable()
class HelmreleaselistHelmV2 {
  ...
  @JsonKey(name: 'kind')
  HelmreleaselistHelmV2Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  HelmreleaselistHelmV2Metadata? metadata;

  HelmreleaselistHelmV2({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory HelmreleaselistHelmV2.fromJson(Map<String, dynamic> json) =>
      _$HelmreleaselistHelmV2FromJson(json);

  Map<String, dynamic> toJson() => _$HelmreleaselistHelmV2ToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
enum ApiVersion {
  @JsonValue('helm.toolkit.fluxcd.io/v2')
  HELM_TOOLKIT_FLUXCD_IO_V2,
}

final apiVersionValues = EnumValues({
  'helm.toolkit.fluxcd.io/v2': ApiVersion.HELM_TOOLKIT_FLUXCD_IO_V2,
});
...
final chartRefKindValues = EnumValues({
  'ExternalArtifact': ChartRefKind.EXTERNAL_ARTIFACT,
...
class Install {
  ...
  @JsonKey(name: 'disableSchemaValidation')
  ...
  @JsonKey(name: 'disableTakeOwnership')
  bool? disableTakeOwnership;
...
class InstallStrategy {
  ...
  InstallStrategy({required this.name, this.retryInterval});

  factory InstallStrategy.fromJson(Map<String, dynamic> json) =>
      _$InstallStrategyFromJson(json);

  Map<String, dynamic> toJson() => _$InstallStrategyToJson(this);
}
...
final nameValues = EnumValues({
  'RemediateOnFailure': Name.REMEDIATE_ON_FAILURE,
  'RetryOnFailure': Name.RETRY_ON_FAILURE,
});
...
class Kustomize {
  ...
  Kustomize({this.images, this.patches});
...
final strategyEnumValues = EnumValues({
  'rollback': StrategyEnum.ROLLBACK,
  'uninstall': StrategyEnum.UNINSTALL,
});
...
class UpgradeStrategy {
  ...
  UpgradeStrategy({required this.name, this.retryInterval});

  factory UpgradeStrategy.fromJson(Map<String, dynamic> json) =>
      _$UpgradeStrategyFromJson(json);

  Map<String, dynamic> toJson() => _$UpgradeStrategyToJson(this);
}
...
class StatusClass {
  ...
  @JsonKey(name: 'lastAttemptedReleaseActionDuration')
  String? lastAttemptedReleaseActionDuration;
  ...
  @JsonKey(name: 'observedCommonMetadataDigest')
  String? observedCommonMetadataDigest;
  ...
  StatusClass({
    ...
    this.lastAttemptedReleaseActionDuration,
    ...
    this.observedCommonMetadataDigest,
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum HelmreleaselistHelmV2Kind {
  @JsonValue('HelmReleaseList')
  HELM_RELEASE_LIST,
}

final helmreleaselistHelmV2KindValues = EnumValues({
  'HelmReleaseList': HelmreleaselistHelmV2Kind.HELM_RELEASE_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class HelmreleaselistHelmV2Metadata {
  ...
  factory HelmreleaselistHelmV2Metadata.fromJson(Map<String, dynamic> json) =>
      _$HelmreleaselistHelmV2MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$HelmreleaselistHelmV2MetadataToJson(this);
}
