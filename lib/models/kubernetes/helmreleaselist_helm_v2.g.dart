...
part of 'helmreleaselist_helm_v2.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

HelmreleaselistHelmV2 _$HelmreleaselistHelmV2FromJson(
  ...
  items: (json['items'] as List<dynamic>)
      ...
      .toList(),
  kind: $enumDecodeNullable(_$HelmreleaselistHelmV2KindEnumMap, json['kind']),
  metadata: json['metadata'] == null
      ? null
      : HelmreleaselistHelmV2Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$HelmreleaselistHelmV2ToJson(
  HelmreleaselistHelmV2 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$HelmreleaselistHelmV2KindEnumMap[instance.kind],
  'metadata': instance.metadata,
};

const _$ApiVersionEnumMap = {
  ApiVersion.HELM_TOOLKIT_FLUXCD_IO_V2: 'helm.toolkit.fluxcd.io/v2',
};

const _$HelmreleaselistHelmV2KindEnumMap = {
  HelmreleaselistHelmV2Kind.HELM_RELEASE_LIST: 'HelmReleaseList',
};
...
const _$ChartRefKindEnumMap = {
  ChartRefKind.EXTERNAL_ARTIFACT: 'ExternalArtifact',
...
Install _$InstallFromJson(Map<String, dynamic> json) => Install(
  ...
  disableTakeOwnership: json['disableTakeOwnership'] as bool?,
  ...
  strategy: json['strategy'] == null
      ? null
      : InstallStrategy.fromJson(json['strategy'] as Map<String, dynamic>),
  timeout: json['timeout'] as String?,
);
...
Map<String, dynamic> _$InstallToJson(Install instance) => <String, dynamic>{
  ...
  'disableSchemaValidation': instance.disableSchemaValidation,
  'disableTakeOwnership': instance.disableTakeOwnership,
...
InstallStrategy _$InstallStrategyFromJson(Map<String, dynamic> json) =>
    InstallStrategy(
      name: $enumDecode(_$NameEnumMap, json['name']),
      retryInterval: json['retryInterval'] as String?,
    );

Map<String, dynamic> _$InstallStrategyToJson(InstallStrategy instance) =>
    <String, dynamic>{
...
const _$NameEnumMap = {
  Name.REMEDIATE_ON_FAILURE: 'RemediateOnFailure',
  Name.RETRY_ON_FAILURE: 'RetryOnFailure',
};
...
Upgrade _$UpgradeFromJson(Map<String, dynamic> json) => Upgrade(
  ...
  strategy: json['strategy'] == null
      ? null
      : UpgradeStrategy.fromJson(json['strategy'] as Map<String, dynamic>),
  timeout: json['timeout'] as String?,
);
...
UpgradeRemediation _$UpgradeRemediationFromJson(Map<String, dynamic> json) =>
    UpgradeRemediation(
      ...
      remediateLastFailure: json['remediateLastFailure'] as bool?,
      retries: (json['retries'] as num?)?.toInt(),
      strategy: $enumDecodeNullable(_$StrategyEnumEnumMap, json['strategy']),
    );
...
Map<String, dynamic> _$UpgradeRemediationToJson(UpgradeRemediation instance) =>
    <String, dynamic>{
      ...
      'remediateLastFailure': instance.remediateLastFailure,
      'retries': instance.retries,
      'strategy': _$StrategyEnumEnumMap[instance.strategy],
    };

const _$StrategyEnumEnumMap = {
  StrategyEnum.ROLLBACK: 'rollback',
  StrategyEnum.UNINSTALL: 'uninstall',
};

UpgradeStrategy _$UpgradeStrategyFromJson(Map<String, dynamic> json) =>
    UpgradeStrategy(
      name: $enumDecode(_$NameEnumMap, json['name']),
      retryInterval: json['retryInterval'] as String?,
    );

Map<String, dynamic> _$UpgradeStrategyToJson(UpgradeStrategy instance) =>
    <String, dynamic>{
      'name': _$NameEnumMap[instance.name]!,
      'retryInterval': instance.retryInterval,
    };
...
StatusClass _$StatusClassFromJson(Map<String, dynamic> json) => StatusClass(
  ...
  lastAttemptedReleaseActionDuration:
      json['lastAttemptedReleaseActionDuration'] as String?,
  ...
  observedCommonMetadataDigest: json['observedCommonMetadataDigest'] as String?,
...
Map<String, dynamic> _$StatusClassToJson(
  ...
  'lastAttemptedReleaseActionDuration':
      instance.lastAttemptedReleaseActionDuration,
  ...
  'observedCommonMetadataDigest': instance.observedCommonMetadataDigest,
...
HelmreleaselistHelmV2Metadata _$HelmreleaselistHelmV2MetadataFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$HelmreleaselistHelmV2MetadataToJson(
  HelmreleaselistHelmV2Metadata instance,
) => <String, dynamic>{
