...
part 'helmrepositorylist_source_v1.g.dart';

///HelmRepositoryList is a list of HelmRepository
@JsonSerializable()
class HelmrepositorylistSourceV1 {
  ...
  @JsonKey(name: 'kind')
  HelmrepositorylistSourceV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  HelmrepositorylistSourceV1Metadata? metadata;

  HelmrepositorylistSourceV1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory HelmrepositorylistSourceV1.fromJson(Map<String, dynamic> json) =>
      _$HelmrepositorylistSourceV1FromJson(json);

  Map<String, dynamic> toJson() => _$HelmrepositorylistSourceV1ToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum HelmrepositorylistSourceV1Kind {
  @JsonValue('HelmRepositoryList')
  HELM_REPOSITORY_LIST,
}

final helmrepositorylistSourceV1KindValues = EnumValues({
  'HelmRepositoryList': HelmrepositorylistSourceV1Kind.HELM_REPOSITORY_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class HelmrepositorylistSourceV1Metadata {
  ...
  HelmrepositorylistSourceV1Metadata({
  ...
  factory HelmrepositorylistSourceV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$HelmrepositorylistSourceV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$HelmrepositorylistSourceV1MetadataToJson(this);
}
