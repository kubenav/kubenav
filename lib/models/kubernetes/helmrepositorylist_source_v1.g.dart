...
part of 'helmrepositorylist_source_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

HelmrepositorylistSourceV1 _$HelmrepositorylistSourceV1FromJson(
  ...
  kind: $enumDecodeNullable(
    _$HelmrepositorylistSourceV1KindEnumMap,
    json['kind'],
  ),
  metadata: json['metadata'] == null
      ? null
      : HelmrepositorylistSourceV1Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$HelmrepositorylistSourceV1ToJson(
  HelmrepositorylistSourceV1 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$HelmrepositorylistSourceV1KindEnumMap[instance.kind],
...
const _$HelmrepositorylistSourceV1KindEnumMap = {
  HelmrepositorylistSourceV1Kind.HELM_REPOSITORY_LIST: 'HelmRepositoryList',
};
...
HelmrepositorylistSourceV1Metadata _$HelmrepositorylistSourceV1MetadataFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$HelmrepositorylistSourceV1MetadataToJson(
  HelmrepositorylistSourceV1Metadata instance,
) => <String, dynamic>{
