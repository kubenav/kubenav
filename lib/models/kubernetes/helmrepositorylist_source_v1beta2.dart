...
part 'helmrepositorylist_source_v1beta2.g.dart';

///HelmRepositoryList is a list of HelmRepository
@JsonSerializable()
class HelmrepositorylistSourceV1Beta2 {
  ...
  ///List of helmrepositories. More info:
  ...
  @JsonKey(name: 'kind')
  HelmrepositorylistSourceV1Beta2Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  HelmrepositorylistSourceV1Beta2Metadata? metadata;

  HelmrepositorylistSourceV1Beta2({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory HelmrepositorylistSourceV1Beta2.fromJson(Map<String, dynamic> json) =>
      _$HelmrepositorylistSourceV1Beta2FromJson(json);

  Map<String, dynamic> toJson() =>
      _$HelmrepositorylistSourceV1Beta2ToJson(this);
}
...
final itemKindValues = EnumValues({'HelmRepository': ItemKind.HELM_REPOSITORY});
...
class Spec {
  ...
  ///This field is optional, and only taken into account if the .spec.type field is set to
  ///'oci'.
...
final typeValues = EnumValues({'default': Type.DEFAULT, 'oci': Type.OCI});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum HelmrepositorylistSourceV1Beta2Kind {
  @JsonValue('HelmRepositoryList')
  HELM_REPOSITORY_LIST,
}

final helmrepositorylistSourceV1Beta2KindValues = EnumValues({
  'HelmRepositoryList':
      HelmrepositorylistSourceV1Beta2Kind.HELM_REPOSITORY_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class HelmrepositorylistSourceV1Beta2Metadata {
  ...
  HelmrepositorylistSourceV1Beta2Metadata({
  ...
  factory HelmrepositorylistSourceV1Beta2Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$HelmrepositorylistSourceV1Beta2MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$HelmrepositorylistSourceV1Beta2MetadataToJson(this);
}
