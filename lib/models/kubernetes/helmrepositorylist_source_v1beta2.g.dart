...
part of 'helmrepositorylist_source_v1beta2.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

HelmrepositorylistSourceV1Beta2 _$HelmrepositorylistSourceV1Beta2FromJson(
  ...
  kind: $enumDecodeNullable(
    _$HelmrepositorylistSourceV1Beta2KindEnumMap,
    json['kind'],
  ),
  metadata: json['metadata'] == null
      ? null
      : HelmrepositorylistSourceV1Beta2Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$HelmrepositorylistSourceV1Beta2ToJson(
  HelmrepositorylistSourceV1Beta2 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$HelmrepositorylistSourceV1Beta2KindEnumMap[instance.kind],
...
const _$HelmrepositorylistSourceV1Beta2KindEnumMap = {
...
const _$ItemKindEnumMap = {ItemKind.HELM_REPOSITORY: 'HelmRepository'};
...
const _$TypeEnumMap = {Type.DEFAULT: 'default', Type.OCI: 'oci'};
...
_$HelmrepositorylistSourceV1Beta2MetadataFromJson(Map<String, dynamic> json) =>
    HelmrepositorylistSourceV1Beta2Metadata(
...
Map<String, dynamic> _$HelmrepositorylistSourceV1Beta2MetadataToJson(
  HelmrepositorylistSourceV1Beta2Metadata instance,
) => <String, dynamic>{
