...
part 'horizontalpodautoscalerlist_autoscaling_v1.g.dart';

///list of horizontal pod autoscaler objects.
@JsonSerializable()
class HorizontalpodautoscalerlistAutoscalingV1 {
  ...
  @JsonKey(name: 'kind')
  HorizontalpodautoscalerlistAutoscalingV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  HorizontalpodautoscalerlistAutoscalingV1Metadata? metadata;
  ...
  factory HorizontalpodautoscalerlistAutoscalingV1.fromJson(
    Map<String, dynamic> json,
  ) => _$HorizontalpodautoscalerlistAutoscalingV1FromJson(json);

  Map<String, dynamic> toJson() =>
      _$HorizontalpodautoscalerlistAutoscalingV1ToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum HorizontalpodautoscalerlistAutoscalingV1Kind {
  @JsonValue('HorizontalPodAutoscalerList')
  HORIZONTAL_POD_AUTOSCALER_LIST,
}

final horizontalpodautoscalerlistAutoscalingV1KindValues = EnumValues({
  'HorizontalPodAutoscalerList': HorizontalpodautoscalerlistAutoscalingV1Kind
      .HORIZONTAL_POD_AUTOSCALER_LIST,
});
...
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class HorizontalpodautoscalerlistAutoscalingV1Metadata {
  ...
  factory HorizontalpodautoscalerlistAutoscalingV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$HorizontalpodautoscalerlistAutoscalingV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$HorizontalpodautoscalerlistAutoscalingV1MetadataToJson(this);
}
