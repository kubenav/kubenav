...
part 'imagepolicylist_image_v1.g.dart';

///ImagePolicyList is a list of ImagePolicy
@JsonSerializable()
class ImagepolicylistImageV1 {
  ...
  @JsonKey(name: 'kind')
  ImagepolicylistImageV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  ImagepolicylistImageV1Metadata? metadata;

  ImagepolicylistImageV1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory ImagepolicylistImageV1.fromJson(Map<String, dynamic> json) =>
      _$ImagepolicylistImageV1FromJson(json);

  Map<String, dynamic> toJson() => _$ImagepolicylistImageV1ToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ImagepolicylistImageV1Kind {
  @JsonValue('ImagePolicyList')
  IMAGE_POLICY_LIST,
}

final imagepolicylistImageV1KindValues = EnumValues({
  'ImagePolicyList': ImagepolicylistImageV1Kind.IMAGE_POLICY_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class ImagepolicylistImageV1Metadata {
  ...
  ImagepolicylistImageV1Metadata({
  ...
  factory ImagepolicylistImageV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$ImagepolicylistImageV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$ImagepolicylistImageV1MetadataToJson(this);
}
