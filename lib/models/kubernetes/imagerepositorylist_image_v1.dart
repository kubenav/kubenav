...
part 'imagerepositorylist_image_v1.g.dart';

///ImageRepositoryList is a list of ImageRepository
@JsonSerializable()
class ImagerepositorylistImageV1 {
  ...
  ///List of imagerepositories. More info:
  ...
  @JsonKey(name: 'kind')
  ImagerepositorylistImageV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  ImagerepositorylistImageV1Metadata? metadata;

  ImagerepositorylistImageV1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory ImagerepositorylistImageV1.fromJson(Map<String, dynamic> json) =>
      _$ImagerepositorylistImageV1FromJson(json);

  Map<String, dynamic> toJson() => _$ImagerepositorylistImageV1ToJson(this);
}
...
final itemKindValues = EnumValues({
  'ImageRepository': ItemKind.IMAGE_REPOSITORY,
});
...
class StatusClass {
  ...
  ///rather than `alpine`.
  @JsonKey(name: 'canonicalImageName')
  ...
  ///spec.lastScanResult.
  @JsonKey(name: 'observedExclusionList')
...
class LastScanResult {
  ...
  factory LastScanResult.fromJson(Map<String, dynamic> json) =>
      _$LastScanResultFromJson(json);

  Map<String, dynamic> toJson() => _$LastScanResultToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ImagerepositorylistImageV1Kind {
  @JsonValue('ImageRepositoryList')
  IMAGE_REPOSITORY_LIST,
}

final imagerepositorylistImageV1KindValues = EnumValues({
  'ImageRepositoryList': ImagerepositorylistImageV1Kind.IMAGE_REPOSITORY_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class ImagerepositorylistImageV1Metadata {
  ...
  ImagerepositorylistImageV1Metadata({
  ...
  factory ImagerepositorylistImageV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$ImagerepositorylistImageV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ImagerepositorylistImageV1MetadataToJson(this);
}
