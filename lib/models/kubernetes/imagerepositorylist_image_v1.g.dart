...
part of 'imagerepositorylist_image_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ImagerepositorylistImageV1 _$ImagerepositorylistImageV1FromJson(
  ...
  kind: $enumDecodeNullable(
    _$ImagerepositorylistImageV1KindEnumMap,
    json['kind'],
  ),
  metadata: json['metadata'] == null
      ? null
      : ImagerepositorylistImageV1Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$ImagerepositorylistImageV1ToJson(
  ImagerepositorylistImageV1 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$ImagerepositorylistImageV1KindEnumMap[instance.kind],
  'metadata': instance.metadata,
};

const _$ApiVersionEnumMap = {
  ApiVersion.IMAGE_TOOLKIT_FLUXCD_IO_V1: 'image.toolkit.fluxcd.io/v1',
};

const _$ImagerepositorylistImageV1KindEnumMap = {
  ImagerepositorylistImageV1Kind.IMAGE_REPOSITORY_LIST: 'ImageRepositoryList',
};
...
ImagerepositorylistImageV1Metadata _$ImagerepositorylistImageV1MetadataFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$ImagerepositorylistImageV1MetadataToJson(
  ImagerepositorylistImageV1Metadata instance,
) => <String, dynamic>{
