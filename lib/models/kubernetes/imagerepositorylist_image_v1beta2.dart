...
part 'imagerepositorylist_image_v1beta2.g.dart';

///ImageRepositoryList is a list of ImageRepository
@JsonSerializable()
class ImagerepositorylistImageV1Beta2 {
  ...
  @JsonKey(name: 'kind')
  ImagerepositorylistImageV1Beta2Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  ImagerepositorylistImageV1Beta2Metadata? metadata;
  ...
  factory ImagerepositorylistImageV1Beta2.fromJson(Map<String, dynamic> json) =>
      _$ImagerepositorylistImageV1Beta2FromJson(json);

  Map<String, dynamic> toJson() =>
      _$ImagerepositorylistImageV1Beta2ToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ImagerepositorylistImageV1Beta2Kind {
  @JsonValue('ImageRepositoryList')
  IMAGE_REPOSITORY_LIST,
}

final imagerepositorylistImageV1Beta2KindValues = EnumValues({
  'ImageRepositoryList':
...
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class ImagerepositorylistImageV1Beta2Metadata {
  ...
  factory ImagerepositorylistImageV1Beta2Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$ImagerepositorylistImageV1Beta2MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ImagerepositorylistImageV1Beta2MetadataToJson(this);
}
