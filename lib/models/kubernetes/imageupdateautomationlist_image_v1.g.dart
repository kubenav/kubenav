...
part of 'imageupdateautomationlist_image_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ImageupdateautomationlistImageV1 _$ImageupdateautomationlistImageV1FromJson(
  ...
  kind: $enumDecodeNullable(
    _$ImageupdateautomationlistImageV1KindEnumMap,
    json['kind'],
  ),
  metadata: json['metadata'] == null
      ? null
      : ImageupdateautomationlistImageV1Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$ImageupdateautomationlistImageV1ToJson(
  ImageupdateautomationlistImageV1 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$ImageupdateautomationlistImageV1KindEnumMap[instance.kind],
...
const _$ImageupdateautomationlistImageV1KindEnumMap = {
...
_$ImageupdateautomationlistImageV1MetadataFromJson(Map<String, dynamic> json) =>
    ImageupdateautomationlistImageV1Metadata(
...
Map<String, dynamic> _$ImageupdateautomationlistImageV1MetadataToJson(
  ImageupdateautomationlistImageV1Metadata instance,
) => <String, dynamic>{
