...
part 'ingressclasslist_networking_v1.g.dart';

///IngressClassList is a collection of IngressClasses.
@JsonSerializable()
class IngressclasslistNetworkingV1 {
  ...
  @JsonKey(name: 'kind')
  IngressclasslistNetworkingV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  IngressclasslistNetworkingV1Metadata? metadata;

  IngressclasslistNetworkingV1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory IngressclasslistNetworkingV1.fromJson(Map<String, dynamic> json) =>
      _$IngressclasslistNetworkingV1FromJson(json);

  Map<String, dynamic> toJson() => _$IngressclasslistNetworkingV1ToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
  @JsonValue('IngressClass')
  INGRESS_CLASS,
}

final itemKindValues = EnumValues({'IngressClass': ItemKind.INGRESS_CLASS});
...
class Spec {
  ...
  Spec({this.controller, this.parameters});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum IngressclasslistNetworkingV1Kind {
  @JsonValue('IngressClassList')
  INGRESS_CLASS_LIST,
}

final ingressclasslistNetworkingV1KindValues = EnumValues({
  'IngressClassList': IngressclasslistNetworkingV1Kind.INGRESS_CLASS_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class IngressclasslistNetworkingV1Metadata {
  ...
  IngressclasslistNetworkingV1Metadata({
  ...
  factory IngressclasslistNetworkingV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$IngressclasslistNetworkingV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$IngressclasslistNetworkingV1MetadataToJson(this);
}
