...
part of 'ingressclasslist_networking_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

IngressclasslistNetworkingV1 _$IngressclasslistNetworkingV1FromJson(
  ...
  kind: $enumDecodeNullable(
    _$IngressclasslistNetworkingV1KindEnumMap,
    json['kind'],
  ),
  metadata: json['metadata'] == null
      ? null
      : IngressclasslistNetworkingV1Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$IngressclasslistNetworkingV1ToJson(
  IngressclasslistNetworkingV1 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$IngressclasslistNetworkingV1KindEnumMap[instance.kind],
...
const _$IngressclasslistNetworkingV1KindEnumMap = {
  IngressclasslistNetworkingV1Kind.INGRESS_CLASS_LIST: 'IngressClassList',
};
...
const _$ItemKindEnumMap = {ItemKind.INGRESS_CLASS: 'IngressClass'};
...
_$IngressclasslistNetworkingV1MetadataFromJson(Map<String, dynamic> json) =>
    IngressclasslistNetworkingV1Metadata(
...
Map<String, dynamic> _$IngressclasslistNetworkingV1MetadataToJson(
  IngressclasslistNetworkingV1Metadata instance,
) => <String, dynamic>{
