...
import 'package:kubenav/models/kubernetes/io_k8s_api_admissionregistration_v1_validating_webhook_configuration.dart';
...
class IoK8sApiAdmissionregistrationV1ValidatingWebhookConfigurationList {
  ...
  bool operator ==(Object other) =>
      ...
      other is IoK8sApiAdmissionregistrationV1ValidatingWebhookConfigurationList &&
  ...
  @override
  String toString() =>
      'IoK8sApiAdmissionregistrationV1ValidatingWebhookConfigurationList[apiVersion=$apiVersion, items=$items, kind=$kind, metadata=$metadata]';
  ...
  static IoK8sApiAdmissionregistrationV1ValidatingWebhookConfigurationList?
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoK8sApiAdmissionregistrationV1ValidatingWebhookConfigurationList[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoK8sApiAdmissionregistrationV1ValidatingWebhookConfigurationList[$key]" has a null value in JSON.');
        });
        return true;
      }());
