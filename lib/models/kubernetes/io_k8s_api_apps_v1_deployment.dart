...
import 'package:kubenav/models/kubernetes/io_k8s_api_apps_v1_deployment_spec.dart';
import 'package:kubenav/models/kubernetes/io_k8s_api_apps_v1_deployment_status.dart';
...
class IoK8sApiAppsV1Deployment {
  ...
  bool operator ==(Object other) =>
      ...
      other is IoK8sApiAppsV1Deployment &&
  ...
  @override
  String toString() =>
      'IoK8sApiAppsV1Deployment[apiVersion=$apiVersion, kind=$kind, metadata=$metadata, spec=$spec, status=$status]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoK8sApiAppsV1Deployment[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoK8sApiAppsV1Deployment[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiAppsV1Deployment>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<IoK8sApiAppsV1Deployment>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAppsV1Deployment.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
