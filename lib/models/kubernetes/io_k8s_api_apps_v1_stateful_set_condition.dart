...
class IoK8sApiAppsV1StatefulSetCondition {
  ...
  bool operator ==(Object other) =>
      ...
      other is IoK8sApiAppsV1StatefulSetCondition &&
  ...
  @override
  String toString() =>
      'IoK8sApiAppsV1StatefulSetCondition[lastTransitionTime=$lastTransitionTime, message=$message, reason=$reason, status=$status, type=$type]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoK8sApiAppsV1StatefulSetCondition[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoK8sApiAppsV1StatefulSetCondition[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiAppsV1StatefulSetCondition>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, IoK8sApiAppsV1StatefulSetCondition> mapFromJson(
      dynamic json) {
  ...
  static Map<String, List<IoK8sApiAppsV1StatefulSetCondition>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAppsV1StatefulSetCondition.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
