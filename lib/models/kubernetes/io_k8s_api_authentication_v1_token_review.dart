...
import 'package:kubenav/models/kubernetes/io_k8s_api_authentication_v1_token_review_spec.dart';
import 'package:kubenav/models/kubernetes/io_k8s_api_authentication_v1_token_review_status.dart';
...
class IoK8sApiAuthenticationV1TokenReview {
  ...
  bool operator ==(Object other) =>
      ...
      other is IoK8sApiAuthenticationV1TokenReview &&
  ...
  @override
  String toString() =>
      'IoK8sApiAuthenticationV1TokenReview[apiVersion=$apiVersion, kind=$kind, metadata=$metadata, spec=$spec, status=$status]';
  ...
  static IoK8sApiAuthenticationV1TokenReview? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoK8sApiAuthenticationV1TokenReview[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoK8sApiAuthenticationV1TokenReview[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiAuthenticationV1TokenReview(
        ...
        status:
            IoK8sApiAuthenticationV1TokenReviewStatus.fromJson(json[r'status']),
      );
    }
    return null;
  }

  static List<IoK8sApiAuthenticationV1TokenReview>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, IoK8sApiAuthenticationV1TokenReview> mapFromJson(
      dynamic json) {
  ...
  static Map<String, List<IoK8sApiAuthenticationV1TokenReview>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiAuthenticationV1TokenReview.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
