...
import 'package:kubenav/models/kubernetes/io_k8s_api_batch_v1_cron_job_spec.dart';
import 'package:kubenav/models/kubernetes/io_k8s_api_batch_v1_cron_job_status.dart';
...
class IoK8sApiBatchV1CronJob {
  ...
  bool operator ==(Object other) =>
      ...
      other is IoK8sApiBatchV1CronJob &&
  ...
  @override
  String toString() =>
      'IoK8sApiBatchV1CronJob[apiVersion=$apiVersion, kind=$kind, metadata=$metadata, spec=$spec, status=$status]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoK8sApiBatchV1CronJob[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoK8sApiBatchV1CronJob[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiBatchV1CronJob>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<IoK8sApiBatchV1CronJob>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiBatchV1CronJob.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
