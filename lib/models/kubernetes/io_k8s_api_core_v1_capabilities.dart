...
class IoK8sApiCoreV1Capabilities {
  ...
  bool operator ==(Object other) =>
      ...
      other is IoK8sApiCoreV1Capabilities &&
          other.add == add &&
          other.drop == drop;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoK8sApiCoreV1Capabilities[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoK8sApiCoreV1Capabilities[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiCoreV1Capabilities>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<IoK8sApiCoreV1Capabilities>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1Capabilities.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
