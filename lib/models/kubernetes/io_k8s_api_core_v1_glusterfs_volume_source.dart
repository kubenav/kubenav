...
class IoK8sApiCoreV1GlusterfsVolumeSource {
  ...
  bool operator ==(Object other) =>
      ...
      other is IoK8sApiCoreV1GlusterfsVolumeSource &&
  ...
  @override
  String toString() =>
      'IoK8sApiCoreV1GlusterfsVolumeSource[endpoints=$endpoints, path=$path, readOnly=$readOnly]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoK8sApiCoreV1GlusterfsVolumeSource[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoK8sApiCoreV1GlusterfsVolumeSource[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiCoreV1GlusterfsVolumeSource>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, IoK8sApiCoreV1GlusterfsVolumeSource> mapFromJson(
      dynamic json) {
  ...
  static Map<String, List<IoK8sApiCoreV1GlusterfsVolumeSource>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1GlusterfsVolumeSource.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
