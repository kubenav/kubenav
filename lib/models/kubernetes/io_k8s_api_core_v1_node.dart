...
import 'package:kubenav/models/kubernetes/io_k8s_api_core_v1_node_spec.dart';
import 'package:kubenav/models/kubernetes/io_k8s_api_core_v1_node_status.dart';
...
class IoK8sApiCoreV1Node {
  ...
  static Map<String, List<IoK8sApiCoreV1Node>> mapListFromJson(
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1Node.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
