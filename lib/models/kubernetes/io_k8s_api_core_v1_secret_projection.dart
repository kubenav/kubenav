...
class IoK8sApiCoreV1SecretProjection {
  ...
  bool operator ==(Object other) =>
      ...
      other is IoK8sApiCoreV1SecretProjection &&
          other.items == items &&
          other.name == name &&
  ...
  @override
  String toString() =>
      'IoK8sApiCoreV1SecretProjection[items=$items, name=$name, optional=$optional]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoK8sApiCoreV1SecretProjection[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoK8sApiCoreV1SecretProjection[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiCoreV1SecretProjection>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<IoK8sApiCoreV1SecretProjection>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiCoreV1SecretProjection.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
