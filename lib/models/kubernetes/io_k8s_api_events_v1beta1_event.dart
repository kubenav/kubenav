...
import 'package:kubenav/models/kubernetes/io_k8s_api_events_v1beta1_event_series.dart';
...
class IoK8sApiEventsV1beta1Event {
  /// Returns a new [IoK8sApiEventsV1beta1Event] instance.
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  IoK8sApiEventsV1beta1EventSeries? series;
  ...
  bool operator ==(Object other) =>
      ...
      other is IoK8sApiEventsV1beta1Event &&
          other.action == action &&
  ...
  /// Returns a new [IoK8sApiEventsV1beta1Event] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IoK8sApiEventsV1beta1Event? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoK8sApiEventsV1beta1Event[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoK8sApiEventsV1beta1Event[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiEventsV1beta1Event(
        ...
        series: IoK8sApiEventsV1beta1EventSeries.fromJson(json[r'series']),
  ...
  static List<IoK8sApiEventsV1beta1Event>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <IoK8sApiEventsV1beta1Event>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IoK8sApiEventsV1beta1Event.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IoK8sApiEventsV1beta1Event> mapFromJson(dynamic json) {
    final map = <String, IoK8sApiEventsV1beta1Event>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiEventsV1beta1Event.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IoK8sApiEventsV1beta1Event-objects as value to a dart map
  static Map<String, List<IoK8sApiEventsV1beta1Event>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map = <String, List<IoK8sApiEventsV1beta1Event>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiEventsV1beta1Event.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
