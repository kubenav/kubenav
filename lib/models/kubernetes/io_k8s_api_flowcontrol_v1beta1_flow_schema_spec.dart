...
import 'package:kubenav/models/kubernetes/io_k8s_api_flowcontrol_v1beta1_flow_distinguisher_method.dart';
import 'package:kubenav/models/kubernetes/io_k8s_api_flowcontrol_v1beta1_policy_rules_with_subjects.dart';
import 'package:kubenav/models/kubernetes/io_k8s_api_flowcontrol_v1beta1_priority_level_configuration_reference.dart';
...
class IoK8sApiFlowcontrolV1beta1FlowSchemaSpec {
  ...
  bool operator ==(Object other) =>
      ...
      other is IoK8sApiFlowcontrolV1beta1FlowSchemaSpec &&
  ...
  @override
  String toString() =>
      'IoK8sApiFlowcontrolV1beta1FlowSchemaSpec[distinguisherMethod=$distinguisherMethod, matchingPrecedence=$matchingPrecedence, priorityLevelConfiguration=$priorityLevelConfiguration, rules=$rules]';
  ...
  static IoK8sApiFlowcontrolV1beta1FlowSchemaSpec? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoK8sApiFlowcontrolV1beta1FlowSchemaSpec[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoK8sApiFlowcontrolV1beta1FlowSchemaSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApiFlowcontrolV1beta1FlowSchemaSpec(
        ...
        rules: IoK8sApiFlowcontrolV1beta1PolicyRulesWithSubjects.listFromJson(
                json[r'rules']) ??
            const [],
      );
    }
  ...
  static List<IoK8sApiFlowcontrolV1beta1FlowSchemaSpec>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, IoK8sApiFlowcontrolV1beta1FlowSchemaSpec> mapFromJson(
      dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value =
            IoK8sApiFlowcontrolV1beta1FlowSchemaSpec.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiFlowcontrolV1beta1FlowSchemaSpec>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiFlowcontrolV1beta1FlowSchemaSpec.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
