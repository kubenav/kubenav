...
import 'package:kubenav/models/kubernetes/io_k8s_api_flowcontrol_v1beta2_flow_schema_condition.dart';
...
class IoK8sApiFlowcontrolV1beta2FlowSchemaStatus {
  ...
  bool operator ==(Object other) =>
      ...
      other is IoK8sApiFlowcontrolV1beta2FlowSchemaStatus &&
  ...
  @override
  String toString() =>
      'IoK8sApiFlowcontrolV1beta2FlowSchemaStatus[conditions=$conditions]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoK8sApiFlowcontrolV1beta2FlowSchemaStatus[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoK8sApiFlowcontrolV1beta2FlowSchemaStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoK8sApiFlowcontrolV1beta2FlowSchemaStatus(
        conditions: IoK8sApiFlowcontrolV1beta2FlowSchemaCondition.listFromJson(
                json[r'conditions']) ??
            const [],
      );
    }
  ...
  static List<IoK8sApiFlowcontrolV1beta2FlowSchemaStatus>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, IoK8sApiFlowcontrolV1beta2FlowSchemaStatus> mapFromJson(
      dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value =
            IoK8sApiFlowcontrolV1beta2FlowSchemaStatus.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiFlowcontrolV1beta2FlowSchemaStatus>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiFlowcontrolV1beta2FlowSchemaStatus.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
