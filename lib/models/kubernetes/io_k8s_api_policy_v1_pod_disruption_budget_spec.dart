...
class IoK8sApiPolicyV1PodDisruptionBudgetSpec {
  ...
  bool operator ==(Object other) =>
      ...
      other is IoK8sApiPolicyV1PodDisruptionBudgetSpec &&
  ...
  @override
  String toString() =>
      'IoK8sApiPolicyV1PodDisruptionBudgetSpec[maxUnavailable=$maxUnavailable, minAvailable=$minAvailable, selector=$selector]';
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoK8sApiPolicyV1PodDisruptionBudgetSpec[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoK8sApiPolicyV1PodDisruptionBudgetSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiPolicyV1PodDisruptionBudgetSpec>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, IoK8sApiPolicyV1PodDisruptionBudgetSpec> mapFromJson(
      dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value =
            IoK8sApiPolicyV1PodDisruptionBudgetSpec.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApiPolicyV1PodDisruptionBudgetSpec>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiPolicyV1PodDisruptionBudgetSpec.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
