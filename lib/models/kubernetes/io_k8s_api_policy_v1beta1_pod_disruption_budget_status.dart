...
class IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus {
  /// Returns a new [IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus &&
  ...
  @override
  String toString() =>
      'IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus[conditions=$conditions, currentHealthy=$currentHealthy, desiredHealthy=$desiredHealthy, disruptedPods=$disruptedPods, disruptionsAllowed=$disruptionsAllowed, expectedPods=$expectedPods, observedGeneration=$observedGeneration]';
  ...
  /// Returns a new [IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus? fromJson(
      dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value =
            IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus>
      mapFromJson(dynamic json) {
    final map = <String, IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus.fromJson(
            entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
  ...
  // maps a json object with a list of IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus-objects as value to a dart map
  static Map<String, List<IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map =
        <String, List<IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus>>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value =
            IoK8sApiPolicyV1beta1PodDisruptionBudgetStatus.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
