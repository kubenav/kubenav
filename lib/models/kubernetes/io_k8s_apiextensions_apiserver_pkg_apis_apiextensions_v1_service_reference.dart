...
class IoK8sApiextensionsApiserverPkgApisApiextensionsV1ServiceReference {
  ...
  bool operator ==(Object other) =>
      ...
      other is IoK8sApiextensionsApiserverPkgApisApiextensionsV1ServiceReference &&
          other.name == name &&
  ...
  @override
  String toString() =>
      'IoK8sApiextensionsApiserverPkgApisApiextensionsV1ServiceReference[name=$name, namespace=$namespace, path=$path, port=$port]';
  ...
  static IoK8sApiextensionsApiserverPkgApisApiextensionsV1ServiceReference?
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoK8sApiextensionsApiserverPkgApisApiextensionsV1ServiceReference[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoK8sApiextensionsApiserverPkgApisApiextensionsV1ServiceReference[$key]" has a null value in JSON.');
        });
        return true;
      }());
