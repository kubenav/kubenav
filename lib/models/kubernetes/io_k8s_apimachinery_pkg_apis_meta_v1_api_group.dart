...
import 'package:kubenav/models/kubernetes/io_k8s_apimachinery_pkg_apis_meta_v1_group_version_for_discovery.dart';
...
class IoK8sApimachineryPkgApisMetaV1APIGroup {
  ...
  bool operator ==(Object other) =>
      ...
      other is IoK8sApimachineryPkgApisMetaV1APIGroup &&
  ...
  @override
  String toString() =>
      'IoK8sApimachineryPkgApisMetaV1APIGroup[apiVersion=$apiVersion, kind=$kind, name=$name, preferredVersion=$preferredVersion, serverAddressByClientCIDRs=$serverAddressByClientCIDRs, versions=$versions]';
  ...
  Map<String, dynamic> toJson() {
    ...
    if (preferredVersion != null) {
      json[r'preferredVersion'] = preferredVersion;
    }
    json[r'serverAddressByClientCIDRs'] = serverAddressByClientCIDRs;
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoK8sApimachineryPkgApisMetaV1APIGroup[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoK8sApimachineryPkgApisMetaV1APIGroup[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return IoK8sApimachineryPkgApisMetaV1APIGroup(
        ...
        preferredVersion:
            IoK8sApimachineryPkgApisMetaV1GroupVersionForDiscovery.fromJson(
                json[r'preferredVersion']),
        serverAddressByClientCIDRs:
            IoK8sApimachineryPkgApisMetaV1ServerAddressByClientCIDR
                    .listFromJson(json[r'serverAddressByClientCIDRs']) ??
                const [],
        versions:
            IoK8sApimachineryPkgApisMetaV1GroupVersionForDiscovery.listFromJson(
                json[r'versions'])!,
      );
    }
    return null;
  ...
  static List<IoK8sApimachineryPkgApisMetaV1APIGroup>? listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, IoK8sApimachineryPkgApisMetaV1APIGroup> mapFromJson(
      dynamic json) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        final value =
            IoK8sApimachineryPkgApisMetaV1APIGroup.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<IoK8sApimachineryPkgApisMetaV1APIGroup>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoK8sApimachineryPkgApisMetaV1APIGroup.listFromJson(
          entry.value,
          growable: growable,
        );
        if (value != null) {
