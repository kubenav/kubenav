...
class IoK8sApimachineryPkgApisMetaV1ObjectMeta {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (clusterName != null) {
      json[r'clusterName'] = clusterName;
    }
    if (creationTimestamp != null) {
      json[r'creationTimestamp'] = creationTimestamp!.toUtc().toIso8601String();
    }
    if (deletionGracePeriodSeconds != null) {
      json[r'deletionGracePeriodSeconds'] = deletionGracePeriodSeconds;
    }
    if (deletionTimestamp != null) {
      json[r'deletionTimestamp'] = deletionTimestamp!.toUtc().toIso8601String();
    }
    json[r'finalizers'] = finalizers;
    if (generateName != null) {
      json[r'generateName'] = generateName;
    }
    if (generation != null) {
      json[r'generation'] = generation;
    }
    json[r'labels'] = labels;
    json[r'managedFields'] = managedFields;
    if (name != null) {
      json[r'name'] = name;
    }
    if (namespace != null) {
    ...
    json[r'ownerReferences'] = ownerReferences;
