...
part 'ipaddresslist_networking_v1.g.dart';

///IPAddressList contains a list of IPAddress.
@JsonSerializable()
class IpaddresslistNetworkingV1 {
  ...
  @JsonKey(name: 'kind')
  IpaddresslistNetworkingV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  IpaddresslistNetworkingV1Metadata? metadata;

  IpaddresslistNetworkingV1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory IpaddresslistNetworkingV1.fromJson(Map<String, dynamic> json) =>
      _$IpaddresslistNetworkingV1FromJson(json);

  Map<String, dynamic> toJson() => _$IpaddresslistNetworkingV1ToJson(this);
}
...
final itemKindValues = EnumValues({'IPAddress': ItemKind.IP_ADDRESS});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum IpaddresslistNetworkingV1Kind {
  @JsonValue('IPAddressList')
  IP_ADDRESS_LIST,
}

final ipaddresslistNetworkingV1KindValues = EnumValues({
  'IPAddressList': IpaddresslistNetworkingV1Kind.IP_ADDRESS_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class IpaddresslistNetworkingV1Metadata {
  ...
  IpaddresslistNetworkingV1Metadata({
  ...
  factory IpaddresslistNetworkingV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$IpaddresslistNetworkingV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$IpaddresslistNetworkingV1MetadataToJson(this);
}
