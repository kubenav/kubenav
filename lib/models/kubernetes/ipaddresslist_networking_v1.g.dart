...
part of 'ipaddresslist_networking_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

IpaddresslistNetworkingV1 _$IpaddresslistNetworkingV1FromJson(
  ...
  kind: $enumDecodeNullable(
    _$IpaddresslistNetworkingV1KindEnumMap,
    json['kind'],
  ),
  metadata: json['metadata'] == null
      ? null
      : IpaddresslistNetworkingV1Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$IpaddresslistNetworkingV1ToJson(
  IpaddresslistNetworkingV1 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$IpaddresslistNetworkingV1KindEnumMap[instance.kind],
...
const _$IpaddresslistNetworkingV1KindEnumMap = {
  IpaddresslistNetworkingV1Kind.IP_ADDRESS_LIST: 'IPAddressList',
};
...
const _$ItemKindEnumMap = {ItemKind.IP_ADDRESS: 'IPAddress'};
...
Spec _$SpecFromJson(Map<String, dynamic> json) => Spec(
  parentRef: ParentRef.fromJson(json['parentRef'] as Map<String, dynamic>),
);
...
IpaddresslistNetworkingV1Metadata _$IpaddresslistNetworkingV1MetadataFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$IpaddresslistNetworkingV1MetadataToJson(
  IpaddresslistNetworkingV1Metadata instance,
) => <String, dynamic>{
