...
part 'issuerlist_cert_manager_v1.g.dart';

///IssuerList is a list of Issuer
@JsonSerializable()
class IssuerlistCertManagerV1 {
  ...
  @JsonKey(name: 'kind')
  IssuerlistCertManagerV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  IssuerlistCertManagerV1Metadata? metadata;

  IssuerlistCertManagerV1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory IssuerlistCertManagerV1.fromJson(Map<String, dynamic> json) =>
      _$IssuerlistCertManagerV1FromJson(json);

  Map<String, dynamic> toJson() => _$IssuerlistCertManagerV1ToJson(this);
}
...
final itemKindValues = EnumValues({'Issuer': ItemKind.ISSUER});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum IssuerlistCertManagerV1Kind {
  @JsonValue('IssuerList')
  ISSUER_LIST,
}

final issuerlistCertManagerV1KindValues = EnumValues({
  'IssuerList': IssuerlistCertManagerV1Kind.ISSUER_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class IssuerlistCertManagerV1Metadata {
  ...
  IssuerlistCertManagerV1Metadata({
  ...
  factory IssuerlistCertManagerV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$IssuerlistCertManagerV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$IssuerlistCertManagerV1MetadataToJson(this);
}
