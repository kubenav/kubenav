...
part 'joblist_batch_v1.g.dart';

///JobList is a collection of jobs.
@JsonSerializable()
class JoblistBatchV1 {
  ...
  @JsonKey(name: 'kind')
  JoblistBatchV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  JoblistBatchV1Metadata? metadata;
  ...
  factory JoblistBatchV1.fromJson(Map<String, dynamic> json) =>
      _$JoblistBatchV1FromJson(json);

  Map<String, dynamic> toJson() => _$JoblistBatchV1ToJson(this);
}
...
class JoblistBatchV1Item {
  ...
  factory JoblistBatchV1Item.fromJson(Map<String, dynamic> json) =>
      _$JoblistBatchV1ItemFromJson(json);

  Map<String, dynamic> toJson() => _$JoblistBatchV1ItemToJson(this);
}
...
final itemKindValues = EnumValues({'Job': ItemKind.JOB});
...
class UncountedTerminatedPods {
  ...
  UncountedTerminatedPods({this.failed, this.succeeded});

  factory UncountedTerminatedPods.fromJson(Map<String, dynamic> json) =>
      _$UncountedTerminatedPodsFromJson(json);
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum JoblistBatchV1Kind {
  @JsonValue('JobList')
  JOB_LIST,
}

final joblistBatchV1KindValues = EnumValues({
  'JobList': JoblistBatchV1Kind.JOB_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class JoblistBatchV1Metadata {
  ...
  factory JoblistBatchV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$JoblistBatchV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$JoblistBatchV1MetadataToJson(this);
}
