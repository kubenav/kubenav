...
part of 'joblist_batch_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

JoblistBatchV1 _$JoblistBatchV1FromJson(Map<String, dynamic> json) =>
    JoblistBatchV1(
      ...
      items: (json['items'] as List<dynamic>)
          .map(
            (e) => e == null
                ? null
                : JoblistBatchV1Item.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
      kind: $enumDecodeNullable(_$JoblistBatchV1KindEnumMap, json['kind']),
      metadata: json['metadata'] == null
          ? null
          : JoblistBatchV1Metadata.fromJson(
              json['metadata'] as Map<String, dynamic>,
            ),
    );

Map<String, dynamic> _$JoblistBatchV1ToJson(JoblistBatchV1 instance) =>
    <String, dynamic>{
      'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
      'items': instance.items,
      'kind': _$JoblistBatchV1KindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$ApiVersionEnumMap = {ApiVersion.BATCH_V1: 'batch/v1'};

const _$JoblistBatchV1KindEnumMap = {JoblistBatchV1Kind.JOB_LIST: 'JobList'};

JoblistBatchV1Item _$JoblistBatchV1ItemFromJson(Map<String, dynamic> json) =>
    JoblistBatchV1Item(
      apiVersion: $enumDecodeNullable(_$ApiVersionEnumMap, json['apiVersion']),
...
Map<String, dynamic> _$JoblistBatchV1ItemToJson(JoblistBatchV1Item instance) =>
    <String, dynamic>{
      'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
...
const _$ItemKindEnumMap = {ItemKind.JOB: 'Job'};
...
JoblistBatchV1Metadata _$JoblistBatchV1MetadataFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$JoblistBatchV1MetadataToJson(
  JoblistBatchV1Metadata instance,
) => <String, dynamic>{
