...
part 'kustomizationlist_kustomize_v1.g.dart';

///KustomizationList is a list of Kustomization
@JsonSerializable()
class KustomizationlistKustomizeV1 {
  ...
  @JsonKey(name: 'kind')
  KustomizationlistKustomizeV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  KustomizationlistKustomizeV1Metadata? metadata;
  ...
  factory KustomizationlistKustomizeV1.fromJson(Map<String, dynamic> json) =>
      _$KustomizationlistKustomizeV1FromJson(json);

  Map<String, dynamic> toJson() => _$KustomizationlistKustomizeV1ToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
enum ApiVersion {
  @JsonValue('kustomize.toolkit.fluxcd.io/v1')
  KUSTOMIZE_TOOLKIT_FLUXCD_IO_V1,
}

final apiVersionValues = EnumValues({
  'kustomize.toolkit.fluxcd.io/v1': ApiVersion.KUSTOMIZE_TOOLKIT_FLUXCD_IO_V1,
});
...
class Spec {
  ...
  @JsonKey(name: 'healthCheckExprs')
  List<HealthCheckExpr?>? healthCheckExprs;
...
class Decryption {
  ...
  Decryption({required this.provider, this.secretRef, this.serviceAccountName});
...
final deletionPolicyValues = EnumValues({
  ...
  'MirrorPrune': DeletionPolicy.MIRROR_PRUNE,
  'Orphan': DeletionPolicy.ORPHAN,
  'WaitForTermination': DeletionPolicy.WAIT_FOR_TERMINATION,
});
...
class DependsOn {
  ...
  @JsonKey(name: 'readyExpr')
  String? readyExpr;

  DependsOn({required this.name, this.namespace, this.readyExpr});
...
class HealthCheckExpr {
  ...
  factory HealthCheckExpr.fromJson(Map<String, dynamic> json) =>
      _$HealthCheckExprFromJson(json);

  Map<String, dynamic> toJson() => _$HealthCheckExprToJson(this);
}
...
class Patch {
  ...
  Patch({required this.patch, this.target});
...
final sourceRefKindValues = EnumValues({
  ...
  'ExternalArtifact': SourceRefKind.EXTERNAL_ARTIFACT,
...
class StatusClass {
  ...
  @JsonKey(name: 'lastAppliedOriginRevision')
  String? lastAppliedOriginRevision;
  ...
  StatusClass({
    ...
    this.history,
    this.inventory,
    this.lastAppliedOriginRevision,
...
class History {
  ...
  @JsonKey(name: 'firstReconciled')
  DateTime firstReconciled;

  ///LastReconciled is the time when this revision was last reconciled to the cluster.
  @JsonKey(name: 'lastReconciled')
  DateTime lastReconciled;

  ///LastReconciledDuration is time it took to reconcile the resources in this revision.
  @JsonKey(name: 'lastReconciledDuration')
  String lastReconciledDuration;

  ///LastReconciledStatus is the status of the last reconciliation.
  @JsonKey(name: 'lastReconciledStatus')
  String lastReconciledStatus;

  ///Metadata contains additional information about the snapshot.
  @JsonKey(name: 'metadata')
  Map<String, String?>? metadata;

  ///TotalReconciliations is the total number of reconciliations that have occurred for this
  ///snapshot.
  @JsonKey(name: 'totalReconciliations')
  int totalReconciliations;

  History({
    required this.digest,
    required this.firstReconciled,
    required this.lastReconciled,
    required this.lastReconciledDuration,
    required this.lastReconciledStatus,
    this.metadata,
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum KustomizationlistKustomizeV1Kind {
  @JsonValue('KustomizationList')
  KUSTOMIZATION_LIST,
}

final kustomizationlistKustomizeV1KindValues = EnumValues({
  'KustomizationList': KustomizationlistKustomizeV1Kind.KUSTOMIZATION_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class KustomizationlistKustomizeV1Metadata {
  ...
  factory KustomizationlistKustomizeV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$KustomizationlistKustomizeV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$KustomizationlistKustomizeV1MetadataToJson(this);
}
