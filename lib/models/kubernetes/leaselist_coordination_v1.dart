...
part 'leaselist_coordination_v1.g.dart';

///LeaseList is a list of Lease objects.
@JsonSerializable()
class LeaselistCoordinationV1 {
  ...
  @JsonKey(name: 'kind')
  LeaselistCoordinationV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  LeaselistCoordinationV1Metadata? metadata;

  LeaselistCoordinationV1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory LeaselistCoordinationV1.fromJson(Map<String, dynamic> json) =>
      _$LeaselistCoordinationV1FromJson(json);

  Map<String, dynamic> toJson() => _$LeaselistCoordinationV1ToJson(this);
}
...
final itemKindValues = EnumValues({'Lease': ItemKind.LEASE});
...
class Spec {
  ...
  ///holderIdentity contains the identity of the holder of a current lease. If Coordinated
  ...
  ///acquire it. This is measured against the time of last observed renewTime.
  ...
  ///If the field is not specified, there is no active coordination for this lease. (Alpha)
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum LeaselistCoordinationV1Kind {
  @JsonValue('LeaseList')
  LEASE_LIST,
}

final leaselistCoordinationV1KindValues = EnumValues({
  'LeaseList': LeaselistCoordinationV1Kind.LEASE_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class LeaselistCoordinationV1Metadata {
  ...
  LeaselistCoordinationV1Metadata({
  ...
  factory LeaselistCoordinationV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$LeaselistCoordinationV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$LeaselistCoordinationV1MetadataToJson(this);
}
