...
part of 'leaselist_coordination_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

LeaselistCoordinationV1 _$LeaselistCoordinationV1FromJson(
  ...
  items: (json['items'] as List<dynamic>)
      ...
      .toList(),
  kind: $enumDecodeNullable(_$LeaselistCoordinationV1KindEnumMap, json['kind']),
  metadata: json['metadata'] == null
      ? null
      : LeaselistCoordinationV1Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$LeaselistCoordinationV1ToJson(
  LeaselistCoordinationV1 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$LeaselistCoordinationV1KindEnumMap[instance.kind],
  'metadata': instance.metadata,
};

const _$ApiVersionEnumMap = {
  ApiVersion.COORDINATION_K8_S_IO_V1: 'coordination.k8s.io/v1',
};

const _$LeaselistCoordinationV1KindEnumMap = {
  LeaselistCoordinationV1Kind.LEASE_LIST: 'LeaseList',
};
...
const _$ItemKindEnumMap = {ItemKind.LEASE: 'Lease'};
...
Spec _$SpecFromJson(Map<String, dynamic> json) => Spec(
  ...
  preferredHolder: json['preferredHolder'] as String?,
...
Map<String, dynamic> _$SpecToJson(Spec instance) => <String, dynamic>{
  ...
  'preferredHolder': instance.preferredHolder,
  'renewTime': instance.renewTime?.toIso8601String(),
  'strategy': instance.strategy,
};

LeaselistCoordinationV1Metadata _$LeaselistCoordinationV1MetadataFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$LeaselistCoordinationV1MetadataToJson(
  LeaselistCoordinationV1Metadata instance,
) => <String, dynamic>{
