...
part 'limitrangelist_v1.g.dart';

///LimitRangeList is a list of LimitRange items.
@JsonSerializable()
class LimitrangelistV1 {
  ...
  @JsonKey(name: 'kind')
  LimitrangelistV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  LimitrangelistV1Metadata? metadata;
  ...
  factory LimitrangelistV1.fromJson(Map<String, dynamic> json) =>
      _$LimitrangelistV1FromJson(json);

  Map<String, dynamic> toJson() => _$LimitrangelistV1ToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
  @JsonValue('LimitRange')
  LIMIT_RANGE,
}

final itemKindValues = EnumValues({'LimitRange': ItemKind.LIMIT_RANGE});
...
class Limit {
  ...
  Map<String, dynamic>? limitDefault;
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum LimitrangelistV1Kind {
  @JsonValue('LimitRangeList')
  LIMIT_RANGE_LIST,
}

final limitrangelistV1KindValues = EnumValues({
  'LimitRangeList': LimitrangelistV1Kind.LIMIT_RANGE_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class LimitrangelistV1Metadata {
  ...
  factory LimitrangelistV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$LimitrangelistV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$LimitrangelistV1MetadataToJson(this);
}
