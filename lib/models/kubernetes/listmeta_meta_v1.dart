...
part 'listmeta_meta_v1.g.dart';

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class ListmetaMetaV1 {
  ...
  ListmetaMetaV1({
    this.listmetaMetaV1Continue,
    this.remainingItemCount,
    this.resourceVersion,
    this.selfLink,
  });

  factory ListmetaMetaV1.fromJson(Map<String, dynamic> json) =>
      _$ListmetaMetaV1FromJson(json);

  Map<String, dynamic> toJson() => _$ListmetaMetaV1ToJson(this);
}
