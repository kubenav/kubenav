...
part 'mutatingwebhookconfigurationlist_admissionregistration_v1.g.dart';

///MutatingWebhookConfigurationList is a list of MutatingWebhookConfiguration.
@JsonSerializable()
class MutatingwebhookconfigurationlistAdmissionregistrationV1 {
  ...
  @JsonKey(name: 'kind')
  MutatingwebhookconfigurationlistAdmissionregistrationV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  MutatingwebhookconfigurationlistAdmissionregistrationV1Metadata? metadata;
  ...
  factory MutatingwebhookconfigurationlistAdmissionregistrationV1.fromJson(
    Map<String, dynamic> json,
  ) => _$MutatingwebhookconfigurationlistAdmissionregistrationV1FromJson(json);

  Map<String, dynamic> toJson() =>
      _$MutatingwebhookconfigurationlistAdmissionregistrationV1ToJson(this);
}
...
class Webhook {
  ...
  ///
  ///Possible enum values:
  ///- `"IfNeeded"` indicates that the mutation may be called at least one additional time as
  ///part of the admission evaluation if the object being admitted is modified by other
  ///admission plugins after the initial mutation call.
  ///- `"Never"` indicates that the mutation must not be called more than once in a single
...
final reinvocationPolicyValues = EnumValues({
  'IfNeeded': ReinvocationPolicy.IF_NEEDED,
  'Never': ReinvocationPolicy.NEVER,
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum MutatingwebhookconfigurationlistAdmissionregistrationV1Kind {
  @JsonValue('MutatingWebhookConfigurationList')
  MUTATING_WEBHOOK_CONFIGURATION_LIST,
}

final mutatingwebhookconfigurationlistAdmissionregistrationV1KindValues =
    EnumValues({
...
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class MutatingwebhookconfigurationlistAdmissionregistrationV1Metadata {
  ...
  factory MutatingwebhookconfigurationlistAdmissionregistrationV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) =>
