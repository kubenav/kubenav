...
part 'namespacelist_v1.g.dart';

///NamespaceList is a list of Namespaces.
@JsonSerializable()
class NamespacelistV1 {
  ...
  @JsonKey(name: 'kind')
  NamespacelistV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  NamespacelistV1Metadata? metadata;
  ...
  factory NamespacelistV1.fromJson(Map<String, dynamic> json) =>
      _$NamespacelistV1FromJson(json);

  Map<String, dynamic> toJson() => _$NamespacelistV1ToJson(this);
}
...
final itemKindValues = EnumValues({'Namespace': ItemKind.NAMESPACE});
...
class Status {
  ...
  Status({this.conditions, this.phase});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum NamespacelistV1Kind {
  @JsonValue('NamespaceList')
  NAMESPACE_LIST,
}

final namespacelistV1KindValues = EnumValues({
  'NamespaceList': NamespacelistV1Kind.NAMESPACE_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class NamespacelistV1Metadata {
  ...
  factory NamespacelistV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$NamespacelistV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$NamespacelistV1MetadataToJson(this);
}
