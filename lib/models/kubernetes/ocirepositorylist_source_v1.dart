...
part 'ocirepositorylist_source_v1.g.dart';

///OCIRepositoryList is a list of OCIRepository
@JsonSerializable()
class OcirepositorylistSourceV1 {
  ...
  @JsonKey(name: 'kind')
  OcirepositorylistSourceV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  OcirepositorylistSourceV1Metadata? metadata;
  ...
  factory OcirepositorylistSourceV1.fromJson(Map<String, dynamic> json) =>
      _$OcirepositorylistSourceV1FromJson(json);

  Map<String, dynamic> toJson() => _$OcirepositorylistSourceV1ToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum OcirepositorylistSourceV1Kind {
  @JsonValue('OCIRepositoryList')
  OCI_REPOSITORY_LIST,
}

final ocirepositorylistSourceV1KindValues = EnumValues({
  'OCIRepositoryList': OcirepositorylistSourceV1Kind.OCI_REPOSITORY_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class OcirepositorylistSourceV1Metadata {
  ...
  factory OcirepositorylistSourceV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$OcirepositorylistSourceV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$OcirepositorylistSourceV1MetadataToJson(this);
}
