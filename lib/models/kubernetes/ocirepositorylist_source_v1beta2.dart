...
part 'ocirepositorylist_source_v1beta2.g.dart';

///OCIRepositoryList is a list of OCIRepository
@JsonSerializable()
class OcirepositorylistSourceV1Beta2 {
  ...
  ///List of ocirepositories. More info:
  ...
  @JsonKey(name: 'kind')
  OcirepositorylistSourceV1Beta2Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  OcirepositorylistSourceV1Beta2Metadata? metadata;

  OcirepositorylistSourceV1Beta2({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory OcirepositorylistSourceV1Beta2.fromJson(Map<String, dynamic> json) =>
      _$OcirepositorylistSourceV1Beta2FromJson(json);

  Map<String, dynamic> toJson() => _$OcirepositorylistSourceV1Beta2ToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
enum ApiVersion {
  @JsonValue('source.toolkit.fluxcd.io/v1beta2')
  SOURCE_TOOLKIT_FLUXCD_IO_V1_BETA2,
}
...
final itemKindValues = EnumValues({'OCIRepository': ItemKind.OCI_REPOSITORY});
...
class LayerSelector {
  ...
  LayerSelector({this.mediaType, this.operation});

  factory LayerSelector.fromJson(Map<String, dynamic> json) =>
      _$LayerSelectorFromJson(json);

  Map<String, dynamic> toJson() => _$LayerSelectorToJson(this);
}
...
final specProviderValues = EnumValues({
  'aws': SpecProvider.AWS,
  'azure': SpecProvider.AZURE,
  'gcp': SpecProvider.GCP,
  'generic': SpecProvider.GENERIC,
});
...
class Ref {
  ...
  Ref({this.digest, this.semver, this.semverFilter, this.tag});
...
class Verify {
  ...
  @JsonKey(name: 'matchOIDCIdentity')
  List<MatchOidcIdentity?>? matchOidcIdentity;
  ...
  Verify({this.matchOidcIdentity, required this.provider, this.secretRef});
...
class MatchOidcIdentity {
  ...
  MatchOidcIdentity({required this.issuer, required this.subject});

  factory MatchOidcIdentity.fromJson(Map<String, dynamic> json) =>
      _$MatchOidcIdentityFromJson(json);

  Map<String, dynamic> toJson() => _$MatchOidcIdentityToJson(this);
}
...
final verifyProviderValues = EnumValues({
  'cosign': VerifyProvider.COSIGN,
  'notation': VerifyProvider.NOTATION,
});
...
class StatusClass {
  ...
  @JsonKey(name: 'contentConfigChecksum')
  ...
  ///the source artifact.
  @JsonKey(name: 'observedLayerSelector')
...
class ObservedLayerSelector {
  ...
  ObservedLayerSelector({this.mediaType, this.operation});

  factory ObservedLayerSelector.fromJson(Map<String, dynamic> json) =>
      _$ObservedLayerSelectorFromJson(json);

  Map<String, dynamic> toJson() => _$ObservedLayerSelectorToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum OcirepositorylistSourceV1Beta2Kind {
  @JsonValue('OCIRepositoryList')
  OCI_REPOSITORY_LIST,
}

final ocirepositorylistSourceV1Beta2KindValues = EnumValues({
  'OCIRepositoryList': OcirepositorylistSourceV1Beta2Kind.OCI_REPOSITORY_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class OcirepositorylistSourceV1Beta2Metadata {
  ...
  OcirepositorylistSourceV1Beta2Metadata({
  ...
  factory OcirepositorylistSourceV1Beta2Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$OcirepositorylistSourceV1Beta2MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$OcirepositorylistSourceV1Beta2MetadataToJson(this);
}
