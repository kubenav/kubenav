...
part of 'ocirepositorylist_source_v1beta2.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

OcirepositorylistSourceV1Beta2 _$OcirepositorylistSourceV1Beta2FromJson(
  ...
  kind: $enumDecodeNullable(
    _$OcirepositorylistSourceV1Beta2KindEnumMap,
    json['kind'],
  ),
  metadata: json['metadata'] == null
      ? null
      : OcirepositorylistSourceV1Beta2Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$OcirepositorylistSourceV1Beta2ToJson(
  OcirepositorylistSourceV1Beta2 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$OcirepositorylistSourceV1Beta2KindEnumMap[instance.kind],
...
const _$OcirepositorylistSourceV1Beta2KindEnumMap = {
  OcirepositorylistSourceV1Beta2Kind.OCI_REPOSITORY_LIST: 'OCIRepositoryList',
};
...
_$OcirepositorylistSourceV1Beta2MetadataFromJson(Map<String, dynamic> json) =>
    OcirepositorylistSourceV1Beta2Metadata(
...
Map<String, dynamic> _$OcirepositorylistSourceV1Beta2MetadataToJson(
  OcirepositorylistSourceV1Beta2Metadata instance,
) => <String, dynamic>{
