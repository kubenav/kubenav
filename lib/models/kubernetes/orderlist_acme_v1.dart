...
part 'orderlist_acme_v1.g.dart';

///OrderList is a list of Order
@JsonSerializable()
class OrderlistAcmeV1 {
  ...
  @JsonKey(name: 'kind')
  OrderlistAcmeV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  OrderlistAcmeV1Metadata? metadata;
  ...
  factory OrderlistAcmeV1.fromJson(Map<String, dynamic> json) =>
      _$OrderlistAcmeV1FromJson(json);

  Map<String, dynamic> toJson() => _$OrderlistAcmeV1ToJson(this);
}
...
final itemKindValues = EnumValues({'Order': ItemKind.ORDER});
...
class Challenge {
  ...
  Challenge({required this.token, required this.type, required this.url});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum OrderlistAcmeV1Kind {
  @JsonValue('OrderList')
  ORDER_LIST,
}

final orderlistAcmeV1KindValues = EnumValues({
  'OrderList': OrderlistAcmeV1Kind.ORDER_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class OrderlistAcmeV1Metadata {
  ...
  factory OrderlistAcmeV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$OrderlistAcmeV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$OrderlistAcmeV1MetadataToJson(this);
}
