...
part 'poddisruptionbudgetlist_policy_v1.g.dart';

///PodDisruptionBudgetList is a collection of PodDisruptionBudgets.
@JsonSerializable()
class PoddisruptionbudgetlistPolicyV1 {
  ...
  @JsonKey(name: 'kind')
  PoddisruptionbudgetlistPolicyV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  PoddisruptionbudgetlistPolicyV1Metadata? metadata;
  ...
  factory PoddisruptionbudgetlistPolicyV1.fromJson(Map<String, dynamic> json) =>
      _$PoddisruptionbudgetlistPolicyV1FromJson(json);

  Map<String, dynamic> toJson() =>
      _$PoddisruptionbudgetlistPolicyV1ToJson(this);
}
...
final apiVersionValues = EnumValues({'policy/v1': ApiVersion.POLICY_V1});
...
final itemKindValues = EnumValues({
  'PodDisruptionBudget': ItemKind.POD_DISRUPTION_BUDGET,
});
...
class Spec {
  ...
  ///yet healthy are considered disrupted and can be evicted regardless of whether the
  ///criteria in a PDB is met. This means perspective running pods of a disrupted application
  ///might not get a chance to become healthy. Healthy pods will be subject to the PDB for
  ///eviction.
...
final unhealthyPodEvictionPolicyValues = EnumValues({
  'AlwaysAllow': UnhealthyPodEvictionPolicy.ALWAYS_ALLOW,
  'IfHealthyBudget': UnhealthyPodEvictionPolicy.IF_HEALTHY_BUDGET,
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum PoddisruptionbudgetlistPolicyV1Kind {
  @JsonValue('PodDisruptionBudgetList')
  POD_DISRUPTION_BUDGET_LIST,
}

final poddisruptionbudgetlistPolicyV1KindValues = EnumValues({
...
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class PoddisruptionbudgetlistPolicyV1Metadata {
  ...
  factory PoddisruptionbudgetlistPolicyV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$PoddisruptionbudgetlistPolicyV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PoddisruptionbudgetlistPolicyV1MetadataToJson(this);
}
