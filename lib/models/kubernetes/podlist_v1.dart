...
class PodlistV1 {
  ...
  PodlistV1Metadata? metadata;

  PodlistV1({this.apiVersion, required this.items, this.kind, this.metadata});

  factory PodlistV1.fromJson(Map<String, dynamic> json) =>
      _$PodlistV1FromJson(json);

  Map<String, dynamic> toJson() => _$PodlistV1ToJson(this);
}
...
class PodlistV1Item {
  ...
  factory PodlistV1Item.fromJson(Map<String, dynamic> json) =>
      _$PodlistV1ItemFromJson(json);

  Map<String, dynamic> toJson() => _$PodlistV1ItemToJson(this);
}
...
final itemKindValues = EnumValues({'Pod': ItemKind.POD});
...
@JsonSerializable()
class Status {
  ///AllocatedResources is the total requests allocated for this pod by the node. If pod-level
  ///requests are not set, this will be the total requests aggregated across containers in the
  ///pod.
  ...
  ///Statuses of containers in this pod. Each container in the pod should have at most one
  ///status in this list, and all statuses should be for containers in the pod. However this
  ///is not enforced. If a status for a non-existent container is present in the list, or the
  ///list has duplicate names, the behavior of various Kubernetes components is not defined
  ///and those statuses might be ignored. More info:
  ///https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-and-container-status
  @JsonKey(name: 'containerStatuses')
  List<ContainerStatus?>? containerStatuses;

  ///Statuses for any ephemeral containers that have run in this pod. Each ephemeral container
  ///in the pod should have at most one status in this list, and all statuses should be for
  ///containers in the pod. However this is not enforced. If a status for a non-existent
  ///container is present in the list, or the list has duplicate names, the behavior of
  ///various Kubernetes components is not defined and those statuses might be ignored. More
  ///info:
  ///https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#pod-and-container-status
  @JsonKey(name: 'ephemeralContainerStatuses')
  List<ContainerStatus?>? ephemeralContainerStatuses;

  ///PodExtendedResourceClaimStatus is stored in the PodStatus for the extended resource
  ///requests backed by DRA. It stores the generated name for the corresponding special
  ///ResourceClaim created by the scheduler.
  @JsonKey(name: 'extendedResourceClaimStatus')
  ...
  ///Statuses of init containers in this pod. The most recent successful non-restartable init
  ///container will have ready = true, the most recently started container will have startTime
  ///set. Each init container in the pod should have at most one status in this list, and all
  ///statuses should be for containers in the pod. However this is not enforced. If a status
  ///for a non-existent container is present in the list, or the list has duplicate names, the
  ///behavior of various Kubernetes components is not defined and those statuses might be
  ///ignored. More info:
  ///https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle/#pod-and-container-status
  ...
  ///
  ///Possible enum values:
  ///- `"Failed"` means that all containers in the pod have terminated, and at least one
  ///container has terminated in a failure (exited with a non-zero exit code or was stopped by
  ///the system).
  ///- `"Pending"` means the pod has been accepted by the system, but one or more of the
  ///containers has not been started. This includes time before being bound to a node, as well
  ///as time spent pulling images onto the host.
  ///- `"Running"` means the pod has been bound to a node and all of the containers have been
  ///started. At least one container is still running or is in the process of being
  ///restarted.
  ///- `"Succeeded"` means that all containers in the pod have voluntarily terminated with a
  ///container exit code of 0, and the system is not going to restart any of these
  ///containers.
  ///- `"Unknown"` means that for some reason the state of the pod could not be obtained,
  ///typically due to an error in communicating with the host of the pod. Deprecated: It isn't
  ///being set since 2015 (74da3b14b0c0f658b3bb8d2def5094686d0e9095)
  @JsonKey(name: 'phase')
  Phase? phase;
  ...
  ///PodResizeInProgress. PodResizePending will track states where the spec has been resized,
  ///but the Kubelet has not yet allocated the resources. PodResizeInProgress will track
  ///in-progress resizes, and should be present whenever allocated resources != acknowledged
  ///resources.
  @JsonKey(name: 'resize')
  String? resize;
  ...
  List<ResourceClaimStatus?>? resourceClaimStatuses;
...
class Condition {
  ...
  ///If set, this represents the .metadata.generation that the pod condition was set based
  ///upon. The PodObservedGenerationTracking feature gate must be enabled to use this field.
  @JsonKey(name: 'observedGeneration')
  int? observedGeneration;
...
class ContainerStatus {
  ...
  ///AllocatedResourcesStatus represents the status of various resources allocated for this
  ///Pod.
  @JsonKey(name: 'allocatedResourcesStatus')
  List<ContainerStatusAllocatedResourcesStatus?>? allocatedResourcesStatus;
  ...
  ContainerStatusLastState? lastState;
  ...
  ///ResourceRequirements describes the compute resource requirements.
  @JsonKey(name: 'resources')
  ContainerStatusResources? resources;
  ...
  @JsonKey(name: 'user')
  ContainerStatusUser? user;

  ///Status of volume mounts.
  @JsonKey(name: 'volumeMounts')
  List<ContainerStatusVolumeMount?>? volumeMounts;
...
@JsonSerializable()
class ContainerStatusAllocatedResourcesStatus {
  ...
  ///List of unique resources health. Each element in the list contains an unique resource ID
  ///and its health. At a minimum, for the lifetime of a Pod, resource ID must uniquely
  ///identify the resource allocated to the Pod on the Node. If other Pod on the same Node
  ///reports the status with the same resource ID, it must be the same resource they share.
  ///See ResourceID type definition for a specific format it has in various use cases.
  @JsonKey(name: 'resources')
  List<PurpleResource?>? resources;

  ContainerStatusAllocatedResourcesStatus({required this.name, this.resources});

  factory ContainerStatusAllocatedResourcesStatus.fromJson(
    Map<String, dynamic> json,
  ) => _$ContainerStatusAllocatedResourcesStatusFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ContainerStatusAllocatedResourcesStatusToJson(this);
}
...
class PurpleResource {
  ...
  ///ResourceID is the unique identifier of the resource. See the ResourceID type for more
  ///information.
  @JsonKey(name: 'resourceID')
  String resourceId;

  PurpleResource({this.health, required this.resourceId});
...
@JsonSerializable()
class ContainerStatusLastState {
  ///ContainerStateRunning is a running state of a container.
  @JsonKey(name: 'running')
  PurpleRunning? running;

  ///ContainerStateTerminated is a terminated state of a container.
  @JsonKey(name: 'terminated')
  PurpleTerminated? terminated;

  ///ContainerStateWaiting is a waiting state of a container.
  @JsonKey(name: 'waiting')
  PurpleWaiting? waiting;

  ContainerStatusLastState({this.running, this.terminated, this.waiting});

  factory ContainerStatusLastState.fromJson(Map<String, dynamic> json) =>
      _$ContainerStatusLastStateFromJson(json);

  Map<String, dynamic> toJson() => _$ContainerStatusLastStateToJson(this);
}
...
class PurpleRunning {
  ...
  PurpleRunning({this.startedAt});

  factory PurpleRunning.fromJson(Map<String, dynamic> json) =>
      _$PurpleRunningFromJson(json);

  Map<String, dynamic> toJson() => _$PurpleRunningToJson(this);
}

@JsonSerializable()
class PurpleTerminated {
  ...
  factory PurpleTerminated.fromJson(Map<String, dynamic> json) =>
      _$PurpleTerminatedFromJson(json);

  Map<String, dynamic> toJson() => _$PurpleTerminatedToJson(this);
}
...
class PurpleWaiting {
  ...
  PurpleWaiting({this.message, this.reason});

  factory PurpleWaiting.fromJson(Map<String, dynamic> json) =>
      _$PurpleWaitingFromJson(json);

  Map<String, dynamic> toJson() => _$PurpleWaitingToJson(this);
}

@JsonSerializable()
class ContainerStatusResources {
  ///Claims lists the names of resources, defined in spec.resourceClaims, that are used by
  ///this container.
  ///
  ///This field depends on the DynamicResourceAllocation feature gate.
  ...
  ContainerStatusResources({this.claims, this.limits, this.requests});

  factory ContainerStatusResources.fromJson(Map<String, dynamic> json) =>
      _$ContainerStatusResourcesFromJson(json);

  Map<String, dynamic> toJson() => _$ContainerStatusResourcesToJson(this);
}
...
class IndigoClaim {
  ...
  IndigoClaim({required this.name, this.request});

  factory IndigoClaim.fromJson(Map<String, dynamic> json) =>
      _$IndigoClaimFromJson(json);

  Map<String, dynamic> toJson() => _$IndigoClaimToJson(this);
}
...
class ContainerStatusState {
  ///ContainerStateRunning is a running state of a container.
  @JsonKey(name: 'running')
  FluffyRunning? running;

  ///ContainerStateTerminated is a terminated state of a container.
  @JsonKey(name: 'terminated')
  FluffyTerminated? terminated;

  ///ContainerStateWaiting is a waiting state of a container.
  @JsonKey(name: 'waiting')
  FluffyWaiting? waiting;

  ContainerStatusState({this.running, this.terminated, this.waiting});

  factory ContainerStatusState.fromJson(Map<String, dynamic> json) =>
      _$ContainerStatusStateFromJson(json);

  Map<String, dynamic> toJson() => _$ContainerStatusStateToJson(this);
}
...
class FluffyRunning {
  ...
  FluffyRunning({this.startedAt});

  factory FluffyRunning.fromJson(Map<String, dynamic> json) =>
      _$FluffyRunningFromJson(json);

  Map<String, dynamic> toJson() => _$FluffyRunningToJson(this);
}

@JsonSerializable()
class FluffyTerminated {
  ///Container's ID in the format '<type>://<container_id>'
  @JsonKey(name: 'containerID')
  String? containerId;
  ...
  factory FluffyTerminated.fromJson(Map<String, dynamic> json) =>
      _$FluffyTerminatedFromJson(json);

  Map<String, dynamic> toJson() => _$FluffyTerminatedToJson(this);
}
...
class FluffyWaiting {
  ...
  FluffyWaiting({this.message, this.reason});

  factory FluffyWaiting.fromJson(Map<String, dynamic> json) =>
      _$FluffyWaitingFromJson(json);

  Map<String, dynamic> toJson() => _$FluffyWaitingToJson(this);
}

@JsonSerializable()
class ContainerStatusUser {
  ///LinuxContainerUser represents user identity information in Linux containers
  @JsonKey(name: 'linux')
  PurpleLinux? linux;

  ContainerStatusUser({this.linux});

  factory ContainerStatusUser.fromJson(Map<String, dynamic> json) =>
      _$ContainerStatusUserFromJson(json);

  Map<String, dynamic> toJson() => _$ContainerStatusUserToJson(this);
}
...
class PurpleLinux {
  ...
  ///SupplementalGroups are the supplemental groups initially attached to the first process in
  ///the container
  @JsonKey(name: 'supplementalGroups')
  List<int?>? supplementalGroups;
  ...
  PurpleLinux({required this.gid, this.supplementalGroups, required this.uid});

  factory PurpleLinux.fromJson(Map<String, dynamic> json) =>
      _$PurpleLinuxFromJson(json);

  Map<String, dynamic> toJson() => _$PurpleLinuxToJson(this);
}

@JsonSerializable()
class ContainerStatusVolumeMount {
  ...
  factory ContainerStatusVolumeMount.fromJson(Map<String, dynamic> json) =>
      _$ContainerStatusVolumeMountFromJson(json);

  Map<String, dynamic> toJson() => _$ContainerStatusVolumeMountToJson(this);
}

@JsonSerializable()
class EphemeralContainerStatus {
  ///AllocatedResources represents the compute resources allocated for this container by the
  ///node. Kubelet sets this value to Container.Resources.Requests upon successful pod
  ///admission and after successfully admitting desired pod resize.
  @JsonKey(name: 'allocatedResources')
  ...
  ///Pod.
  @JsonKey(name: 'allocatedResourcesStatus')
  List<EphemeralContainerStatusAllocatedResourcesStatus?>?
  ...
  ///specified. If none of them is specified, the default one is ContainerStateWaiting.
  @JsonKey(name: 'lastState')
  EphemeralContainerStatusLastState? lastState;
  ...
  ///ResourceRequirements describes the compute resource requirements.
  @JsonKey(name: 'resources')
  EphemeralContainerStatusResources? resources;
  ...
  ///specified. If none of them is specified, the default one is ContainerStateWaiting.
  @JsonKey(name: 'state')
  EphemeralContainerStatusState? state;
  ...
  ///ContainerUser represents user identity information
  @JsonKey(name: 'user')
  EphemeralContainerStatusUser? user;

  ///Status of volume mounts.
  @JsonKey(name: 'volumeMounts')
  List<EphemeralContainerStatusVolumeMount?>? volumeMounts;
  ...
  factory EphemeralContainerStatus.fromJson(Map<String, dynamic> json) =>
      _$EphemeralContainerStatusFromJson(json);

  Map<String, dynamic> toJson() => _$EphemeralContainerStatusToJson(this);
}

@JsonSerializable()
class EphemeralContainerStatusAllocatedResourcesStatus {
  ///Name of the resource. Must be unique within the pod and in case of non-DRA resource,
  ///match one of the resources from the pod spec. For DRA resources, the value must be
  ///"claim:<claim_name>/<request>". When this status is reported about a container, the
  ///"claim_name" and "request" must match one of the claims of this container.
  ...
  EphemeralContainerStatusAllocatedResourcesStatus({
    required this.name,
    this.resources,
  });

  factory EphemeralContainerStatusAllocatedResourcesStatus.fromJson(
    Map<String, dynamic> json,
  ) => _$EphemeralContainerStatusAllocatedResourcesStatusFromJson(json);

  Map<String, dynamic> toJson() =>
      _$EphemeralContainerStatusAllocatedResourcesStatusToJson(this);
}
...
class FluffyResource {
  ...
  FluffyResource({this.health, required this.resourceId});
...
@JsonSerializable()
class EphemeralContainerStatusLastState {
  ///ContainerStateRunning is a running state of a container.
  @JsonKey(name: 'running')
  TentacledRunning? running;

  ///ContainerStateTerminated is a terminated state of a container.
  @JsonKey(name: 'terminated')
  TentacledTerminated? terminated;

  ///ContainerStateWaiting is a waiting state of a container.
  @JsonKey(name: 'waiting')
  TentacledWaiting? waiting;

  EphemeralContainerStatusLastState({
    this.running,
    this.terminated,
    this.waiting,
  });

  factory EphemeralContainerStatusLastState.fromJson(
    Map<String, dynamic> json,
  ) => _$EphemeralContainerStatusLastStateFromJson(json);

  Map<String, dynamic> toJson() =>
      _$EphemeralContainerStatusLastStateToJson(this);
}

@JsonSerializable()
class TentacledRunning {
  ///Time is a wrapper around time.Time which supports correct marshaling to YAML and JSON.
  ///Wrappers are provided for many of the factory methods that the time package offers.
  @JsonKey(name: 'startedAt')
  DateTime? startedAt;

  TentacledRunning({this.startedAt});

  factory TentacledRunning.fromJson(Map<String, dynamic> json) =>
      _$TentacledRunningFromJson(json);

  Map<String, dynamic> toJson() => _$TentacledRunningToJson(this);
}

@JsonSerializable()
class TentacledTerminated {
  ///Container's ID in the format '<type>://<container_id>'
  @JsonKey(name: 'containerID')
  String? containerId;
  ...
  factory TentacledTerminated.fromJson(Map<String, dynamic> json) =>
      _$TentacledTerminatedFromJson(json);

  Map<String, dynamic> toJson() => _$TentacledTerminatedToJson(this);
}

@JsonSerializable()
class TentacledWaiting {
  ///Message regarding why the container is not yet running.
  @JsonKey(name: 'message')
  String? message;
  ...
  TentacledWaiting({this.message, this.reason});

  factory TentacledWaiting.fromJson(Map<String, dynamic> json) =>
      _$TentacledWaitingFromJson(json);

  Map<String, dynamic> toJson() => _$TentacledWaitingToJson(this);
}

@JsonSerializable()
class EphemeralContainerStatusResources {
  ///Claims lists the names of resources, defined in spec.resourceClaims, that are used by
  ///this container.
  ///
  ///This field depends on the DynamicResourceAllocation feature gate.
  ...
  EphemeralContainerStatusResources({this.claims, this.limits, this.requests});

  factory EphemeralContainerStatusResources.fromJson(
    Map<String, dynamic> json,
  ) => _$EphemeralContainerStatusResourcesFromJson(json);

  Map<String, dynamic> toJson() =>
      _$EphemeralContainerStatusResourcesToJson(this);
}
...
class IndecentClaim {
  ...
  IndecentClaim({required this.name, this.request});

  factory IndecentClaim.fromJson(Map<String, dynamic> json) =>
      _$IndecentClaimFromJson(json);

  Map<String, dynamic> toJson() => _$IndecentClaimToJson(this);
}

@JsonSerializable()
class EphemeralContainerStatusState {
  ///ContainerStateRunning is a running state of a container.
  @JsonKey(name: 'running')
  StickyRunning? running;

  ///ContainerStateTerminated is a terminated state of a container.
  @JsonKey(name: 'terminated')
  StickyTerminated? terminated;

  ///ContainerStateWaiting is a waiting state of a container.
  @JsonKey(name: 'waiting')
  StickyWaiting? waiting;

  EphemeralContainerStatusState({this.running, this.terminated, this.waiting});

  factory EphemeralContainerStatusState.fromJson(Map<String, dynamic> json) =>
      _$EphemeralContainerStatusStateFromJson(json);

  Map<String, dynamic> toJson() => _$EphemeralContainerStatusStateToJson(this);
}
...
class StickyRunning {
  ...
  StickyRunning({this.startedAt});

  factory StickyRunning.fromJson(Map<String, dynamic> json) =>
      _$StickyRunningFromJson(json);

  Map<String, dynamic> toJson() => _$StickyRunningToJson(this);
}

@JsonSerializable()
class StickyTerminated {
  ///Container's ID in the format '<type>://<container_id>'
  @JsonKey(name: 'containerID')
  String? containerId;
  ...
  factory StickyTerminated.fromJson(Map<String, dynamic> json) =>
      _$StickyTerminatedFromJson(json);

  Map<String, dynamic> toJson() => _$StickyTerminatedToJson(this);
}
...
class StickyWaiting {
  ...
  StickyWaiting({this.message, this.reason});

  factory StickyWaiting.fromJson(Map<String, dynamic> json) =>
      _$StickyWaitingFromJson(json);

  Map<String, dynamic> toJson() => _$StickyWaitingToJson(this);
}

@JsonSerializable()
class EphemeralContainerStatusUser {
  ///LinuxContainerUser represents user identity information in Linux containers
  @JsonKey(name: 'linux')
  FluffyLinux? linux;

  EphemeralContainerStatusUser({this.linux});

  factory EphemeralContainerStatusUser.fromJson(Map<String, dynamic> json) =>
      _$EphemeralContainerStatusUserFromJson(json);

  Map<String, dynamic> toJson() => _$EphemeralContainerStatusUserToJson(this);
}
...
class FluffyLinux {
  ...
  FluffyLinux({required this.gid, this.supplementalGroups, required this.uid});

  factory FluffyLinux.fromJson(Map<String, dynamic> json) =>
      _$FluffyLinuxFromJson(json);

  Map<String, dynamic> toJson() => _$FluffyLinuxToJson(this);
}

@JsonSerializable()
class EphemeralContainerStatusVolumeMount {
  ///MountPath corresponds to the original VolumeMount.
  @JsonKey(name: 'mountPath')
  String mountPath;
  ...
  EphemeralContainerStatusVolumeMount({
    required this.mountPath,
    required this.name,
    this.readOnly,
    this.recursiveReadOnly,
  ...
  factory EphemeralContainerStatusVolumeMount.fromJson(
    Map<String, dynamic> json,
  ) => _$EphemeralContainerStatusVolumeMountFromJson(json);

  Map<String, dynamic> toJson() =>
      _$EphemeralContainerStatusVolumeMountToJson(this);
}

@JsonSerializable()
class ExtendedResourceClaimStatus {
  ///RequestMappings identifies the mapping of <container, extended resource backed by DRA>
  ///to  device request in the generated ResourceClaim.
  @JsonKey(name: 'requestMappings')
  ...
  factory ExtendedResourceClaimStatus.fromJson(Map<String, dynamic> json) =>
      _$ExtendedResourceClaimStatusFromJson(json);

  Map<String, dynamic> toJson() => _$ExtendedResourceClaimStatusToJson(this);
}
...
class RequestMapping {
  ...
  ///The name of the request in the special ResourceClaim which corresponds to the extended
  ///resource.
  @JsonKey(name: 'requestName')
  String requestName;
  ...
  factory RequestMapping.fromJson(Map<String, dynamic> json) =>
      _$RequestMappingFromJson(json);

  Map<String, dynamic> toJson() => _$RequestMappingToJson(this);
}
...
class InitContainerStatus {
  ...
  ///Pod.
  @JsonKey(name: 'allocatedResourcesStatus')
  List<InitContainerStatusAllocatedResourcesStatus?>? allocatedResourcesStatus;
  ...
  ///specified. If none of them is specified, the default one is ContainerStateWaiting.
  @JsonKey(name: 'lastState')
  InitContainerStatusLastState? lastState;
  ...
  ///ResourceRequirements describes the compute resource requirements.
  @JsonKey(name: 'resources')
  InitContainerStatusResources? resources;
  ...
  ///specified. If none of them is specified, the default one is ContainerStateWaiting.
  @JsonKey(name: 'state')
  InitContainerStatusState? state;
  ...
  ///ContainerUser represents user identity information
  @JsonKey(name: 'user')
  InitContainerStatusUser? user;

  ///Status of volume mounts.
  @JsonKey(name: 'volumeMounts')
  List<InitContainerStatusVolumeMount?>? volumeMounts;
  ...
  factory InitContainerStatus.fromJson(Map<String, dynamic> json) =>
      _$InitContainerStatusFromJson(json);

  Map<String, dynamic> toJson() => _$InitContainerStatusToJson(this);
}

@JsonSerializable()
class InitContainerStatusAllocatedResourcesStatus {
  ///Name of the resource. Must be unique within the pod and in case of non-DRA resource,
  ///match one of the resources from the pod spec. For DRA resources, the value must be
  ///"claim:<claim_name>/<request>". When this status is reported about a container, the
  ///"claim_name" and "request" must match one of the claims of this container.
  ...
  ///See ResourceID type definition for a specific format it has in various use cases.
  @JsonKey(name: 'resources')
  List<TentacledResource?>? resources;

  InitContainerStatusAllocatedResourcesStatus({
    required this.name,
    this.resources,
  });

  factory InitContainerStatusAllocatedResourcesStatus.fromJson(
    Map<String, dynamic> json,
  ) => _$InitContainerStatusAllocatedResourcesStatusFromJson(json);

  Map<String, dynamic> toJson() =>
      _$InitContainerStatusAllocatedResourcesStatusToJson(this);
}

@JsonSerializable()
class TentacledResource {
  ///Health of the resource. can be one of:
  ///- Healthy: operates as normal
  ///- Unhealthy: reported unhealthy. We consider this a temporary health issue
  ///since we do not have a mechanism today to distinguish
  ...
  TentacledResource({this.health, required this.resourceId});

  factory TentacledResource.fromJson(Map<String, dynamic> json) =>
      _$TentacledResourceFromJson(json);

  Map<String, dynamic> toJson() => _$TentacledResourceToJson(this);
}

@JsonSerializable()
class InitContainerStatusLastState {
  ///ContainerStateRunning is a running state of a container.
  @JsonKey(name: 'running')
  IndigoRunning? running;

  ///ContainerStateTerminated is a terminated state of a container.
  @JsonKey(name: 'terminated')
  IndigoTerminated? terminated;

  ///ContainerStateWaiting is a waiting state of a container.
  @JsonKey(name: 'waiting')
  IndigoWaiting? waiting;

  InitContainerStatusLastState({this.running, this.terminated, this.waiting});

  factory InitContainerStatusLastState.fromJson(Map<String, dynamic> json) =>
      _$InitContainerStatusLastStateFromJson(json);

  Map<String, dynamic> toJson() => _$InitContainerStatusLastStateToJson(this);
}
...
class IndigoRunning {
  ...
  IndigoRunning({this.startedAt});

  factory IndigoRunning.fromJson(Map<String, dynamic> json) =>
      _$IndigoRunningFromJson(json);

  Map<String, dynamic> toJson() => _$IndigoRunningToJson(this);
}

@JsonSerializable()
class IndigoTerminated {
  ///Container's ID in the format '<type>://<container_id>'
  @JsonKey(name: 'containerID')
  String? containerId;
  ...
  factory IndigoTerminated.fromJson(Map<String, dynamic> json) =>
      _$IndigoTerminatedFromJson(json);

  Map<String, dynamic> toJson() => _$IndigoTerminatedToJson(this);
}
...
class IndigoWaiting {
  ...
  IndigoWaiting({this.message, this.reason});

  factory IndigoWaiting.fromJson(Map<String, dynamic> json) =>
      _$IndigoWaitingFromJson(json);

  Map<String, dynamic> toJson() => _$IndigoWaitingToJson(this);
}

@JsonSerializable()
class InitContainerStatusResources {
  ///Claims lists the names of resources, defined in spec.resourceClaims, that are used by
  ///this container.
  ///
  ///This field depends on the DynamicResourceAllocation feature gate.
  ...
  InitContainerStatusResources({this.claims, this.limits, this.requests});

  factory InitContainerStatusResources.fromJson(Map<String, dynamic> json) =>
      _$InitContainerStatusResourcesFromJson(json);

  Map<String, dynamic> toJson() => _$InitContainerStatusResourcesToJson(this);
}

@JsonSerializable()
class HilariousClaim {
  ///Name must match the name of one entry in pod.spec.resourceClaims of the Pod where this
  ///field is used. It makes that resource available inside a container.
  @JsonKey(name: 'name')
  String name;
  ...
  HilariousClaim({required this.name, this.request});

  factory HilariousClaim.fromJson(Map<String, dynamic> json) =>
      _$HilariousClaimFromJson(json);

  Map<String, dynamic> toJson() => _$HilariousClaimToJson(this);
}

@JsonSerializable()
class InitContainerStatusState {
  ///ContainerStateRunning is a running state of a container.
  @JsonKey(name: 'running')
  IndecentRunning? running;

  ///ContainerStateTerminated is a terminated state of a container.
  @JsonKey(name: 'terminated')
  IndecentTerminated? terminated;

  ///ContainerStateWaiting is a waiting state of a container.
  @JsonKey(name: 'waiting')
  IndecentWaiting? waiting;

  InitContainerStatusState({this.running, this.terminated, this.waiting});

  factory InitContainerStatusState.fromJson(Map<String, dynamic> json) =>
      _$InitContainerStatusStateFromJson(json);

  Map<String, dynamic> toJson() => _$InitContainerStatusStateToJson(this);
}

@JsonSerializable()
class IndecentRunning {
  ///Time is a wrapper around time.Time which supports correct marshaling to YAML and JSON.
  ///Wrappers are provided for many of the factory methods that the time package offers.
  @JsonKey(name: 'startedAt')
  DateTime? startedAt;

  IndecentRunning({this.startedAt});

  factory IndecentRunning.fromJson(Map<String, dynamic> json) =>
      _$IndecentRunningFromJson(json);

  Map<String, dynamic> toJson() => _$IndecentRunningToJson(this);
}

@JsonSerializable()
class IndecentTerminated {
  ///Container's ID in the format '<type>://<container_id>'
  @JsonKey(name: 'containerID')
  String? containerId;
  ...
  factory IndecentTerminated.fromJson(Map<String, dynamic> json) =>
      _$IndecentTerminatedFromJson(json);

  Map<String, dynamic> toJson() => _$IndecentTerminatedToJson(this);
}

@JsonSerializable()
class IndecentWaiting {
  ///Message regarding why the container is not yet running.
  @JsonKey(name: 'message')
  String? message;
  ...
  IndecentWaiting({this.message, this.reason});

  factory IndecentWaiting.fromJson(Map<String, dynamic> json) =>
      _$IndecentWaitingFromJson(json);

  Map<String, dynamic> toJson() => _$IndecentWaitingToJson(this);
}

@JsonSerializable()
class InitContainerStatusUser {
  ///LinuxContainerUser represents user identity information in Linux containers
  @JsonKey(name: 'linux')
  TentacledLinux? linux;

  InitContainerStatusUser({this.linux});

  factory InitContainerStatusUser.fromJson(Map<String, dynamic> json) =>
      _$InitContainerStatusUserFromJson(json);

  Map<String, dynamic> toJson() => _$InitContainerStatusUserToJson(this);
}

@JsonSerializable()
class TentacledLinux {
  ///GID is the primary gid initially attached to the first process in the container
  @JsonKey(name: 'gid')
  int gid;
  ...
  factory TentacledLinux.fromJson(Map<String, dynamic> json) =>
      _$TentacledLinuxFromJson(json);

  Map<String, dynamic> toJson() => _$TentacledLinuxToJson(this);
}

@JsonSerializable()
class InitContainerStatusVolumeMount {
  ///MountPath corresponds to the original VolumeMount.
  @JsonKey(name: 'mountPath')
  String mountPath;
  ...
  InitContainerStatusVolumeMount({
    required this.mountPath,
    required this.name,
    this.readOnly,
    this.recursiveReadOnly,
  ...
  factory InitContainerStatusVolumeMount.fromJson(Map<String, dynamic> json) =>
      _$InitContainerStatusVolumeMountFromJson(json);

  Map<String, dynamic> toJson() => _$InitContainerStatusVolumeMountToJson(this);
}
...
final qosClassValues = EnumValues({
...
class ResourceClaimStatus {
  ...
  ///ResourceClaimName is the name of the ResourceClaim that was generated for the Pod in the
  ///namespace of the Pod. If this is unset, then generating a ResourceClaim was not
  ///necessary. The pod.spec.resourceClaims entry can be ignored in this case.
  @JsonKey(name: 'resourceClaimName')
  String? resourceClaimName;

  ResourceClaimStatus({required this.name, this.resourceClaimName});

  factory ResourceClaimStatus.fromJson(Map<String, dynamic> json) =>
      _$ResourceClaimStatusFromJson(json);

  Map<String, dynamic> toJson() => _$ResourceClaimStatusToJson(this);
}
...
class StatusResources {
  ...
  StatusResources({this.claims, this.limits, this.requests});

  factory StatusResources.fromJson(Map<String, dynamic> json) =>
      _$StatusResourcesFromJson(json);

  Map<String, dynamic> toJson() => _$StatusResourcesToJson(this);
}

@JsonSerializable()
class AmbitiousClaim {
  ///Name must match the name of one entry in pod.spec.resourceClaims of the Pod where this
  ///field is used. It makes that resource available inside a container.
  @JsonKey(name: 'name')
  String name;
  ...
  AmbitiousClaim({required this.name, this.request});

  factory AmbitiousClaim.fromJson(Map<String, dynamic> json) =>
      _$AmbitiousClaimFromJson(json);

  Map<String, dynamic> toJson() => _$AmbitiousClaimToJson(this);
}
...
final podlistV1KindValues = EnumValues({'PodList': PodlistV1Kind.POD_LIST});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class PodlistV1Metadata {
  ...
  factory PodlistV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$PodlistV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$PodlistV1MetadataToJson(this);
}
