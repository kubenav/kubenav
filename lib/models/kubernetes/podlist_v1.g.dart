...
part of 'podlist_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

PodlistV1 _$PodlistV1FromJson(Map<String, dynamic> json) => PodlistV1(
  apiVersion: $enumDecodeNullable(_$ApiVersionEnumMap, json['apiVersion']),
  items: (json['items'] as List<dynamic>)
      .map(
        (e) => e == null
            ? null
            : PodlistV1Item.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  kind: $enumDecodeNullable(_$PodlistV1KindEnumMap, json['kind']),
  metadata: json['metadata'] == null
      ? null
      : PodlistV1Metadata.fromJson(json['metadata'] as Map<String, dynamic>),
);

Map<String, dynamic> _$PodlistV1ToJson(PodlistV1 instance) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$PodlistV1KindEnumMap[instance.kind],
  'metadata': instance.metadata,
};

const _$ApiVersionEnumMap = {ApiVersion.V1: 'v1'};

const _$PodlistV1KindEnumMap = {PodlistV1Kind.POD_LIST: 'PodList'};

PodlistV1Item _$PodlistV1ItemFromJson(Map<String, dynamic> json) =>
    PodlistV1Item(
      apiVersion: $enumDecodeNullable(_$ApiVersionEnumMap, json['apiVersion']),
...
Map<String, dynamic> _$PodlistV1ItemToJson(PodlistV1Item instance) =>
    <String, dynamic>{
      'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
...
const _$ItemKindEnumMap = {ItemKind.POD: 'Pod'};
...
Status _$StatusFromJson(Map<String, dynamic> json) => Status(
  ...
  containerStatuses: (json['containerStatuses'] as List<dynamic>?)
      ?.map(
        (e) => e == null
            ? null
            : ContainerStatus.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  ...
  extendedResourceClaimStatus: json['extendedResourceClaimStatus'] == null
      ? null
      : ExtendedResourceClaimStatus.fromJson(
          json['extendedResourceClaimStatus'] as Map<String, dynamic>,
        ),
  hostIp: json['hostIP'] as String?,
  hostIPs: (json['hostIPs'] as List<dynamic>?)
      ?.map(
        (e) => e == null ? null : HostIp.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  ...
  podIPs: (json['podIPs'] as List<dynamic>?)
      ?.map((e) => e == null ? null : PodIp.fromJson(e as Map<String, dynamic>))
      .toList(),
  qosClass: $enumDecodeNullable(_$QosClassEnumMap, json['qosClass']),
  ...
  resourceClaimStatuses: (json['resourceClaimStatuses'] as List<dynamic>?)
      ?.map(
        (e) => e == null
            ? null
            : ResourceClaimStatus.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  resources: json['resources'] == null
      ? null
      : StatusResources.fromJson(json['resources'] as Map<String, dynamic>),
...
Map<String, dynamic> _$StatusToJson(Status instance) => <String, dynamic>{
  ...
  'extendedResourceClaimStatus': instance.extendedResourceClaimStatus,
  'hostIP': instance.hostIp,
  ...
  'qosClass': _$QosClassEnumMap[instance.qosClass],
...
const _$QosClassEnumMap = {
  QosClass.BEST_EFFORT: 'BestEffort',
...
ContainerStatus _$ContainerStatusFromJson(
  Map<String, dynamic> json,
) => ContainerStatus(
  allocatedResources: json['allocatedResources'] as Map<String, dynamic>?,
  allocatedResourcesStatus: (json['allocatedResourcesStatus'] as List<dynamic>?)
      ?.map(
        (e) => e == null
            ? null
            : ContainerStatusAllocatedResourcesStatus.fromJson(
                e as Map<String, dynamic>,
              ),
      )
      .toList(),
  ...
  lastState: json['lastState'] == null
      ? null
      : ContainerStatusLastState.fromJson(
  ...
  resources: json['resources'] == null
      ? null
      : ContainerStatusResources.fromJson(
          json['resources'] as Map<String, dynamic>,
        ),
  ...
  state: json['state'] == null
      ? null
      : ContainerStatusState.fromJson(json['state'] as Map<String, dynamic>),
  stopSignal: $enumDecodeNullable(_$StopSignalEnumMap, json['stopSignal']),
  user: json['user'] == null
      ? null
      : ContainerStatusUser.fromJson(json['user'] as Map<String, dynamic>),
  volumeMounts: (json['volumeMounts'] as List<dynamic>?)
      ?.map(
        (e) => e == null
            ? null
            : ContainerStatusVolumeMount.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
);
...
Map<String, dynamic> _$ContainerStatusToJson(ContainerStatus instance) =>
    <String, dynamic>{
      'allocatedResources': instance.allocatedResources,
      'allocatedResourcesStatus': instance.allocatedResourcesStatus,
...
ContainerStatusAllocatedResourcesStatus
_$ContainerStatusAllocatedResourcesStatusFromJson(Map<String, dynamic> json) =>
    ContainerStatusAllocatedResourcesStatus(
      name: json['name'] as String,
...
Map<String, dynamic> _$ContainerStatusAllocatedResourcesStatusToJson(
  ContainerStatusAllocatedResourcesStatus instance,
) => <String, dynamic>{'name': instance.name, 'resources': instance.resources};
...
ContainerStatusLastState _$ContainerStatusLastStateFromJson(
  Map<String, dynamic> json,
) => ContainerStatusLastState(
  running: json['running'] == null
      ? null
      : PurpleRunning.fromJson(json['running'] as Map<String, dynamic>),
  terminated: json['terminated'] == null
      ? null
      : PurpleTerminated.fromJson(json['terminated'] as Map<String, dynamic>),
  waiting: json['waiting'] == null
      ? null
      : PurpleWaiting.fromJson(json['waiting'] as Map<String, dynamic>),
);

Map<String, dynamic> _$ContainerStatusLastStateToJson(
  ContainerStatusLastState instance,
) => <String, dynamic>{
...
PurpleRunning _$PurpleRunningFromJson(Map<String, dynamic> json) =>
    PurpleRunning(
...
Map<String, dynamic> _$PurpleRunningToJson(PurpleRunning instance) =>
    <String, dynamic>{'startedAt': instance.startedAt?.toIso8601String()};

PurpleTerminated _$PurpleTerminatedFromJson(Map<String, dynamic> json) =>
    PurpleTerminated(
      containerId: json['containerID'] as String?,
...
Map<String, dynamic> _$PurpleTerminatedToJson(PurpleTerminated instance) =>
    <String, dynamic>{
      'containerID': instance.containerId,
...
PurpleWaiting _$PurpleWaitingFromJson(Map<String, dynamic> json) =>
    PurpleWaiting(
      message: json['message'] as String?,
      reason: json['reason'] as String?,
    );

Map<String, dynamic> _$PurpleWaitingToJson(PurpleWaiting instance) =>
    <String, dynamic>{'message': instance.message, 'reason': instance.reason};

ContainerStatusResources _$ContainerStatusResourcesFromJson(
  Map<String, dynamic> json,
) => ContainerStatusResources(
  claims: (json['claims'] as List<dynamic>?)
      ?.map(
        (e) =>
            e == null ? null : IndigoClaim.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  limits: json['limits'] as Map<String, dynamic>?,
  requests: json['requests'] as Map<String, dynamic>?,
...
Map<String, dynamic> _$ContainerStatusResourcesToJson(
  ContainerStatusResources instance,
) => <String, dynamic>{
  'claims': instance.claims,
  'limits': instance.limits,
  'requests': instance.requests,
...
IndigoClaim _$IndigoClaimFromJson(Map<String, dynamic> json) => IndigoClaim(
  name: json['name'] as String,
  request: json['request'] as String?,
);

Map<String, dynamic> _$IndigoClaimToJson(IndigoClaim instance) =>
    <String, dynamic>{'name': instance.name, 'request': instance.request};

ContainerStatusState _$ContainerStatusStateFromJson(
  Map<String, dynamic> json,
) => ContainerStatusState(
  running: json['running'] == null
      ? null
      : FluffyRunning.fromJson(json['running'] as Map<String, dynamic>),
  terminated: json['terminated'] == null
      ? null
      : FluffyTerminated.fromJson(json['terminated'] as Map<String, dynamic>),
  waiting: json['waiting'] == null
      ? null
      : FluffyWaiting.fromJson(json['waiting'] as Map<String, dynamic>),
);

Map<String, dynamic> _$ContainerStatusStateToJson(
  ContainerStatusState instance,
) => <String, dynamic>{
  'running': instance.running,
  'terminated': instance.terminated,
  'waiting': instance.waiting,
...
FluffyRunning _$FluffyRunningFromJson(Map<String, dynamic> json) =>
    FluffyRunning(
      startedAt: json['startedAt'] == null
          ? null
          : DateTime.parse(json['startedAt'] as String),
...
Map<String, dynamic> _$FluffyRunningToJson(FluffyRunning instance) =>
    <String, dynamic>{'startedAt': instance.startedAt?.toIso8601String()};

FluffyTerminated _$FluffyTerminatedFromJson(Map<String, dynamic> json) =>
    FluffyTerminated(
      containerId: json['containerID'] as String?,
      exitCode: (json['exitCode'] as num).toInt(),
      finishedAt: json['finishedAt'] == null
...
Map<String, dynamic> _$FluffyTerminatedToJson(FluffyTerminated instance) =>
    <String, dynamic>{
      'containerID': instance.containerId,
      'exitCode': instance.exitCode,
      'finishedAt': instance.finishedAt?.toIso8601String(),
...
FluffyWaiting _$FluffyWaitingFromJson(Map<String, dynamic> json) =>
    FluffyWaiting(
      message: json['message'] as String?,
      reason: json['reason'] as String?,
    );

Map<String, dynamic> _$FluffyWaitingToJson(FluffyWaiting instance) =>
    <String, dynamic>{'message': instance.message, 'reason': instance.reason};

ContainerStatusUser _$ContainerStatusUserFromJson(Map<String, dynamic> json) =>
    ContainerStatusUser(
      linux: json['linux'] == null
          ? null
          : PurpleLinux.fromJson(json['linux'] as Map<String, dynamic>),
    );

Map<String, dynamic> _$ContainerStatusUserToJson(
  ContainerStatusUser instance,
) => <String, dynamic>{'linux': instance.linux};

PurpleLinux _$PurpleLinuxFromJson(Map<String, dynamic> json) => PurpleLinux(
...
Map<String, dynamic> _$PurpleLinuxToJson(PurpleLinux instance) =>
    <String, dynamic>{
      'gid': instance.gid,
      'supplementalGroups': instance.supplementalGroups,
      'uid': instance.uid,
...
ContainerStatusVolumeMount _$ContainerStatusVolumeMountFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$ContainerStatusVolumeMountToJson(
  ContainerStatusVolumeMount instance,
) => <String, dynamic>{
  'mountPath': instance.mountPath,
  'name': instance.name,
  'readOnly': instance.readOnly,
...
EphemeralContainerStatus _$EphemeralContainerStatusFromJson(
  Map<String, dynamic> json,
  ...
  allocatedResourcesStatus: (json['allocatedResourcesStatus'] as List<dynamic>?)
      ?.map(
        (e) => e == null
            ? null
            : EphemeralContainerStatusAllocatedResourcesStatus.fromJson(
                e as Map<String, dynamic>,
              ),
      )
      .toList(),
  ...
  lastState: json['lastState'] == null
      ? null
      : EphemeralContainerStatusLastState.fromJson(
          json['lastState'] as Map<String, dynamic>,
        ),
  name: json['name'] as String,
  ready: json['ready'] as bool,
  resources: json['resources'] == null
      ? null
      : EphemeralContainerStatusResources.fromJson(
          json['resources'] as Map<String, dynamic>,
        ),
  restartCount: (json['restartCount'] as num).toInt(),
  started: json['started'] as bool?,
  state: json['state'] == null
      ? null
      : EphemeralContainerStatusState.fromJson(
          json['state'] as Map<String, dynamic>,
        ),
  stopSignal: $enumDecodeNullable(_$StopSignalEnumMap, json['stopSignal']),
  user: json['user'] == null
      ? null
      : EphemeralContainerStatusUser.fromJson(
  ...
  volumeMounts: (json['volumeMounts'] as List<dynamic>?)
      ?.map(
        (e) => e == null
            ? null
            : EphemeralContainerStatusVolumeMount.fromJson(
                e as Map<String, dynamic>,
              ),
      )
      .toList(),
...
Map<String, dynamic> _$EphemeralContainerStatusToJson(
  EphemeralContainerStatus instance,
) => <String, dynamic>{
  'allocatedResources': instance.allocatedResources,
  'allocatedResourcesStatus': instance.allocatedResourcesStatus,
  'containerID': instance.containerId,
...
_$EphemeralContainerStatusAllocatedResourcesStatusFromJson(
  Map<String, dynamic> json,
) => EphemeralContainerStatusAllocatedResourcesStatus(
  name: json['name'] as String,
  resources: (json['resources'] as List<dynamic>?)
...
Map<String, dynamic> _$EphemeralContainerStatusAllocatedResourcesStatusToJson(
  EphemeralContainerStatusAllocatedResourcesStatus instance,
) => <String, dynamic>{'name': instance.name, 'resources': instance.resources};
...
EphemeralContainerStatusLastState _$EphemeralContainerStatusLastStateFromJson(
  Map<String, dynamic> json,
) => EphemeralContainerStatusLastState(
  running: json['running'] == null
      ? null
      : TentacledRunning.fromJson(json['running'] as Map<String, dynamic>),
  terminated: json['terminated'] == null
      ? null
      : TentacledTerminated.fromJson(
          json['terminated'] as Map<String, dynamic>,
        ),
  waiting: json['waiting'] == null
      ? null
      : TentacledWaiting.fromJson(json['waiting'] as Map<String, dynamic>),
);

Map<String, dynamic> _$EphemeralContainerStatusLastStateToJson(
  EphemeralContainerStatusLastState instance,
) => <String, dynamic>{
  'running': instance.running,
  'terminated': instance.terminated,
  'waiting': instance.waiting,
...
TentacledRunning _$TentacledRunningFromJson(Map<String, dynamic> json) =>
    TentacledRunning(
      startedAt: json['startedAt'] == null
          ? null
          : DateTime.parse(json['startedAt'] as String),
...
Map<String, dynamic> _$TentacledRunningToJson(TentacledRunning instance) =>
    <String, dynamic>{'startedAt': instance.startedAt?.toIso8601String()};

TentacledTerminated _$TentacledTerminatedFromJson(Map<String, dynamic> json) =>
    TentacledTerminated(
      containerId: json['containerID'] as String?,
      exitCode: (json['exitCode'] as num).toInt(),
      finishedAt: json['finishedAt'] == null
...
Map<String, dynamic> _$TentacledTerminatedToJson(
  TentacledTerminated instance,
) => <String, dynamic>{
  'containerID': instance.containerId,
  'exitCode': instance.exitCode,
  'finishedAt': instance.finishedAt?.toIso8601String(),
...
TentacledWaiting _$TentacledWaitingFromJson(Map<String, dynamic> json) =>
    TentacledWaiting(
      message: json['message'] as String?,
      reason: json['reason'] as String?,
    );

Map<String, dynamic> _$TentacledWaitingToJson(TentacledWaiting instance) =>
    <String, dynamic>{'message': instance.message, 'reason': instance.reason};

EphemeralContainerStatusResources _$EphemeralContainerStatusResourcesFromJson(
  Map<String, dynamic> json,
) => EphemeralContainerStatusResources(
  claims: (json['claims'] as List<dynamic>?)
      ?.map(
        (e) => e == null
            ? null
            : IndecentClaim.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  limits: json['limits'] as Map<String, dynamic>?,
  requests: json['requests'] as Map<String, dynamic>?,
...
Map<String, dynamic> _$EphemeralContainerStatusResourcesToJson(
  EphemeralContainerStatusResources instance,
) => <String, dynamic>{
  'claims': instance.claims,
  'limits': instance.limits,
  'requests': instance.requests,
...
IndecentClaim _$IndecentClaimFromJson(Map<String, dynamic> json) =>
    IndecentClaim(
      name: json['name'] as String,
      request: json['request'] as String?,
    );

Map<String, dynamic> _$IndecentClaimToJson(IndecentClaim instance) =>
    <String, dynamic>{'name': instance.name, 'request': instance.request};

EphemeralContainerStatusState _$EphemeralContainerStatusStateFromJson(
  Map<String, dynamic> json,
) => EphemeralContainerStatusState(
  running: json['running'] == null
      ? null
      : StickyRunning.fromJson(json['running'] as Map<String, dynamic>),
  terminated: json['terminated'] == null
      ? null
      : StickyTerminated.fromJson(json['terminated'] as Map<String, dynamic>),
  waiting: json['waiting'] == null
      ? null
      : StickyWaiting.fromJson(json['waiting'] as Map<String, dynamic>),
);

Map<String, dynamic> _$EphemeralContainerStatusStateToJson(
  EphemeralContainerStatusState instance,
) => <String, dynamic>{
  'running': instance.running,
  'terminated': instance.terminated,
  'waiting': instance.waiting,
...
StickyRunning _$StickyRunningFromJson(Map<String, dynamic> json) =>
    StickyRunning(
      startedAt: json['startedAt'] == null
          ? null
          : DateTime.parse(json['startedAt'] as String),
...
Map<String, dynamic> _$StickyRunningToJson(StickyRunning instance) =>
    <String, dynamic>{'startedAt': instance.startedAt?.toIso8601String()};

StickyTerminated _$StickyTerminatedFromJson(Map<String, dynamic> json) =>
    StickyTerminated(
      containerId: json['containerID'] as String?,
      exitCode: (json['exitCode'] as num).toInt(),
      finishedAt: json['finishedAt'] == null
...
Map<String, dynamic> _$StickyTerminatedToJson(StickyTerminated instance) =>
    <String, dynamic>{
      'containerID': instance.containerId,
      'exitCode': instance.exitCode,
      'finishedAt': instance.finishedAt?.toIso8601String(),
...
StickyWaiting _$StickyWaitingFromJson(Map<String, dynamic> json) =>
    StickyWaiting(
      message: json['message'] as String?,
      reason: json['reason'] as String?,
    );

Map<String, dynamic> _$StickyWaitingToJson(StickyWaiting instance) =>
    <String, dynamic>{'message': instance.message, 'reason': instance.reason};

EphemeralContainerStatusUser _$EphemeralContainerStatusUserFromJson(
  Map<String, dynamic> json,
) => EphemeralContainerStatusUser(
  linux: json['linux'] == null
      ? null
      : FluffyLinux.fromJson(json['linux'] as Map<String, dynamic>),
);

Map<String, dynamic> _$EphemeralContainerStatusUserToJson(
  EphemeralContainerStatusUser instance,
) => <String, dynamic>{'linux': instance.linux};

FluffyLinux _$FluffyLinuxFromJson(Map<String, dynamic> json) => FluffyLinux(
  gid: (json['gid'] as num).toInt(),
  supplementalGroups: (json['supplementalGroups'] as List<dynamic>?)
      ?.map((e) => (e as num?)?.toInt())
      .toList(),
...
Map<String, dynamic> _$FluffyLinuxToJson(FluffyLinux instance) =>
    <String, dynamic>{
      'gid': instance.gid,
      'supplementalGroups': instance.supplementalGroups,
      'uid': instance.uid,
...
_$EphemeralContainerStatusVolumeMountFromJson(Map<String, dynamic> json) =>
    EphemeralContainerStatusVolumeMount(
      mountPath: json['mountPath'] as String,
      name: json['name'] as String,
      readOnly: json['readOnly'] as bool?,
...
Map<String, dynamic> _$EphemeralContainerStatusVolumeMountToJson(
  EphemeralContainerStatusVolumeMount instance,
) => <String, dynamic>{
  'mountPath': instance.mountPath,
  'name': instance.name,
  'readOnly': instance.readOnly,
...
ExtendedResourceClaimStatus _$ExtendedResourceClaimStatusFromJson(
  Map<String, dynamic> json,
) => ExtendedResourceClaimStatus(
  requestMappings: (json['requestMappings'] as List<dynamic>)
      .map(
        (e) => e == null
            ? null
            : RequestMapping.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  resourceClaimName: json['resourceClaimName'] as String,
);

Map<String, dynamic> _$ExtendedResourceClaimStatusToJson(
  ExtendedResourceClaimStatus instance,
) => <String, dynamic>{
  'requestMappings': instance.requestMappings,
  'resourceClaimName': instance.resourceClaimName,
};

RequestMapping _$RequestMappingFromJson(Map<String, dynamic> json) =>
    RequestMapping(
      containerName: json['containerName'] as String,
...
Map<String, dynamic> _$RequestMappingToJson(RequestMapping instance) =>
    <String, dynamic>{
      'containerName': instance.containerName,
...
HostIp _$HostIpFromJson(Map<String, dynamic> json) =>
    HostIp(ip: json['ip'] as String);

Map<String, dynamic> _$HostIpToJson(HostIp instance) => <String, dynamic>{
  'ip': instance.ip,
};

InitContainerStatus _$InitContainerStatusFromJson(
  Map<String, dynamic> json,
) => InitContainerStatus(
  allocatedResources: json['allocatedResources'] as Map<String, dynamic>?,
  allocatedResourcesStatus: (json['allocatedResourcesStatus'] as List<dynamic>?)
      ?.map(
        (e) => e == null
            ? null
            : InitContainerStatusAllocatedResourcesStatus.fromJson(
                e as Map<String, dynamic>,
              ),
      )
      .toList(),
  ...
  lastState: json['lastState'] == null
      ? null
      : InitContainerStatusLastState.fromJson(
          json['lastState'] as Map<String, dynamic>,
        ),
  name: json['name'] as String,
  ready: json['ready'] as bool,
  resources: json['resources'] == null
      ? null
      : InitContainerStatusResources.fromJson(
          json['resources'] as Map<String, dynamic>,
        ),
  restartCount: (json['restartCount'] as num).toInt(),
  started: json['started'] as bool?,
  state: json['state'] == null
      ? null
      : InitContainerStatusState.fromJson(
          json['state'] as Map<String, dynamic>,
        ),
  stopSignal: $enumDecodeNullable(_$StopSignalEnumMap, json['stopSignal']),
  user: json['user'] == null
      ? null
      : InitContainerStatusUser.fromJson(json['user'] as Map<String, dynamic>),
  volumeMounts: (json['volumeMounts'] as List<dynamic>?)
      ?.map(
        (e) => e == null
            ? null
            : InitContainerStatusVolumeMount.fromJson(
                e as Map<String, dynamic>,
              ),
      )
      .toList(),
...
Map<String, dynamic> _$InitContainerStatusToJson(
  InitContainerStatus instance,
) => <String, dynamic>{
  'allocatedResources': instance.allocatedResources,
  'allocatedResourcesStatus': instance.allocatedResourcesStatus,
  'containerID': instance.containerId,
...
_$InitContainerStatusAllocatedResourcesStatusFromJson(
  Map<String, dynamic> json,
) => InitContainerStatusAllocatedResourcesStatus(
  name: json['name'] as String,
  resources: (json['resources'] as List<dynamic>?)
      ?.map(
        (e) => e == null
            ? null
            : TentacledResource.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
);

Map<String, dynamic> _$InitContainerStatusAllocatedResourcesStatusToJson(
  InitContainerStatusAllocatedResourcesStatus instance,
) => <String, dynamic>{'name': instance.name, 'resources': instance.resources};

TentacledResource _$TentacledResourceFromJson(Map<String, dynamic> json) =>
    TentacledResource(
      health: json['health'] as String?,
      resourceId: json['resourceID'] as String,
    );

Map<String, dynamic> _$TentacledResourceToJson(TentacledResource instance) =>
    <String, dynamic>{
      'health': instance.health,
      'resourceID': instance.resourceId,
    };

InitContainerStatusLastState _$InitContainerStatusLastStateFromJson(
  Map<String, dynamic> json,
) => InitContainerStatusLastState(
  running: json['running'] == null
      ? null
      : IndigoRunning.fromJson(json['running'] as Map<String, dynamic>),
  terminated: json['terminated'] == null
      ? null
      : IndigoTerminated.fromJson(json['terminated'] as Map<String, dynamic>),
  waiting: json['waiting'] == null
      ? null
      : IndigoWaiting.fromJson(json['waiting'] as Map<String, dynamic>),
);

Map<String, dynamic> _$InitContainerStatusLastStateToJson(
  InitContainerStatusLastState instance,
) => <String, dynamic>{
  'running': instance.running,
  'terminated': instance.terminated,
  'waiting': instance.waiting,
...
IndigoRunning _$IndigoRunningFromJson(Map<String, dynamic> json) =>
    IndigoRunning(
      startedAt: json['startedAt'] == null
          ? null
          : DateTime.parse(json['startedAt'] as String),
...
Map<String, dynamic> _$IndigoRunningToJson(IndigoRunning instance) =>
    <String, dynamic>{'startedAt': instance.startedAt?.toIso8601String()};

IndigoTerminated _$IndigoTerminatedFromJson(Map<String, dynamic> json) =>
    IndigoTerminated(
      containerId: json['containerID'] as String?,
      exitCode: (json['exitCode'] as num).toInt(),
      finishedAt: json['finishedAt'] == null
...
Map<String, dynamic> _$IndigoTerminatedToJson(IndigoTerminated instance) =>
    <String, dynamic>{
      'containerID': instance.containerId,
      'exitCode': instance.exitCode,
      'finishedAt': instance.finishedAt?.toIso8601String(),
...
IndigoWaiting _$IndigoWaitingFromJson(Map<String, dynamic> json) =>
    IndigoWaiting(
      message: json['message'] as String?,
      reason: json['reason'] as String?,
    );

Map<String, dynamic> _$IndigoWaitingToJson(IndigoWaiting instance) =>
    <String, dynamic>{'message': instance.message, 'reason': instance.reason};

InitContainerStatusResources _$InitContainerStatusResourcesFromJson(
  Map<String, dynamic> json,
) => InitContainerStatusResources(
  claims: (json['claims'] as List<dynamic>?)
      ?.map(
        (e) => e == null
            ? null
            : HilariousClaim.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  limits: json['limits'] as Map<String, dynamic>?,
  requests: json['requests'] as Map<String, dynamic>?,
...
Map<String, dynamic> _$InitContainerStatusResourcesToJson(
  InitContainerStatusResources instance,
) => <String, dynamic>{
  'claims': instance.claims,
  'limits': instance.limits,
  'requests': instance.requests,
...
HilariousClaim _$HilariousClaimFromJson(Map<String, dynamic> json) =>
    HilariousClaim(
      name: json['name'] as String,
      request: json['request'] as String?,
    );

Map<String, dynamic> _$HilariousClaimToJson(HilariousClaim instance) =>
    <String, dynamic>{'name': instance.name, 'request': instance.request};

InitContainerStatusState _$InitContainerStatusStateFromJson(
  Map<String, dynamic> json,
) => InitContainerStatusState(
  running: json['running'] == null
      ? null
      : IndecentRunning.fromJson(json['running'] as Map<String, dynamic>),
  terminated: json['terminated'] == null
      ? null
      : IndecentTerminated.fromJson(json['terminated'] as Map<String, dynamic>),
  waiting: json['waiting'] == null
      ? null
      : IndecentWaiting.fromJson(json['waiting'] as Map<String, dynamic>),
);

Map<String, dynamic> _$InitContainerStatusStateToJson(
  InitContainerStatusState instance,
) => <String, dynamic>{
  'running': instance.running,
  'terminated': instance.terminated,
  'waiting': instance.waiting,
...
IndecentRunning _$IndecentRunningFromJson(Map<String, dynamic> json) =>
    IndecentRunning(
      startedAt: json['startedAt'] == null
          ? null
          : DateTime.parse(json['startedAt'] as String),
...
Map<String, dynamic> _$IndecentRunningToJson(IndecentRunning instance) =>
    <String, dynamic>{'startedAt': instance.startedAt?.toIso8601String()};

IndecentTerminated _$IndecentTerminatedFromJson(Map<String, dynamic> json) =>
    IndecentTerminated(
      containerId: json['containerID'] as String?,
      exitCode: (json['exitCode'] as num).toInt(),
      finishedAt: json['finishedAt'] == null
...
Map<String, dynamic> _$IndecentTerminatedToJson(IndecentTerminated instance) =>
    <String, dynamic>{
      'containerID': instance.containerId,
      'exitCode': instance.exitCode,
      'finishedAt': instance.finishedAt?.toIso8601String(),
...
IndecentWaiting _$IndecentWaitingFromJson(Map<String, dynamic> json) =>
    IndecentWaiting(
      message: json['message'] as String?,
      reason: json['reason'] as String?,
    );

Map<String, dynamic> _$IndecentWaitingToJson(IndecentWaiting instance) =>
    <String, dynamic>{'message': instance.message, 'reason': instance.reason};

InitContainerStatusUser _$InitContainerStatusUserFromJson(
  Map<String, dynamic> json,
) => InitContainerStatusUser(
  linux: json['linux'] == null
      ? null
      : TentacledLinux.fromJson(json['linux'] as Map<String, dynamic>),
);

Map<String, dynamic> _$InitContainerStatusUserToJson(
  InitContainerStatusUser instance,
) => <String, dynamic>{'linux': instance.linux};

TentacledLinux _$TentacledLinuxFromJson(Map<String, dynamic> json) =>
    TentacledLinux(
      gid: (json['gid'] as num).toInt(),
      supplementalGroups: (json['supplementalGroups'] as List<dynamic>?)
          ?.map((e) => (e as num?)?.toInt())
...
Map<String, dynamic> _$TentacledLinuxToJson(TentacledLinux instance) =>
    <String, dynamic>{
      'gid': instance.gid,
      'supplementalGroups': instance.supplementalGroups,
      'uid': instance.uid,
...
InitContainerStatusVolumeMount _$InitContainerStatusVolumeMountFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$InitContainerStatusVolumeMountToJson(
  InitContainerStatusVolumeMount instance,
) => <String, dynamic>{
  'mountPath': instance.mountPath,
  'name': instance.name,
  'readOnly': instance.readOnly,
...
PodIp _$PodIpFromJson(Map<String, dynamic> json) =>
    PodIp(ip: json['ip'] as String);

Map<String, dynamic> _$PodIpToJson(PodIp instance) => <String, dynamic>{
  'ip': instance.ip,
};
...
StatusResources _$StatusResourcesFromJson(Map<String, dynamic> json) =>
    StatusResources(
      claims: (json['claims'] as List<dynamic>?)
          ?.map(
            (e) => e == null
                ? null
                : AmbitiousClaim.fromJson(e as Map<String, dynamic>),
          )
          .toList(),
      limits: json['limits'] as Map<String, dynamic>?,
      requests: json['requests'] as Map<String, dynamic>?,
...
Map<String, dynamic> _$StatusResourcesToJson(StatusResources instance) =>
    <String, dynamic>{
      'claims': instance.claims,
      'limits': instance.limits,
      'requests': instance.requests,
...
AmbitiousClaim _$AmbitiousClaimFromJson(Map<String, dynamic> json) =>
    AmbitiousClaim(
      name: json['name'] as String,
      request: json['request'] as String?,
    );

Map<String, dynamic> _$AmbitiousClaimToJson(AmbitiousClaim instance) =>
    <String, dynamic>{'name': instance.name, 'request': instance.request};

PodlistV1Metadata _$PodlistV1MetadataFromJson(Map<String, dynamic> json) =>
    PodlistV1Metadata(
...
Map<String, dynamic> _$PodlistV1MetadataToJson(PodlistV1Metadata instance) =>
    <String, dynamic>{
