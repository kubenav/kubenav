...
part 'priorityclasslist_scheduling_v1.g.dart';

///PriorityClassList is a collection of priority classes.
@JsonSerializable()
class PriorityclasslistSchedulingV1 {
  ...
  @JsonKey(name: 'kind')
  PriorityclasslistSchedulingV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  PriorityclasslistSchedulingV1Metadata? metadata;
  ...
  factory PriorityclasslistSchedulingV1.fromJson(Map<String, dynamic> json) =>
      _$PriorityclasslistSchedulingV1FromJson(json);

  Map<String, dynamic> toJson() => _$PriorityclasslistSchedulingV1ToJson(this);
}
...
final itemKindValues = EnumValues({'PriorityClass': ItemKind.PRIORITY_CLASS});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum PriorityclasslistSchedulingV1Kind {
  @JsonValue('PriorityClassList')
  PRIORITY_CLASS_LIST,
}

final priorityclasslistSchedulingV1KindValues = EnumValues({
  'PriorityClassList': PriorityclasslistSchedulingV1Kind.PRIORITY_CLASS_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class PriorityclasslistSchedulingV1Metadata {
  ...
  factory PriorityclasslistSchedulingV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$PriorityclasslistSchedulingV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PriorityclasslistSchedulingV1MetadataToJson(this);
}
