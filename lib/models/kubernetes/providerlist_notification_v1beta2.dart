...
part 'providerlist_notification_v1beta2.g.dart';

///ProviderList is a list of Provider
@JsonSerializable()
class ProviderlistNotificationV1Beta2 {
  ...
  @JsonKey(name: 'kind')
  ProviderlistNotificationV1Beta2Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  ProviderlistNotificationV1Beta2Metadata? metadata;
  ...
  factory ProviderlistNotificationV1Beta2.fromJson(Map<String, dynamic> json) =>
      _$ProviderlistNotificationV1Beta2FromJson(json);

  Map<String, dynamic> toJson() =>
      _$ProviderlistNotificationV1Beta2ToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ProviderlistNotificationV1Beta2Kind {
  @JsonValue('ProviderList')
  PROVIDER_LIST,
}

final providerlistNotificationV1Beta2KindValues = EnumValues({
  'ProviderList': ProviderlistNotificationV1Beta2Kind.PROVIDER_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class ProviderlistNotificationV1Beta2Metadata {
  ...
  factory ProviderlistNotificationV1Beta2Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$ProviderlistNotificationV1Beta2MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ProviderlistNotificationV1Beta2MetadataToJson(this);
}
