...
part of 'providerlist_notification_v1beta3.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ProviderlistNotificationV1Beta3 _$ProviderlistNotificationV1Beta3FromJson(
  ...
  kind: $enumDecodeNullable(
    _$ProviderlistNotificationV1Beta3KindEnumMap,
    json['kind'],
  ),
  metadata: json['metadata'] == null
      ? null
      : ProviderlistNotificationV1Beta3Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$ProviderlistNotificationV1Beta3ToJson(
  ProviderlistNotificationV1Beta3 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$ProviderlistNotificationV1Beta3KindEnumMap[instance.kind],
...
const _$ProviderlistNotificationV1Beta3KindEnumMap = {
  ProviderlistNotificationV1Beta3Kind.PROVIDER_LIST: 'ProviderList',
};
...
Spec _$SpecFromJson(Map<String, dynamic> json) => Spec(
  ...
  commitStatusExpr: json['commitStatusExpr'] as String?,
...
Map<String, dynamic> _$SpecToJson(Spec instance) => <String, dynamic>{
  ...
  'commitStatusExpr': instance.commitStatusExpr,
...
_$ProviderlistNotificationV1Beta3MetadataFromJson(Map<String, dynamic> json) =>
    ProviderlistNotificationV1Beta3Metadata(
...
Map<String, dynamic> _$ProviderlistNotificationV1Beta3MetadataToJson(
  ProviderlistNotificationV1Beta3Metadata instance,
) => <String, dynamic>{
