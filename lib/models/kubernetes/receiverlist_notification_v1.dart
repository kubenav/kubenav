...
part 'receiverlist_notification_v1.g.dart';

///ReceiverList is a list of Receiver
@JsonSerializable()
class ReceiverlistNotificationV1 {
  ...
  @JsonKey(name: 'kind')
  ReceiverlistNotificationV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  ReceiverlistNotificationV1Metadata? metadata;
  ...
  factory ReceiverlistNotificationV1.fromJson(Map<String, dynamic> json) =>
      _$ReceiverlistNotificationV1FromJson(json);

  Map<String, dynamic> toJson() => _$ReceiverlistNotificationV1ToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
enum ApiVersion {
  @JsonValue('notification.toolkit.fluxcd.io/v1')
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ReceiverlistNotificationV1Kind {
  @JsonValue('ReceiverList')
  RECEIVER_LIST,
}

final receiverlistNotificationV1KindValues = EnumValues({
  'ReceiverList': ReceiverlistNotificationV1Kind.RECEIVER_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class ReceiverlistNotificationV1Metadata {
  ...
  factory ReceiverlistNotificationV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$ReceiverlistNotificationV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ReceiverlistNotificationV1MetadataToJson(this);
}
