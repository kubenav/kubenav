...
part 'receiverlist_notification_v1beta2.g.dart';

///ReceiverList is a list of Receiver
@JsonSerializable()
class ReceiverlistNotificationV1Beta2 {
  ...
  @JsonKey(name: 'kind')
  ReceiverlistNotificationV1Beta2Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  ReceiverlistNotificationV1Beta2Metadata? metadata;

  ReceiverlistNotificationV1Beta2({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory ReceiverlistNotificationV1Beta2.fromJson(Map<String, dynamic> json) =>
      _$ReceiverlistNotificationV1Beta2FromJson(json);

  Map<String, dynamic> toJson() =>
      _$ReceiverlistNotificationV1Beta2ToJson(this);
}
...
final itemKindValues = EnumValues({'Receiver': ItemKind.RECEIVER});
...
final resourceKindValues = EnumValues({
  'Bucket': ResourceKind.BUCKET,
  'GitRepository': ResourceKind.GIT_REPOSITORY,
  'HelmChart': ResourceKind.HELM_CHART,
  'HelmRelease': ResourceKind.HELM_RELEASE,
  'HelmRepository': ResourceKind.HELM_REPOSITORY,
  'ImagePolicy': ResourceKind.IMAGE_POLICY,
  'ImageRepository': ResourceKind.IMAGE_REPOSITORY,
  'ImageUpdateAutomation': ResourceKind.IMAGE_UPDATE_AUTOMATION,
  'Kustomization': ResourceKind.KUSTOMIZATION,
  'OCIRepository': ResourceKind.OCI_REPOSITORY,
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ReceiverlistNotificationV1Beta2Kind {
  @JsonValue('ReceiverList')
  RECEIVER_LIST,
}

final receiverlistNotificationV1Beta2KindValues = EnumValues({
  'ReceiverList': ReceiverlistNotificationV1Beta2Kind.RECEIVER_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class ReceiverlistNotificationV1Beta2Metadata {
  ...
  ReceiverlistNotificationV1Beta2Metadata({
  ...
  factory ReceiverlistNotificationV1Beta2Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$ReceiverlistNotificationV1Beta2MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ReceiverlistNotificationV1Beta2MetadataToJson(this);
}
