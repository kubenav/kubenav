...
part of 'receiverlist_notification_v1beta2.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ReceiverlistNotificationV1Beta2 _$ReceiverlistNotificationV1Beta2FromJson(
  ...
  kind: $enumDecodeNullable(
    _$ReceiverlistNotificationV1Beta2KindEnumMap,
    json['kind'],
  ),
  metadata: json['metadata'] == null
      ? null
      : ReceiverlistNotificationV1Beta2Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$ReceiverlistNotificationV1Beta2ToJson(
  ReceiverlistNotificationV1Beta2 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$ReceiverlistNotificationV1Beta2KindEnumMap[instance.kind],
...
const _$ReceiverlistNotificationV1Beta2KindEnumMap = {
  ReceiverlistNotificationV1Beta2Kind.RECEIVER_LIST: 'ReceiverList',
};
...
_$ReceiverlistNotificationV1Beta2MetadataFromJson(Map<String, dynamic> json) =>
    ReceiverlistNotificationV1Beta2Metadata(
...
Map<String, dynamic> _$ReceiverlistNotificationV1Beta2MetadataToJson(
  ReceiverlistNotificationV1Beta2Metadata instance,
) => <String, dynamic>{
