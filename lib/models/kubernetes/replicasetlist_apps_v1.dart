...
part 'replicasetlist_apps_v1.g.dart';

///ReplicaSetList is a collection of ReplicaSets.
@JsonSerializable()
class ReplicasetlistAppsV1 {
  ...
  @JsonKey(name: 'items')
  List<ReplicasetlistAppsV1Item?> items;
  ...
  @JsonKey(name: 'kind')
  ReplicasetlistAppsV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  ReplicasetlistAppsV1Metadata? metadata;
  ...
  factory ReplicasetlistAppsV1.fromJson(Map<String, dynamic> json) =>
      _$ReplicasetlistAppsV1FromJson(json);

  Map<String, dynamic> toJson() => _$ReplicasetlistAppsV1ToJson(this);
}
...
@JsonSerializable()
class ReplicasetlistAppsV1Item {
  ///APIVersion defines the versioned schema of this representation of an object. Servers
  ///should convert recognized schemas to the latest internal value, and may reject
  ///unrecognized values. More info:
  ///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
  ...
  factory ReplicasetlistAppsV1Item.fromJson(Map<String, dynamic> json) =>
      _$ReplicasetlistAppsV1ItemFromJson(json);

  Map<String, dynamic> toJson() => _$ReplicasetlistAppsV1ItemToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
  @JsonValue('ReplicaSet')
  REPLICA_SET,
}

final itemKindValues = EnumValues({'ReplicaSet': ItemKind.REPLICA_SET});
...
@JsonSerializable()
class Status {
  ///The number of available non-terminating pods (ready for at least minReadySeconds) for
  ///this replica set.
  ...
  ///The number of non-terminating pods that have labels matching the labels of the pod
  ...
  ///Replicas is the most recently observed number of non-terminating pods. More info:
  ///https://kubernetes.io/docs/concepts/workloads/controllers/replicaset
  @JsonKey(name: 'replicas')
  int replicas;

  ///The number of terminating pods for this replica set. Terminating pods have a non-null
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ReplicasetlistAppsV1Kind {
  @JsonValue('ReplicaSetList')
  REPLICA_SET_LIST,
}

final replicasetlistAppsV1KindValues = EnumValues({
  'ReplicaSetList': ReplicasetlistAppsV1Kind.REPLICA_SET_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class ReplicasetlistAppsV1Metadata {
  ...
  factory ReplicasetlistAppsV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$ReplicasetlistAppsV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$ReplicasetlistAppsV1MetadataToJson(this);
}
