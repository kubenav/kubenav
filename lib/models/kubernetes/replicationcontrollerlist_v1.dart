...
part 'replicationcontrollerlist_v1.g.dart';

///ReplicationControllerList is a collection of replication controllers.
@JsonSerializable()
class ReplicationcontrollerlistV1 {
  ...
  @JsonKey(name: 'items')
  List<ReplicationcontrollerlistV1Item?> items;
  ...
  @JsonKey(name: 'kind')
  ReplicationcontrollerlistV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  ReplicationcontrollerlistV1Metadata? metadata;
  ...
  factory ReplicationcontrollerlistV1.fromJson(Map<String, dynamic> json) =>
      _$ReplicationcontrollerlistV1FromJson(json);

  Map<String, dynamic> toJson() => _$ReplicationcontrollerlistV1ToJson(this);
}
...
@JsonSerializable()
class ReplicationcontrollerlistV1Item {
  ///APIVersion defines the versioned schema of this representation of an object. Servers
  ///should convert recognized schemas to the latest internal value, and may reject
  ///unrecognized values. More info:
  ///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
  ...
  factory ReplicationcontrollerlistV1Item.fromJson(Map<String, dynamic> json) =>
      _$ReplicationcontrollerlistV1ItemFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ReplicationcontrollerlistV1ItemToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
  @JsonValue('ReplicationController')
  REPLICATION_CONTROLLER,
}

final itemKindValues = EnumValues({
  'ReplicationController': ItemKind.REPLICATION_CONTROLLER,
});
...
class ItemSpec {
  ...
  ItemSpec({this.minReadySeconds, this.replicas, this.selector, this.template});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ReplicationcontrollerlistV1Kind {
  @JsonValue('ReplicationControllerList')
  REPLICATION_CONTROLLER_LIST,
}

final replicationcontrollerlistV1KindValues = EnumValues({
...
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class ReplicationcontrollerlistV1Metadata {
  ...
  factory ReplicationcontrollerlistV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$ReplicationcontrollerlistV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ReplicationcontrollerlistV1MetadataToJson(this);
}
