...
part 'resourceclaimlist_resource_v1.g.dart';

///ResourceClaimList is a collection of claims.
@JsonSerializable()
class ResourceclaimlistResourceV1 {
  ...
  @JsonKey(name: 'kind')
  ResourceclaimlistResourceV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  ResourceclaimlistResourceV1Metadata? metadata;
  ...
  factory ResourceclaimlistResourceV1.fromJson(Map<String, dynamic> json) =>
      _$ResourceclaimlistResourceV1FromJson(json);

  Map<String, dynamic> toJson() => _$ResourceclaimlistResourceV1ToJson(this);
}
...
class Item {
  ...
  ///ResourceClaimStatus tracks whether the resource has been allocated and what the result of
  ///that was.
  @JsonKey(name: 'status')
  Status? status;
...
final itemKindValues = EnumValues({'ResourceClaim': ItemKind.RESOURCE_CLAIM});
...
class SpecDevices {
  ...
  SpecDevices({this.config, this.constraints, this.requests});

  factory SpecDevices.fromJson(Map<String, dynamic> json) =>
      _$SpecDevicesFromJson(json);

  Map<String, dynamic> toJson() => _$SpecDevicesToJson(this);
}
...
class PurpleConfig {
  ...
  PurpleConfig({this.opaque, this.requests});

  factory PurpleConfig.fromJson(Map<String, dynamic> json) =>
      _$PurpleConfigFromJson(json);

  Map<String, dynamic> toJson() => _$PurpleConfigToJson(this);
}
...
class PurpleOpaque {
  ...
  PurpleOpaque({required this.driver, required this.parameters});

  factory PurpleOpaque.fromJson(Map<String, dynamic> json) =>
      _$PurpleOpaqueFromJson(json);

  Map<String, dynamic> toJson() => _$PurpleOpaqueToJson(this);
}
...
class Status {
  ...
  ///Devices contains the status of each device allocated for this claim, as reported by the
  ///driver. This can include driver-specific information. Entries are owned by their
  ///respective drivers.
  @JsonKey(name: 'devices')
  List<Device?>? devices;

  ///ReservedFor indicates which entities are currently allowed to use the claim. A Pod which
  ///references a ResourceClaim which is not reserved for that Pod will not be started. A
  ///claim that is in use or might be in use because it has been reserved must not get
  ///deallocated.
  ///
  ///In a cluster with multiple scheduler instances, two pods might get scheduled concurrently
  ///by different schedulers. When they reference the same ResourceClaim which already has
  ///reached its maximum number of consumers, only one pod can be scheduled.
  ///
  ///Both schedulers try to add their pod to the claim.status.reservedFor field, but only the
  ///update that reaches the API server first gets stored. The other one fails with an error
  ///and the scheduler which issued it knows that it must put the pod back into the queue,
  ...
  List<ReservedFor?>? reservedFor;

  Status({this.allocation, this.devices, this.reservedFor});
...
class Allocation {
  ///Time is a wrapper around time.Time which supports correct marshaling to YAML and JSON.
  ///Wrappers are provided for many of the factory methods that the time package offers.
  @JsonKey(name: 'allocationTimestamp')
  DateTime? allocationTimestamp;

  ///DeviceAllocationResult is the result of allocating devices.
  @JsonKey(name: 'devices')
  AllocationDevices? devices;
  ...
  Allocation({this.allocationTimestamp, this.devices, this.nodeSelector});
...
@JsonSerializable()
class AllocationDevices {
  ///This field is a combination of all the claim and class configuration parameters. Drivers
  ///can distinguish between those based on a flag.
  ///
  ///This includes configuration parameters for drivers which have no allocated devices in the
  ///result because it is up to the drivers which configuration parameters they support. They
  ///can silently ignore unknown configuration parameters.
  @JsonKey(name: 'config')
  List<FluffyConfig?>? config;

  ///Results lists all allocated devices.
  @JsonKey(name: 'results')
  List<Result?>? results;

  AllocationDevices({this.config, this.results});

  factory AllocationDevices.fromJson(Map<String, dynamic> json) =>
      _$AllocationDevicesFromJson(json);

  Map<String, dynamic> toJson() => _$AllocationDevicesToJson(this);
}
...
class FluffyConfig {
  ...
  ///Requests lists the names of requests where the configuration applies. If empty, its
  ///applies to all requests.
  ///
  ///References to subrequests must include the name of the main request and may include the
  ///subrequest using the format <main request>[/<subrequest>]. If just the main request is
  ...
  FluffyConfig({this.opaque, this.requests, required this.source});

  factory FluffyConfig.fromJson(Map<String, dynamic> json) =>
      _$FluffyConfigFromJson(json);

  Map<String, dynamic> toJson() => _$FluffyConfigToJson(this);
}
...
class FluffyOpaque {
  ...
  FluffyOpaque({required this.driver, required this.parameters});

  factory FluffyOpaque.fromJson(Map<String, dynamic> json) =>
      _$FluffyOpaqueFromJson(json);

  Map<String, dynamic> toJson() => _$FluffyOpaqueToJson(this);
}
...
final sourceValues = EnumValues({
  'FromClaim': Source.FROM_CLAIM,
  'FromClass': Source.FROM_CLASS,
});

@JsonSerializable()
class Result {
  ///AdminAccess indicates that this device was allocated for administrative access. See the
  ///corresponding request field for a definition of mode.
  ///
  ///This is an alpha field and requires enabling the DRAAdminAccess feature gate. Admin
  ///access is disabled if this field is unset or set to false, otherwise it is enabled.
  @JsonKey(name: 'adminAccess')
  ...
  ///BindingConditions contains a copy of the BindingConditions from the corresponding
  ///ResourceSlice at the time of allocation.
  ///
  ...
  ///BindingFailureConditions contains a copy of the BindingFailureConditions from the
  ...
  ///ConsumedCapacity tracks the amount of capacity consumed per device as part of the claim
  ///request. The consumed amount may differ from the requested amount: it is rounded up to
  ///the nearest valid value based on the device’s requestPolicy if applicable (i.e., may not
  ///be less than the requested amount).
  ///
  ///The total consumed capacity for each device must not exceed the DeviceCapacity's Value.
  ///
  ///This field is populated only for devices that allow multiple allocations. All capacity
  ///entries are included, even if the consumed amount is zero.
  @JsonKey(name: 'consumedCapacity')
  Map<String, dynamic>? consumedCapacity;
  ...
  ///This name together with the driver name and the device name field identify which device
  ///was allocated (`<driver name>/<pool name>/<device name>`).
  ///
  ///Must not be longer than 253 characters and may contain one or more DNS sub-domains
  ///separated by slashes.
  @JsonKey(name: 'pool')
  String pool;

  ///Request is the name of the request in the claim which caused this device to be allocated.
  ///If it references a subrequest in the firstAvailable list on a DeviceRequest, this field
  ///must include both the name of the main request and the subrequest using the format <main
  ///request>/<subrequest>.
  ///
  ...
  ///ShareID uniquely identifies an individual allocation share of the device, used when the
  ...
  ///A copy of all tolerations specified in the request at the time when the device got
  ///allocated.
  ///
  ///The maximum number of tolerations is 16.
  ///
  ///This is an alpha field and requires enabling the DRADeviceTaints feature gate.
  @JsonKey(name: 'tolerations')
  List<ResultToleration?>? tolerations;
...
class ResultToleration {
  ...
  factory ResultToleration.fromJson(Map<String, dynamic> json) =>
      _$ResultTolerationFromJson(json);

  Map<String, dynamic> toJson() => _$ResultTolerationToJson(this);
}
...
@JsonSerializable()
class Device {
  ///Conditions contains the latest observation of the device's state. If the device has been
  ///configured according to the class and claim config references, the `Ready` condition
  ///should be True.
  ///
  ...
  ///NetworkDeviceData provides network-related details for the allocated device. This
  ///information may be filled by drivers or other components to configure or identify the
  ///device within a network context.
  @JsonKey(name: 'networkData')
...
@JsonSerializable()
class NetworkData {
  ///HardwareAddress represents the hardware address (e.g. MAC Address) of the device's
  ///network interface.
  ///
  ///Must not be longer than 128 characters.
  @JsonKey(name: 'hardwareAddress')
  String? hardwareAddress;

  ///InterfaceName specifies the name of the network interface associated with the allocated
  ///device. This might be the name of a physical or virtual network interface being
  ...
  ///IPs lists the network addresses assigned to the device's network interface. This can
  ///include both IPv4 and IPv6 addresses. The IPs are in the CIDR notation, which includes
  ///both the address and the associated subnet mask. e.g.: "192.0.2.5/24" for IPv4 and
  ///"2001:db8::5/64" for IPv6.
  @JsonKey(name: 'ips')
  List<String?>? ips;

  NetworkData({this.hardwareAddress, this.interfaceName, this.ips});
...
class ReservedFor {
  ...
  factory ReservedFor.fromJson(Map<String, dynamic> json) =>
      _$ReservedForFromJson(json);

  Map<String, dynamic> toJson() => _$ReservedForToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ResourceclaimlistResourceV1Kind {
  @JsonValue('ResourceClaimList')
  RESOURCE_CLAIM_LIST,
}

final resourceclaimlistResourceV1KindValues = EnumValues({
  'ResourceClaimList': ResourceclaimlistResourceV1Kind.RESOURCE_CLAIM_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class ResourceclaimlistResourceV1Metadata {
  ...
  factory ResourceclaimlistResourceV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$ResourceclaimlistResourceV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ResourceclaimlistResourceV1MetadataToJson(this);
}
