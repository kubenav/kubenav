...
part 'resourcequotalist_v1.g.dart';

///ResourceQuotaList is a list of ResourceQuota items.
@JsonSerializable()
class ResourcequotalistV1 {
  ...
  @JsonKey(name: 'kind')
  ResourcequotalistV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  ResourcequotalistV1Metadata? metadata;
  ...
  factory ResourcequotalistV1.fromJson(Map<String, dynamic> json) =>
      _$ResourcequotalistV1FromJson(json);

  Map<String, dynamic> toJson() => _$ResourcequotalistV1ToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
  @JsonValue('ResourceQuota')
  RESOURCE_QUOTA,
}

final itemKindValues = EnumValues({'ResourceQuota': ItemKind.RESOURCE_QUOTA});
...
class Spec {
  ...
  Spec({this.hard, this.scopes, this.scopeSelector});
...
class MatchExpression {
  ...
  ///- `"CrossNamespacePodAffinity"` Match all pod objects that have cross-namespace pod
  ///(anti)affinity mentioned.
  ///- `"NotBestEffort"` Match all pod objects that do not have best effort quality of
  ///service
  ///- `"NotTerminating"` Match all pod objects where spec.activeDeadlineSeconds is nil
  ///- `"PriorityClass"` Match all pod objects that have priority class mentioned
  ///- `"Terminating"` Match all pod objects where spec.activeDeadlineSeconds >=0
  ///- `"VolumeAttributesClass"` Match all pvc objects that have volume attributes class
  ///mentioned.
...
final scopeNameValues = EnumValues({
  'BestEffort': ScopeName.BEST_EFFORT,
  'CrossNamespacePodAffinity': ScopeName.CROSS_NAMESPACE_POD_AFFINITY,
  'NotBestEffort': ScopeName.NOT_BEST_EFFORT,
  'NotTerminating': ScopeName.NOT_TERMINATING,
  'PriorityClass': ScopeName.PRIORITY_CLASS,
  'Terminating': ScopeName.TERMINATING,
  'VolumeAttributesClass': ScopeName.VOLUME_ATTRIBUTES_CLASS,
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ResourcequotalistV1Kind {
  @JsonValue('ResourceQuotaList')
  RESOURCE_QUOTA_LIST,
}

final resourcequotalistV1KindValues = EnumValues({
  'ResourceQuotaList': ResourcequotalistV1Kind.RESOURCE_QUOTA_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class ResourcequotalistV1Metadata {
  ...
  factory ResourcequotalistV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$ResourcequotalistV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$ResourcequotalistV1MetadataToJson(this);
}
