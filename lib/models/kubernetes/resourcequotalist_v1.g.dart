...
part of 'resourcequotalist_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ResourcequotalistV1 _$ResourcequotalistV1FromJson(Map<String, dynamic> json) =>
    ResourcequotalistV1(
      ...
      items: (json['items'] as List<dynamic>)
          ...
          .toList(),
      kind: $enumDecodeNullable(_$ResourcequotalistV1KindEnumMap, json['kind']),
      metadata: json['metadata'] == null
          ? null
          : ResourcequotalistV1Metadata.fromJson(
              json['metadata'] as Map<String, dynamic>,
            ),
    );

Map<String, dynamic> _$ResourcequotalistV1ToJson(
  ResourcequotalistV1 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$ResourcequotalistV1KindEnumMap[instance.kind],
  'metadata': instance.metadata,
};

const _$ApiVersionEnumMap = {ApiVersion.V1: 'v1'};

const _$ResourcequotalistV1KindEnumMap = {
  ResourcequotalistV1Kind.RESOURCE_QUOTA_LIST: 'ResourceQuotaList',
};
...
const _$ItemKindEnumMap = {ItemKind.RESOURCE_QUOTA: 'ResourceQuota'};
...
Spec _$SpecFromJson(Map<String, dynamic> json) => Spec(
  ...
  scopes: (json['scopes'] as List<dynamic>?)
      ?.map((e) => $enumDecode(_$ScopeNameEnumMap, e))
      .toList(),
...
Map<String, dynamic> _$SpecToJson(Spec instance) => <String, dynamic>{
  'hard': instance.hard,
  'scopes': instance.scopes?.map((e) => _$ScopeNameEnumMap[e]!).toList(),
  'scopeSelector': instance.scopeSelector,
};

const _$ScopeNameEnumMap = {
  ScopeName.BEST_EFFORT: 'BestEffort',
  ScopeName.CROSS_NAMESPACE_POD_AFFINITY: 'CrossNamespacePodAffinity',
  ScopeName.NOT_BEST_EFFORT: 'NotBestEffort',
  ScopeName.NOT_TERMINATING: 'NotTerminating',
  ScopeName.PRIORITY_CLASS: 'PriorityClass',
  ScopeName.TERMINATING: 'Terminating',
  ScopeName.VOLUME_ATTRIBUTES_CLASS: 'VolumeAttributesClass',
};
...
Map<String, dynamic> _$ScopeSelectorToJson(ScopeSelector instance) =>
    <String, dynamic>{'matchExpressions': instance.matchExpressions};
...
MatchExpression _$MatchExpressionFromJson(Map<String, dynamic> json) =>
    MatchExpression(
      ...
      scopeName: $enumDecode(_$ScopeNameEnumMap, json['scopeName']),
...
Map<String, dynamic> _$MatchExpressionToJson(MatchExpression instance) =>
    <String, dynamic>{
      ...
      'scopeName': _$ScopeNameEnumMap[instance.scopeName]!,
...
ResourcequotalistV1Metadata _$ResourcequotalistV1MetadataFromJson(
...
Map<String, dynamic> _$ResourcequotalistV1MetadataToJson(
  ResourcequotalistV1Metadata instance,
) => <String, dynamic>{
