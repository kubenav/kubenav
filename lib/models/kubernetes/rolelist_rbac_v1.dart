...
part 'rolelist_rbac_v1.g.dart';

///RoleList is a collection of Roles
@JsonSerializable()
class RolelistRbacV1 {
  ...
  @JsonKey(name: 'kind')
  RolelistRbacV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  RolelistRbacV1Metadata? metadata;
  ...
  factory RolelistRbacV1.fromJson(Map<String, dynamic> json) =>
      _$RolelistRbacV1FromJson(json);

  Map<String, dynamic> toJson() => _$RolelistRbacV1ToJson(this);
}
...
class Item {
  ...
  Item({this.apiVersion, this.kind, this.metadata, this.rules});
...
final itemKindValues = EnumValues({'Role': ItemKind.ROLE});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum RolelistRbacV1Kind {
  @JsonValue('RoleList')
  ROLE_LIST,
}

final rolelistRbacV1KindValues = EnumValues({
  'RoleList': RolelistRbacV1Kind.ROLE_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class RolelistRbacV1Metadata {
  ...
  factory RolelistRbacV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$RolelistRbacV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$RolelistRbacV1MetadataToJson(this);
}
