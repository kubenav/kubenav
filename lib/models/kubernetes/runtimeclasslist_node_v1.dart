...
part 'runtimeclasslist_node_v1.g.dart';

///RuntimeClassList is a list of RuntimeClass objects.
@JsonSerializable()
class RuntimeclasslistNodeV1 {
  ...
  @JsonKey(name: 'kind')
  RuntimeclasslistNodeV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  RuntimeclasslistNodeV1Metadata? metadata;
  ...
  factory RuntimeclasslistNodeV1.fromJson(Map<String, dynamic> json) =>
      _$RuntimeclasslistNodeV1FromJson(json);

  Map<String, dynamic> toJson() => _$RuntimeclasslistNodeV1ToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
  @JsonValue('RuntimeClass')
  RUNTIME_CLASS,
}

final itemKindValues = EnumValues({'RuntimeClass': ItemKind.RUNTIME_CLASS});
...
class Scheduling {
  ...
  Scheduling({this.nodeSelector, this.tolerations});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum RuntimeclasslistNodeV1Kind {
  @JsonValue('RuntimeClassList')
  RUNTIME_CLASS_LIST,
}

final runtimeclasslistNodeV1KindValues = EnumValues({
  'RuntimeClassList': RuntimeclasslistNodeV1Kind.RUNTIME_CLASS_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class RuntimeclasslistNodeV1Metadata {
  ...
  factory RuntimeclasslistNodeV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$RuntimeclasslistNodeV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$RuntimeclasslistNodeV1MetadataToJson(this);
}
