...
class SecretlistV1 {
  ...
  @JsonKey(name: 'kind')
  SecretlistV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  SecretlistV1Metadata? metadata;
  ...
  factory SecretlistV1.fromJson(Map<String, dynamic> json) =>
      _$SecretlistV1FromJson(json);

  Map<String, dynamic> toJson() => _$SecretlistV1ToJson(this);
}
...
class Item {
  ...
  ///or '.'. The serialized form of the secret data is a base64 encoded string, representing
  ...
  ///write-only input field for convenience. All keys and values are merged into the data
  ///field on write, overwriting any existing values. The stringData field is never output
  ///when reading from the API.
  @JsonKey(name: 'stringData')
...
final itemKindValues = EnumValues({'Secret': ItemKind.SECRET});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum SecretlistV1Kind {
  @JsonValue('SecretList')
  SECRET_LIST,
}

final secretlistV1KindValues = EnumValues({
  'SecretList': SecretlistV1Kind.SECRET_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class SecretlistV1Metadata {
  ...
  factory SecretlistV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$SecretlistV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$SecretlistV1MetadataToJson(this);
}
