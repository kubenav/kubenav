...
part of 'secretlist_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

SecretlistV1 _$SecretlistV1FromJson(Map<String, dynamic> json) => SecretlistV1(
  ...
  items: (json['items'] as List<dynamic>)
      ...
      .toList(),
  kind: $enumDecodeNullable(_$SecretlistV1KindEnumMap, json['kind']),
  metadata: json['metadata'] == null
      ? null
      : SecretlistV1Metadata.fromJson(json['metadata'] as Map<String, dynamic>),
);

Map<String, dynamic> _$SecretlistV1ToJson(SecretlistV1 instance) =>
    <String, dynamic>{
      'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
      'items': instance.items,
      'kind': _$SecretlistV1KindEnumMap[instance.kind],
      'metadata': instance.metadata,
    };

const _$ApiVersionEnumMap = {ApiVersion.V1: 'v1'};

const _$SecretlistV1KindEnumMap = {SecretlistV1Kind.SECRET_LIST: 'SecretList'};
...
const _$ItemKindEnumMap = {ItemKind.SECRET: 'Secret'};
...
SecretlistV1Metadata _$SecretlistV1MetadataFromJson(
...
Map<String, dynamic> _$SecretlistV1MetadataToJson(
  SecretlistV1Metadata instance,
) => <String, dynamic>{
