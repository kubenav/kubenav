...
part 'serviceaccountlist_v1.g.dart';

///ServiceAccountList is a list of ServiceAccount objects
@JsonSerializable()
class ServiceaccountlistV1 {
  ...
  @JsonKey(name: 'kind')
  ServiceaccountlistV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  ServiceaccountlistV1Metadata? metadata;

  ServiceaccountlistV1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory ServiceaccountlistV1.fromJson(Map<String, dynamic> json) =>
      _$ServiceaccountlistV1FromJson(json);

  Map<String, dynamic> toJson() => _$ServiceaccountlistV1ToJson(this);
}
...
class Item {
  ...
  ///ServiceAccount are allowed to use. Pods are only limited to this list if this service
  ///account has a "kubernetes.io/enforce-mountable-secrets" annotation set to "true". The
  ///"kubernetes.io/enforce-mountable-secrets" annotation is deprecated since v1.32. Prefer
  ///separate namespaces to isolate access to mounted secrets. This field should not be used
  ///to find auto-generated service account token secrets for use outside of pods. Instead,
  ///tokens can be requested directly using the TokenRequest API, or service account token
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
  @JsonValue('ServiceAccount')
  SERVICE_ACCOUNT,
}

final itemKindValues = EnumValues({'ServiceAccount': ItemKind.SERVICE_ACCOUNT});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ServiceaccountlistV1Kind {
  @JsonValue('ServiceAccountList')
  SERVICE_ACCOUNT_LIST,
}

final serviceaccountlistV1KindValues = EnumValues({
  'ServiceAccountList': ServiceaccountlistV1Kind.SERVICE_ACCOUNT_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class ServiceaccountlistV1Metadata {
  ...
  factory ServiceaccountlistV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$ServiceaccountlistV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$ServiceaccountlistV1MetadataToJson(this);
}
