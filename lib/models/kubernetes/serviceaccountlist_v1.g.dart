...
part of 'serviceaccountlist_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ServiceaccountlistV1 _$ServiceaccountlistV1FromJson(
  ...
  items: (json['items'] as List<dynamic>)
      ...
      .toList(),
  kind: $enumDecodeNullable(_$ServiceaccountlistV1KindEnumMap, json['kind']),
  metadata: json['metadata'] == null
      ? null
      : ServiceaccountlistV1Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$ServiceaccountlistV1ToJson(
  ServiceaccountlistV1 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$ServiceaccountlistV1KindEnumMap[instance.kind],
  'metadata': instance.metadata,
};

const _$ApiVersionEnumMap = {ApiVersion.V1: 'v1'};

const _$ServiceaccountlistV1KindEnumMap = {
  ServiceaccountlistV1Kind.SERVICE_ACCOUNT_LIST: 'ServiceAccountList',
};
...
Item _$ItemFromJson(Map<String, dynamic> json) => Item(
  ...
  secrets: (json['secrets'] as List<dynamic>?)
      ?.map(
        (e) => e == null ? null : Secret.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
);
...
const _$ItemKindEnumMap = {ItemKind.SERVICE_ACCOUNT: 'ServiceAccount'};
...
ServiceaccountlistV1Metadata _$ServiceaccountlistV1MetadataFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$ServiceaccountlistV1MetadataToJson(
  ServiceaccountlistV1Metadata instance,
) => <String, dynamic>{
