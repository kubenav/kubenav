...
part 'servicecidrlist_networking_v1.g.dart';

///ServiceCIDRList contains a list of ServiceCIDR objects.
@JsonSerializable()
class ServicecidrlistNetworkingV1 {
  ...
  @JsonKey(name: 'kind')
  ServicecidrlistNetworkingV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  ServicecidrlistNetworkingV1Metadata? metadata;

  ServicecidrlistNetworkingV1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory ServicecidrlistNetworkingV1.fromJson(Map<String, dynamic> json) =>
      _$ServicecidrlistNetworkingV1FromJson(json);

  Map<String, dynamic> toJson() => _$ServicecidrlistNetworkingV1ToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
  @JsonValue('ServiceCIDR')
  SERVICE_CIDR,
}

final itemKindValues = EnumValues({'ServiceCIDR': ItemKind.SERVICE_CIDR});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ServicecidrlistNetworkingV1Kind {
  @JsonValue('ServiceCIDRList')
  SERVICE_CIDR_LIST,
}

final servicecidrlistNetworkingV1KindValues = EnumValues({
  'ServiceCIDRList': ServicecidrlistNetworkingV1Kind.SERVICE_CIDR_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class ServicecidrlistNetworkingV1Metadata {
  ...
  ServicecidrlistNetworkingV1Metadata({
  ...
  factory ServicecidrlistNetworkingV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$ServicecidrlistNetworkingV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$ServicecidrlistNetworkingV1MetadataToJson(this);
}
