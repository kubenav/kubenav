...
part 'statefulsetlist_apps_v1.g.dart';

///StatefulSetList is a collection of StatefulSets.
@JsonSerializable()
class StatefulsetlistAppsV1 {
  ///APIVersion defines the versioned schema of this representation of an object. Servers
  ///should convert recognized schemas to the latest internal value, and may reject
  ///unrecognized values. More info:
  ///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
  @JsonKey(name: 'apiVersion')
  StatefulsetlistAppsV1ApiVersion? apiVersion;

  ///Items is the list of stateful sets.
  @JsonKey(name: 'items')
  List<StatefulsetlistAppsV1Item?> items;
  ...
  @JsonKey(name: 'kind')
  StatefulsetlistAppsV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  StatefulsetlistAppsV1Metadata? metadata;
  ...
  factory StatefulsetlistAppsV1.fromJson(Map<String, dynamic> json) =>
      _$StatefulsetlistAppsV1FromJson(json);

  Map<String, dynamic> toJson() => _$StatefulsetlistAppsV1ToJson(this);
}
...
///unrecognized values. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
enum StatefulsetlistAppsV1ApiVersion {
  @JsonValue('apps/v1')
  APPS_V1,
}

final statefulsetlistAppsV1ApiVersionValues = EnumValues({
  'apps/v1': StatefulsetlistAppsV1ApiVersion.APPS_V1,
});

@JsonSerializable()
class StatefulsetlistAppsV1Item {
  ///APIVersion defines the versioned schema of this representation of an object. Servers
  ///should convert recognized schemas to the latest internal value, and may reject
  ///unrecognized values. More info:
  ///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
  ...
  factory StatefulsetlistAppsV1Item.fromJson(Map<String, dynamic> json) =>
      _$StatefulsetlistAppsV1ItemFromJson(json);

  Map<String, dynamic> toJson() => _$StatefulsetlistAppsV1ItemToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
  @JsonValue('StatefulSet')
  STATEFUL_SET,
}

final itemKindValues = EnumValues({'StatefulSet': ItemKind.STATEFUL_SET});
...
class ItemSpec {
  ...
  ///opposite order. The alternative policy is `Parallel` which will create pods in parallel
  ///to match the desired scale without waiting, and on scale down will delete all pods at
  ///once.
  ///
  ///Possible enum values:
  ///- `"OrderedReady"` will create pods in strictly increasing order on scale up and strictly
  ///decreasing order on scale down, progressing only when the previous pod is ready or
  ///terminated. At most one pod will be changed at any time.
  ///- `"Parallel"` will create and delete pods as soon as the stateful set replica count is
  ///changed, and will not wait for pods to be ready or complete termination.
  @JsonKey(name: 'podManagementPolicy')
  ...
  @JsonKey(name: 'volumeClaimTemplates')
  List<SpecVolumeClaimTemplate?>? volumeClaimTemplates;
...
class Ordinals {
  ...
  factory Ordinals.fromJson(Map<String, dynamic> json) =>
      _$OrdinalsFromJson(json);

  Map<String, dynamic> toJson() => _$OrdinalsToJson(this);
}
...
class PersistentVolumeClaimRetentionPolicy {
  ...
  PersistentVolumeClaimRetentionPolicy({this.whenDeleted, this.whenScaled});

  factory PersistentVolumeClaimRetentionPolicy.fromJson(
    Map<String, dynamic> json,
  ) => _$PersistentVolumeClaimRetentionPolicyFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PersistentVolumeClaimRetentionPolicyToJson(this);
}
...
final podManagementPolicyValues = EnumValues({
  'OrderedReady': PodManagementPolicy.ORDERED_READY,
  'Parallel': PodManagementPolicy.PARALLEL,
});
...
class Ephemeral {
  ...
  EphemeralVolumeClaimTemplate? volumeClaimTemplate;
...
@JsonSerializable()
class EphemeralVolumeClaimTemplate {
  ///ObjectMeta is metadata that all persisted resources must have, which includes all objects
  ///users must create.
  @JsonKey(name: 'metadata')
  ...
  EphemeralVolumeClaimTemplate({this.metadata, required this.spec});

  factory EphemeralVolumeClaimTemplate.fromJson(Map<String, dynamic> json) =>
      _$EphemeralVolumeClaimTemplateFromJson(json);

  Map<String, dynamic> toJson() => _$EphemeralVolumeClaimTemplateToJson(this);
}
...
class PurpleDataSource {
  ...
  PurpleDataSource({this.apiGroup, required this.kind, required this.name});

  factory PurpleDataSource.fromJson(Map<String, dynamic> json) =>
      _$PurpleDataSourceFromJson(json);

  Map<String, dynamic> toJson() => _$PurpleDataSourceToJson(this);
}

@JsonSerializable()
class PurpleDataSourceRef {
  ///APIGroup is the group for the resource being referenced. If APIGroup is not specified,
  ///the specified Kind must be in the core API group. For any other third-party types,
  ///APIGroup is required.
  @JsonKey(name: 'apiGroup')
  ...
  factory PurpleDataSourceRef.fromJson(Map<String, dynamic> json) =>
      _$PurpleDataSourceRefFromJson(json);

  Map<String, dynamic> toJson() => _$PurpleDataSourceRefToJson(this);
}
...
class UpdateStrategy {
  ...
  ///
  ///Possible enum values:
  ///- `"OnDelete"` triggers the legacy behavior. Version tracking and ordered rolling
  ///restarts are disabled. Pods are recreated from the StatefulSetSpec when they are manually
  ///deleted. When a scale operation is performed with this strategy,specification version
  ///indicated by the StatefulSet's currentRevision.
  ///- `"RollingUpdate"` indicates that update will be applied to all Pods in the StatefulSet
  ///with respect to the StatefulSet ordering constraints. When a scale operation is performed
  ///with this strategy, new Pods will be created from the specification version indicated by
  ///the StatefulSet's updateRevision.
  @JsonKey(name: 'type')
  UpdateStrategyType? type;

  UpdateStrategy({this.rollingUpdate, this.type});

  factory UpdateStrategy.fromJson(Map<String, dynamic> json) =>
      _$UpdateStrategyFromJson(json);

  Map<String, dynamic> toJson() => _$UpdateStrategyToJson(this);
}
...
class RollingUpdate {
  ...
  RollingUpdate({this.maxUnavailable, this.partition});

  factory RollingUpdate.fromJson(Map<String, dynamic> json) =>
      _$RollingUpdateFromJson(json);

  Map<String, dynamic> toJson() => _$RollingUpdateToJson(this);
}
...
final updateStrategyTypeValues = EnumValues({
  'OnDelete': UpdateStrategyType.ON_DELETE,
  'RollingUpdate': UpdateStrategyType.ROLLING_UPDATE,
});

@JsonSerializable()
class SpecVolumeClaimTemplate {
  ///APIVersion defines the versioned schema of this representation of an object. Servers
  ///should convert recognized schemas to the latest internal value, and may reject
  ///unrecognized values. More info:
  ///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
  @JsonKey(name: 'apiVersion')
  VolumeClaimTemplateApiVersion? apiVersion;
  ...
  @JsonKey(name: 'status')
  VolumeClaimTemplateStatus? status;

  SpecVolumeClaimTemplate({
    this.apiVersion,
    this.kind,
    this.metadata,
    this.spec,
  ...
  factory SpecVolumeClaimTemplate.fromJson(Map<String, dynamic> json) =>
      _$SpecVolumeClaimTemplateFromJson(json);

  Map<String, dynamic> toJson() => _$SpecVolumeClaimTemplateToJson(this);
}
...
///unrecognized values. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#resources
enum VolumeClaimTemplateApiVersion {
  @JsonValue('v1')
  V1,
}

final volumeClaimTemplateApiVersionValues = EnumValues({
  'v1': VolumeClaimTemplateApiVersion.V1,
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum VolumeClaimTemplateKind {
  @JsonValue('PersistentVolumeClaim')
  PERSISTENT_VOLUME_CLAIM,
}

final volumeClaimTemplateKindValues = EnumValues({
  'PersistentVolumeClaim': VolumeClaimTemplateKind.PERSISTENT_VOLUME_CLAIM,
});
...
class FluffyMetadata {
  ...
  ///version that the workflow used when modifying the object.
  @JsonKey(name: 'managedFields')
  List<StickyManagedField?>? managedFields;
  ...
  ///There cannot be more than one managing controller.
  @JsonKey(name: 'ownerReferences')
  List<StickyOwnerReference?>? ownerReferences;
...
class StickyManagedField {
  ...
  factory StickyManagedField.fromJson(Map<String, dynamic> json) =>
      _$StickyManagedFieldFromJson(json);

  Map<String, dynamic> toJson() => _$StickyManagedFieldToJson(this);
}

@JsonSerializable()
class StickyOwnerReference {
  ///API version of the referent.
  @JsonKey(name: 'apiVersion')
  String apiVersion;
  ...
  factory StickyOwnerReference.fromJson(Map<String, dynamic> json) =>
      _$StickyOwnerReferenceFromJson(json);

  Map<String, dynamic> toJson() => _$StickyOwnerReferenceToJson(this);
}
...
class FluffySpec {
  ...
  ///referenced object inside the same namespace.
  @JsonKey(name: 'dataSource')
  FluffyDataSource? dataSource;

  ///TypedObjectReference contains enough information to let you locate the typed referenced
  ///object
  @JsonKey(name: 'dataSourceRef')
  FluffyDataSourceRef? dataSourceRef;

  ///VolumeResourceRequirements describes the storage resource requirements for a volume.
  @JsonKey(name: 'resources')
  TentacledResources? resources;
...
class FluffyDataSource {
  ...
  FluffyDataSource({this.apiGroup, required this.kind, required this.name});

  factory FluffyDataSource.fromJson(Map<String, dynamic> json) =>
      _$FluffyDataSourceFromJson(json);

  Map<String, dynamic> toJson() => _$FluffyDataSourceToJson(this);
}

@JsonSerializable()
class FluffyDataSourceRef {
  ///APIGroup is the group for the resource being referenced. If APIGroup is not specified,
  ///the specified Kind must be in the core API group. For any other third-party types,
  ///APIGroup is required.
  @JsonKey(name: 'apiGroup')
  ...
  factory FluffyDataSourceRef.fromJson(Map<String, dynamic> json) =>
      _$FluffyDataSourceRefFromJson(json);

  Map<String, dynamic> toJson() => _$FluffyDataSourceRefToJson(this);
}

@JsonSerializable()
class TentacledResources {
  ///Limits describes the maximum amount of compute resources allowed. More info:
  ///https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
  @JsonKey(name: 'limits')
  Map<String, dynamic>? limits;
  ...
  TentacledResources({this.limits, this.requests});

  factory TentacledResources.fromJson(Map<String, dynamic> json) =>
      _$TentacledResourcesFromJson(json);

  Map<String, dynamic> toJson() => _$TentacledResourcesToJson(this);
}
...
@JsonSerializable()
class VolumeClaimTemplateStatus {
  ...
  List<PurpleCondition?>? conditions;
  ...
  factory VolumeClaimTemplateStatus.fromJson(Map<String, dynamic> json) =>
      _$VolumeClaimTemplateStatusFromJson(json);

  Map<String, dynamic> toJson() => _$VolumeClaimTemplateStatusToJson(this);
}
...
class PurpleCondition {
  ...
  factory PurpleCondition.fromJson(Map<String, dynamic> json) =>
      _$PurpleConditionFromJson(json);

  Map<String, dynamic> toJson() => _$PurpleConditionToJson(this);
}
...
class ItemStatus {
  ...
  @JsonKey(name: 'conditions')
  List<FluffyCondition?>? conditions;
...
class FluffyCondition {
  ...
  factory FluffyCondition.fromJson(Map<String, dynamic> json) =>
      _$FluffyConditionFromJson(json);

  Map<String, dynamic> toJson() => _$FluffyConditionToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum StatefulsetlistAppsV1Kind {
  @JsonValue('StatefulSetList')
  STATEFUL_SET_LIST,
}

final statefulsetlistAppsV1KindValues = EnumValues({
  'StatefulSetList': StatefulsetlistAppsV1Kind.STATEFUL_SET_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class StatefulsetlistAppsV1Metadata {
  ...
  factory StatefulsetlistAppsV1Metadata.fromJson(Map<String, dynamic> json) =>
      _$StatefulsetlistAppsV1MetadataFromJson(json);

  Map<String, dynamic> toJson() => _$StatefulsetlistAppsV1MetadataToJson(this);
}
