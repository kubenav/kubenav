...
part of 'statefulsetlist_apps_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

StatefulsetlistAppsV1 _$StatefulsetlistAppsV1FromJson(
  Map<String, dynamic> json,
) => StatefulsetlistAppsV1(
  apiVersion: $enumDecodeNullable(
    _$StatefulsetlistAppsV1ApiVersionEnumMap,
    json['apiVersion'],
  ),
  items: (json['items'] as List<dynamic>)
      .map(
        (e) => e == null
            ? null
            : StatefulsetlistAppsV1Item.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  kind: $enumDecodeNullable(_$StatefulsetlistAppsV1KindEnumMap, json['kind']),
  metadata: json['metadata'] == null
      ? null
      : StatefulsetlistAppsV1Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$StatefulsetlistAppsV1ToJson(
  StatefulsetlistAppsV1 instance,
) => <String, dynamic>{
  'apiVersion': _$StatefulsetlistAppsV1ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$StatefulsetlistAppsV1KindEnumMap[instance.kind],
  'metadata': instance.metadata,
};

const _$StatefulsetlistAppsV1ApiVersionEnumMap = {
  StatefulsetlistAppsV1ApiVersion.APPS_V1: 'apps/v1',
};

const _$StatefulsetlistAppsV1KindEnumMap = {
  StatefulsetlistAppsV1Kind.STATEFUL_SET_LIST: 'StatefulSetList',
};

StatefulsetlistAppsV1Item _$StatefulsetlistAppsV1ItemFromJson(
  Map<String, dynamic> json,
  ...
  status: json['status'] == null
      ? null
      : ItemStatus.fromJson(json['status'] as Map<String, dynamic>),
);

Map<String, dynamic> _$StatefulsetlistAppsV1ItemToJson(
  StatefulsetlistAppsV1Item instance,
) => <String, dynamic>{
  'apiVersion': _$StatefulsetlistAppsV1ApiVersionEnumMap[instance.apiVersion],
...
const _$ItemKindEnumMap = {ItemKind.STATEFUL_SET: 'StatefulSet'};
...
ItemSpec _$ItemSpecFromJson(Map<String, dynamic> json) => ItemSpec(
  ...
  ordinals: json['ordinals'] == null
      ? null
      : Ordinals.fromJson(json['ordinals'] as Map<String, dynamic>),
  persistentVolumeClaimRetentionPolicy:
      json['persistentVolumeClaimRetentionPolicy'] == null
      ? null
      : PersistentVolumeClaimRetentionPolicy.fromJson(
          json['persistentVolumeClaimRetentionPolicy'] as Map<String, dynamic>,
        ),
  podManagementPolicy: $enumDecodeNullable(
    _$PodManagementPolicyEnumMap,
    json['podManagementPolicy'],
  ),
  replicas: (json['replicas'] as num?)?.toInt(),
  revisionHistoryLimit: (json['revisionHistoryLimit'] as num?)?.toInt(),
  selector: PurpleSelector.fromJson(json['selector'] as Map<String, dynamic>),
  serviceName: json['serviceName'] as String?,
  template: Template.fromJson(json['template'] as Map<String, dynamic>),
  updateStrategy: json['updateStrategy'] == null
      ? null
      : UpdateStrategy.fromJson(json['updateStrategy'] as Map<String, dynamic>),
  volumeClaimTemplates: (json['volumeClaimTemplates'] as List<dynamic>?)
      ?.map(
        (e) => e == null
            ? null
            : SpecVolumeClaimTemplate.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
);
...
Map<String, dynamic> _$ItemSpecToJson(ItemSpec instance) => <String, dynamic>{
  ...
  'ordinals': instance.ordinals,
  'persistentVolumeClaimRetentionPolicy':
      instance.persistentVolumeClaimRetentionPolicy,
  'podManagementPolicy':
      _$PodManagementPolicyEnumMap[instance.podManagementPolicy],
...
const _$PodManagementPolicyEnumMap = {
  PodManagementPolicy.ORDERED_READY: 'OrderedReady',
  PodManagementPolicy.PARALLEL: 'Parallel',
};

Ordinals _$OrdinalsFromJson(Map<String, dynamic> json) =>
    Ordinals(start: (json['start'] as num?)?.toInt());

Map<String, dynamic> _$OrdinalsToJson(Ordinals instance) => <String, dynamic>{
  'start': instance.start,
};

PersistentVolumeClaimRetentionPolicy
_$PersistentVolumeClaimRetentionPolicyFromJson(Map<String, dynamic> json) =>
    PersistentVolumeClaimRetentionPolicy(
      whenDeleted: json['whenDeleted'] as String?,
      whenScaled: json['whenScaled'] as String?,
    );

Map<String, dynamic> _$PersistentVolumeClaimRetentionPolicyToJson(
  PersistentVolumeClaimRetentionPolicy instance,
) => <String, dynamic>{
...
Ephemeral _$EphemeralFromJson(Map<String, dynamic> json) => Ephemeral(
  volumeClaimTemplate: json['volumeClaimTemplate'] == null
      ? null
      : EphemeralVolumeClaimTemplate.fromJson(
...
EphemeralVolumeClaimTemplate _$EphemeralVolumeClaimTemplateFromJson(
  Map<String, dynamic> json,
) => EphemeralVolumeClaimTemplate(
  metadata: json['metadata'] == null
      ? null
...
Map<String, dynamic> _$EphemeralVolumeClaimTemplateToJson(
  EphemeralVolumeClaimTemplate instance,
...
PurpleSpec _$PurpleSpecFromJson(Map<String, dynamic> json) => PurpleSpec(
  ...
  dataSource: json['dataSource'] == null
      ? null
      : PurpleDataSource.fromJson(json['dataSource'] as Map<String, dynamic>),
  dataSourceRef: json['dataSourceRef'] == null
      ? null
      : PurpleDataSourceRef.fromJson(
...
PurpleDataSource _$PurpleDataSourceFromJson(Map<String, dynamic> json) =>
    PurpleDataSource(
...
Map<String, dynamic> _$PurpleDataSourceToJson(PurpleDataSource instance) =>
    <String, dynamic>{
...
PurpleDataSourceRef _$PurpleDataSourceRefFromJson(Map<String, dynamic> json) =>
    PurpleDataSourceRef(
      apiGroup: json['apiGroup'] as String?,
      kind: json['kind'] as String,
      name: json['name'] as String,
...
Map<String, dynamic> _$PurpleDataSourceRefToJson(
  PurpleDataSourceRef instance,
) => <String, dynamic>{
  'apiGroup': instance.apiGroup,
  'kind': instance.kind,
  'name': instance.name,
...
UpdateStrategy _$UpdateStrategyFromJson(Map<String, dynamic> json) =>
    UpdateStrategy(
      rollingUpdate: json['rollingUpdate'] == null
          ? null
          : RollingUpdate.fromJson(
              json['rollingUpdate'] as Map<String, dynamic>,
            ),
      type: $enumDecodeNullable(_$UpdateStrategyTypeEnumMap, json['type']),
    );

Map<String, dynamic> _$UpdateStrategyToJson(UpdateStrategy instance) =>
    <String, dynamic>{
      'rollingUpdate': instance.rollingUpdate,
      'type': _$UpdateStrategyTypeEnumMap[instance.type],
    };

const _$UpdateStrategyTypeEnumMap = {
  UpdateStrategyType.ON_DELETE: 'OnDelete',
  UpdateStrategyType.ROLLING_UPDATE: 'RollingUpdate',
};

RollingUpdate _$RollingUpdateFromJson(Map<String, dynamic> json) =>
    RollingUpdate(
      maxUnavailable: json['maxUnavailable'],
      partition: (json['partition'] as num?)?.toInt(),
    );

Map<String, dynamic> _$RollingUpdateToJson(RollingUpdate instance) =>
    <String, dynamic>{
      'maxUnavailable': instance.maxUnavailable,
      'partition': instance.partition,
    };

SpecVolumeClaimTemplate _$SpecVolumeClaimTemplateFromJson(
  Map<String, dynamic> json,
) => SpecVolumeClaimTemplate(
  apiVersion: $enumDecodeNullable(
    _$VolumeClaimTemplateApiVersionEnumMap,
    json['apiVersion'],
  ),
  kind: $enumDecodeNullable(_$VolumeClaimTemplateKindEnumMap, json['kind']),
  metadata: json['metadata'] == null
      ? null
  ...
  status: json['status'] == null
      ? null
      : VolumeClaimTemplateStatus.fromJson(
          json['status'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$SpecVolumeClaimTemplateToJson(
  SpecVolumeClaimTemplate instance,
) => <String, dynamic>{
  'apiVersion': _$VolumeClaimTemplateApiVersionEnumMap[instance.apiVersion],
  'kind': _$VolumeClaimTemplateKindEnumMap[instance.kind],
  'metadata': instance.metadata,
  'spec': instance.spec,
  'status': instance.status,
};

const _$VolumeClaimTemplateApiVersionEnumMap = {
  VolumeClaimTemplateApiVersion.V1: 'v1',
};

const _$VolumeClaimTemplateKindEnumMap = {
  VolumeClaimTemplateKind.PERSISTENT_VOLUME_CLAIM: 'PersistentVolumeClaim',
};

FluffyMetadata _$FluffyMetadataFromJson(
  Map<String, dynamic> json,
) => FluffyMetadata(
  annotations: (json['annotations'] as Map<String, dynamic>?)?.map(
    (k, e) => MapEntry(k, e as String?),
  ...
  managedFields: (json['managedFields'] as List<dynamic>?)
      ?.map(
        (e) => e == null
            ? null
            : StickyManagedField.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  name: json['name'] as String?,
  namespace: json['namespace'] as String?,
  ownerReferences: (json['ownerReferences'] as List<dynamic>?)
      ?.map(
        (e) => e == null
            ? null
            : StickyOwnerReference.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
  resourceVersion: json['resourceVersion'] as String?,
  selfLink: json['selfLink'] as String?,
...
StickyManagedField _$StickyManagedFieldFromJson(Map<String, dynamic> json) =>
    StickyManagedField(
      apiVersion: json['apiVersion'] as String?,
      fieldsType: json['fieldsType'] as String?,
      fieldsV1: json['fieldsV1'] as Map<String, dynamic>?,
...
Map<String, dynamic> _$StickyManagedFieldToJson(StickyManagedField instance) =>
    <String, dynamic>{
      'apiVersion': instance.apiVersion,
      'fieldsType': instance.fieldsType,
      'fieldsV1': instance.fieldsV1,
...
StickyOwnerReference _$StickyOwnerReferenceFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$StickyOwnerReferenceToJson(
  StickyOwnerReference instance,
) => <String, dynamic>{
  'apiVersion': instance.apiVersion,
  'blockOwnerDeletion': instance.blockOwnerDeletion,
  'controller': instance.controller,
...
FluffySpec _$FluffySpecFromJson(Map<String, dynamic> json) => FluffySpec(
  ...
  dataSource: json['dataSource'] == null
      ? null
      : FluffyDataSource.fromJson(json['dataSource'] as Map<String, dynamic>),
  dataSourceRef: json['dataSourceRef'] == null
      ? null
      : FluffyDataSourceRef.fromJson(
          json['dataSourceRef'] as Map<String, dynamic>,
        ),
  resources: json['resources'] == null
      ? null
      : TentacledResources.fromJson(json['resources'] as Map<String, dynamic>),
  selector: json['selector'] == null
      ? null
...
FluffyDataSource _$FluffyDataSourceFromJson(Map<String, dynamic> json) =>
    FluffyDataSource(
      apiGroup: json['apiGroup'] as String?,
      kind: json['kind'] as String,
      name: json['name'] as String,
...
Map<String, dynamic> _$FluffyDataSourceToJson(FluffyDataSource instance) =>
    <String, dynamic>{
      'apiGroup': instance.apiGroup,
      'kind': instance.kind,
      'name': instance.name,
...
FluffyDataSourceRef _$FluffyDataSourceRefFromJson(Map<String, dynamic> json) =>
    FluffyDataSourceRef(
      apiGroup: json['apiGroup'] as String?,
      kind: json['kind'] as String,
      name: json['name'] as String,
...
Map<String, dynamic> _$FluffyDataSourceRefToJson(
  FluffyDataSourceRef instance,
) => <String, dynamic>{
  'apiGroup': instance.apiGroup,
  'kind': instance.kind,
  'name': instance.name,
...
TentacledResources _$TentacledResourcesFromJson(Map<String, dynamic> json) =>
    TentacledResources(
      limits: json['limits'] as Map<String, dynamic>?,
      requests: json['requests'] as Map<String, dynamic>?,
    );

Map<String, dynamic> _$TentacledResourcesToJson(TentacledResources instance) =>
    <String, dynamic>{'limits': instance.limits, 'requests': instance.requests};
...
VolumeClaimTemplateStatus _$VolumeClaimTemplateStatusFromJson(
  Map<String, dynamic> json,
  ...
  conditions: (json['conditions'] as List<dynamic>?)
      ?.map(
        (e) => e == null
            ? null
            : PurpleCondition.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
...
Map<String, dynamic> _$VolumeClaimTemplateStatusToJson(
  VolumeClaimTemplateStatus instance,
) => <String, dynamic>{
  'accessModes': instance.accessModes
      ?.map((e) => _$AccessModeEnumMap[e]!)
      .toList(),
...
PurpleCondition _$PurpleConditionFromJson(Map<String, dynamic> json) =>
    PurpleCondition(
...
Map<String, dynamic> _$PurpleConditionToJson(PurpleCondition instance) =>
    <String, dynamic>{
...
ItemStatus _$ItemStatusFromJson(Map<String, dynamic> json) => ItemStatus(
  ...
  conditions: (json['conditions'] as List<dynamic>?)
      ?.map(
        (e) => e == null
            ? null
            : FluffyCondition.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
...
FluffyCondition _$FluffyConditionFromJson(Map<String, dynamic> json) =>
    FluffyCondition(
      lastTransitionTime: json['lastTransitionTime'] == null
          ? null
          : DateTime.parse(json['lastTransitionTime'] as String),
...
Map<String, dynamic> _$FluffyConditionToJson(FluffyCondition instance) =>
    <String, dynamic>{
      'lastTransitionTime': instance.lastTransitionTime?.toIso8601String(),
      'message': instance.message,
      'reason': instance.reason,
...
StatefulsetlistAppsV1Metadata _$StatefulsetlistAppsV1MetadataFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$StatefulsetlistAppsV1MetadataToJson(
  StatefulsetlistAppsV1Metadata instance,
) => <String, dynamic>{
