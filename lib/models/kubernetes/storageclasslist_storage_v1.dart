...
part 'storageclasslist_storage_v1.g.dart';

///StorageClassList is a collection of storage classes.
@JsonSerializable()
class StorageclasslistStorageV1 {
  ...
  @JsonKey(name: 'kind')
  StorageclasslistStorageV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  StorageclasslistStorageV1Metadata? metadata;

  StorageclasslistStorageV1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory StorageclasslistStorageV1.fromJson(Map<String, dynamic> json) =>
      _$StorageclasslistStorageV1FromJson(json);

  Map<String, dynamic> toJson() => _$StorageclasslistStorageV1ToJson(this);
}
...
class Item {
  ...
  ///provisioned. Each volume plugin defines its own supported topology specifications. An
  ///empty TopologySelectorTerm list means there is no topology restriction. This field is
  ///only honored by servers that enable the VolumeScheduling feature.
  @JsonKey(name: 'allowedTopologies')
  List<AllowedTopology?>? allowedTopologies;

  ///allowVolumeExpansion shows whether the storage class allow volume expand.
  @JsonKey(name: 'allowVolumeExpansion')
  ...
  ///mountOptions controls the mountOptions for dynamically provisioned PersistentVolumes of
  ///this storage class. e.g. ["ro", "soft"]. Not validated - mount of the PVs will simply
  ...
  @JsonKey(name: 'provisioner')
  String provisioner;

  ///reclaimPolicy controls the reclaimPolicy for dynamically provisioned PersistentVolumes of
  ...
  ///and bound. This is the default mode.
  ///- `"WaitForFirstConsumer"` indicates that PersistentVolumeClaims should not be
  ///provisioned and bound until the first Pod is created that references the
  ///PeristentVolumeClaim. The volume provisioning and binding will occur during Pod scheduing.
  @JsonKey(name: 'volumeBindingMode')
...
class AllowedTopology {
  ...
  List<MatchLabelExpression?>? matchLabelExpressions;

  AllowedTopology({this.matchLabelExpressions});

  factory AllowedTopology.fromJson(Map<String, dynamic> json) =>
      _$AllowedTopologyFromJson(json);

  Map<String, dynamic> toJson() => _$AllowedTopologyToJson(this);
}
...
class MatchLabelExpression {
  ...
  MatchLabelExpression({required this.key, required this.values});

  factory MatchLabelExpression.fromJson(Map<String, dynamic> json) =>
      _$MatchLabelExpressionFromJson(json);

  Map<String, dynamic> toJson() => _$MatchLabelExpressionToJson(this);
}
...
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum ItemKind {
  @JsonValue('StorageClass')
  STORAGE_CLASS,
}

final itemKindValues = EnumValues({'StorageClass': ItemKind.STORAGE_CLASS});
...
final reclaimPolicyValues = EnumValues({
...
final volumeBindingModeValues = EnumValues({
  'Immediate': VolumeBindingMode.IMMEDIATE,
  'WaitForFirstConsumer': VolumeBindingMode.WAIT_FOR_FIRST_CONSUMER,
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum StorageclasslistStorageV1Kind {
  @JsonValue('StorageClassList')
  STORAGE_CLASS_LIST,
}

final storageclasslistStorageV1KindValues = EnumValues({
  'StorageClassList': StorageclasslistStorageV1Kind.STORAGE_CLASS_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class StorageclasslistStorageV1Metadata {
  ...
  StorageclasslistStorageV1Metadata({
  ...
  factory StorageclasslistStorageV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$StorageclasslistStorageV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$StorageclasslistStorageV1MetadataToJson(this);
}
