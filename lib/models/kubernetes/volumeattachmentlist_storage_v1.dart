...
part 'volumeattachmentlist_storage_v1.g.dart';

///VolumeAttachmentList is a collection of VolumeAttachment objects.
@JsonSerializable()
class VolumeattachmentlistStorageV1 {
  ...
  @JsonKey(name: 'kind')
  VolumeattachmentlistStorageV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  VolumeattachmentlistStorageV1Metadata? metadata;

  VolumeattachmentlistStorageV1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory VolumeattachmentlistStorageV1.fromJson(Map<String, dynamic> json) =>
      _$VolumeattachmentlistStorageV1FromJson(json);

  Map<String, dynamic> toJson() => _$VolumeattachmentlistStorageV1ToJson(this);
}
...
class Spec {
  ...
  Spec({required this.attacher, required this.nodeName, required this.source});
...
class Source {
  ...
  Source({this.inlineVolumeSpec, this.persistentVolumeName});
...
class InlineVolumeSpec {
  ...
  factory InlineVolumeSpec.fromJson(Map<String, dynamic> json) =>
      _$InlineVolumeSpecFromJson(json);

  Map<String, dynamic> toJson() => _$InlineVolumeSpecToJson(this);
}
...
@JsonSerializable()
class AttachError {
  ///errorCode is a numeric gRPC code representing the error encountered during Attach or
  ///Detach operations.
  ///
  ///This is an optional, beta field that requires the MutableCSINodeAllocatableCount feature
  ///gate being enabled to be set.
  ...
  AttachError({this.errorCode, this.message, this.time});

  factory AttachError.fromJson(Map<String, dynamic> json) =>
      _$AttachErrorFromJson(json);

  Map<String, dynamic> toJson() => _$AttachErrorToJson(this);
}
...
class DetachError {
  ...
  DetachError({this.errorCode, this.message, this.time});

  factory DetachError.fromJson(Map<String, dynamic> json) =>
      _$DetachErrorFromJson(json);

  Map<String, dynamic> toJson() => _$DetachErrorToJson(this);
}
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum VolumeattachmentlistStorageV1Kind {
  @JsonValue('VolumeAttachmentList')
  VOLUME_ATTACHMENT_LIST,
}

final volumeattachmentlistStorageV1KindValues = EnumValues({
  'VolumeAttachmentList':
      VolumeattachmentlistStorageV1Kind.VOLUME_ATTACHMENT_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class VolumeattachmentlistStorageV1Metadata {
  ...
  VolumeattachmentlistStorageV1Metadata({
  ...
  factory VolumeattachmentlistStorageV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$VolumeattachmentlistStorageV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$VolumeattachmentlistStorageV1MetadataToJson(this);
}
