...
part 'volumeattributesclasslist_storage_v1.g.dart';

///VolumeAttributesClassList is a collection of VolumeAttributesClass objects.
@JsonSerializable()
class VolumeattributesclasslistStorageV1 {
  ...
  @JsonKey(name: 'kind')
  VolumeattributesclasslistStorageV1Kind? kind;

  ///ListMeta describes metadata that synthetic resources must have, including lists and
  ///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
  @JsonKey(name: 'metadata')
  VolumeattributesclasslistStorageV1Metadata? metadata;

  VolumeattributesclasslistStorageV1({
    this.apiVersion,
    required this.items,
    this.kind,
    this.metadata,
  ...
  factory VolumeattributesclasslistStorageV1.fromJson(
    Map<String, dynamic> json,
  ) => _$VolumeattributesclasslistStorageV1FromJson(json);

  Map<String, dynamic> toJson() =>
      _$VolumeattributesclasslistStorageV1ToJson(this);
}
...
class Item {
  ...
  ///parameters hold volume attributes defined by the CSI driver. These values are opaque to
  ///the Kubernetes and are passed directly to the CSI driver. The underlying storage provider
  ///supports changing these attributes on an existing volume, however the parameters field
  ///itself is immutable. To invoke a volume update, a new VolumeAttributesClass should be
  ///created with new parameters, and the PersistentVolumeClaim should be updated to reference
  ///the new VolumeAttributesClass.
  ///
  ///This field is required and must contain at least one key/value pair. The keys cannot be
  ///empty, and the maximum number of parameters is 512, with a cumulative max size of 256K.
  ///If the CSI driver rejects invalid parameters, the target PersistentVolumeClaim will be
  ///set to an "Infeasible" state in the modifyVolumeStatus field.
...
final itemKindValues = EnumValues({
  'VolumeAttributesClass': ItemKind.VOLUME_ATTRIBUTES_CLASS,
});
...
///CamelCase. More info:
///https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds
enum VolumeattributesclasslistStorageV1Kind {
  @JsonValue('VolumeAttributesClassList')
  VOLUME_ATTRIBUTES_CLASS_LIST,
}

final volumeattributesclasslistStorageV1KindValues = EnumValues({
  'VolumeAttributesClassList':
      VolumeattributesclasslistStorageV1Kind.VOLUME_ATTRIBUTES_CLASS_LIST,
});

///ListMeta describes metadata that synthetic resources must have, including lists and
///various status objects. A resource may have only one of {ObjectMeta, ListMeta}.
@JsonSerializable()
class VolumeattributesclasslistStorageV1Metadata {
  ...
  VolumeattributesclasslistStorageV1Metadata({
  ...
  factory VolumeattributesclasslistStorageV1Metadata.fromJson(
    Map<String, dynamic> json,
  ) => _$VolumeattributesclasslistStorageV1MetadataFromJson(json);

  Map<String, dynamic> toJson() =>
      _$VolumeattributesclasslistStorageV1MetadataToJson(this);
}
