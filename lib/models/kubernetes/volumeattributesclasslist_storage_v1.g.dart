...
part of 'volumeattributesclasslist_storage_v1.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

VolumeattributesclasslistStorageV1 _$VolumeattributesclasslistStorageV1FromJson(
  ...
  kind: $enumDecodeNullable(
    _$VolumeattributesclasslistStorageV1KindEnumMap,
    json['kind'],
  ),
  metadata: json['metadata'] == null
      ? null
      : VolumeattributesclasslistStorageV1Metadata.fromJson(
          json['metadata'] as Map<String, dynamic>,
        ),
);

Map<String, dynamic> _$VolumeattributesclasslistStorageV1ToJson(
  VolumeattributesclasslistStorageV1 instance,
) => <String, dynamic>{
  'apiVersion': _$ApiVersionEnumMap[instance.apiVersion],
  'items': instance.items,
  'kind': _$VolumeattributesclasslistStorageV1KindEnumMap[instance.kind],
...
const _$VolumeattributesclasslistStorageV1KindEnumMap = {
...
const _$ItemKindEnumMap = {
  ItemKind.VOLUME_ATTRIBUTES_CLASS: 'VolumeAttributesClass',
};
...
_$VolumeattributesclasslistStorageV1MetadataFromJson(
  Map<String, dynamic> json,
) => VolumeattributesclasslistStorageV1Metadata(
...
Map<String, dynamic> _$VolumeattributesclasslistStorageV1MetadataToJson(
  VolumeattributesclasslistStorageV1Metadata instance,
) => <String, dynamic>{
