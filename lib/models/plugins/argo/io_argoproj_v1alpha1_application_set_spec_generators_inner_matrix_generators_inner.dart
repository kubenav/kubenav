...
class IoArgoprojV1alpha1ApplicationSetSpecGeneratorsInnerMatrixGeneratorsInner {
  /// Returns a new [IoArgoprojV1alpha1ApplicationSetSpecGeneratorsInnerMatrixGeneratorsInner] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is IoArgoprojV1alpha1ApplicationSetSpecGeneratorsInnerMatrixGeneratorsInner &&
  ...
  @override
  String toString() =>
      'IoArgoprojV1alpha1ApplicationSetSpecGeneratorsInnerMatrixGeneratorsInner[clusterDecisionResource=$clusterDecisionResource, clusters=$clusters, git=$git, list=$list, matrix=$matrix, merge=$merge, plugin=$plugin, pullRequest=$pullRequest, scmProvider=$scmProvider, selector=$selector]';
  ...
  /// Returns a new [IoArgoprojV1alpha1ApplicationSetSpecGeneratorsInnerMatrixGeneratorsInner] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IoArgoprojV1alpha1ApplicationSetSpecGeneratorsInnerMatrixGeneratorsInner?
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoArgoprojV1alpha1ApplicationSetSpecGeneratorsInnerMatrixGeneratorsInner[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoArgoprojV1alpha1ApplicationSetSpecGeneratorsInnerMatrixGeneratorsInner[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoArgoprojV1alpha1ApplicationSetSpecGeneratorsInnerMatrixGeneratorsInner(
        clusterDecisionResource:
            IoArgoprojV1alpha1ApplicationSetSpecGeneratorsInnerClusterDecisionResource
        ...
        list: IoArgoprojV1alpha1ApplicationSetSpecGeneratorsInnerList.fromJson(
            json[r'list']),
        matrix: mapValueOfType<Object>(json, r'matrix'),
        merge: mapValueOfType<Object>(json, r'merge'),
        plugin:
            IoArgoprojV1alpha1ApplicationSetSpecGeneratorsInnerMatrixGeneratorsInnerPlugin
  ...
  // maps a json object with a list of IoArgoprojV1alpha1ApplicationSetSpecGeneratorsInnerMatrixGeneratorsInner-objects as value to a dart map
  static Map<
          String,
          List<
              IoArgoprojV1alpha1ApplicationSetSpecGeneratorsInnerMatrixGeneratorsInner>>
