...
class IoArgoprojV1alpha1ApplicationSpecSource {
  /// Returns a new [IoArgoprojV1alpha1ApplicationSpecSource] instance.
  IoArgoprojV1alpha1ApplicationSpecSource({
    this.chart,
    this.directory,
    this.helm,
    this.kustomize,
  ...
  bool operator ==(Object other) =>
      ...
      other is IoArgoprojV1alpha1ApplicationSpecSource &&
          other.chart == chart &&
  ...
  @override
  String toString() =>
      'IoArgoprojV1alpha1ApplicationSpecSource[chart=$chart, directory=$directory, helm=$helm, kustomize=$kustomize, path=$path, plugin=$plugin, ref=$ref, repoURL=$repoURL, targetRevision=$targetRevision]';
  ...
  /// Returns a new [IoArgoprojV1alpha1ApplicationSpecSource] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IoArgoprojV1alpha1ApplicationSpecSource? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoArgoprojV1alpha1ApplicationSpecSource[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoArgoprojV1alpha1ApplicationSpecSource[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoArgoprojV1alpha1ApplicationSpecSource(
  ...
  static List<IoArgoprojV1alpha1ApplicationSpecSource> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <IoArgoprojV1alpha1ApplicationSpecSource>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IoArgoprojV1alpha1ApplicationSpecSource.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IoArgoprojV1alpha1ApplicationSpecSource> mapFromJson(
      dynamic json) {
    final map = <String, IoArgoprojV1alpha1ApplicationSpecSource>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value =
            IoArgoprojV1alpha1ApplicationSpecSource.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IoArgoprojV1alpha1ApplicationSpecSource-objects as value to a dart map
  static Map<String, List<IoArgoprojV1alpha1ApplicationSpecSource>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map = <String, List<IoArgoprojV1alpha1ApplicationSpecSource>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = IoArgoprojV1alpha1ApplicationSpecSource.listFromJson(
          entry.value,
          growable: growable,
        );
      }
