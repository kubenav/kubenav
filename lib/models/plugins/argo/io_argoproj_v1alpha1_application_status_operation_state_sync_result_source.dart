...
class IoArgoprojV1alpha1ApplicationStatusOperationStateSyncResultSource {
  /// Returns a new [IoArgoprojV1alpha1ApplicationStatusOperationStateSyncResultSource] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is IoArgoprojV1alpha1ApplicationStatusOperationStateSyncResultSource &&
          other.chart == chart &&
  ...
  @override
  String toString() =>
      'IoArgoprojV1alpha1ApplicationStatusOperationStateSyncResultSource[chart=$chart, directory=$directory, helm=$helm, kustomize=$kustomize, path=$path, plugin=$plugin, ref=$ref, repoURL=$repoURL, targetRevision=$targetRevision]';
  ...
  /// Returns a new [IoArgoprojV1alpha1ApplicationStatusOperationStateSyncResultSource] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IoArgoprojV1alpha1ApplicationStatusOperationStateSyncResultSource?
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoArgoprojV1alpha1ApplicationStatusOperationStateSyncResultSource[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoArgoprojV1alpha1ApplicationStatusOperationStateSyncResultSource[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoArgoprojV1alpha1ApplicationStatusOperationStateSyncResultSource(
  ...
  static List<IoArgoprojV1alpha1ApplicationStatusOperationStateSyncResultSource>
      listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  // maps a json object with a list of IoArgoprojV1alpha1ApplicationStatusOperationStateSyncResultSource-objects as value to a dart map
  static Map<
          String,
          List<
              IoArgoprojV1alpha1ApplicationStatusOperationStateSyncResultSource>>
