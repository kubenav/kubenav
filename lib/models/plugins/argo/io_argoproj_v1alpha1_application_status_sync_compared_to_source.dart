...
class IoArgoprojV1alpha1ApplicationStatusSyncComparedToSource {
  /// Returns a new [IoArgoprojV1alpha1ApplicationStatusSyncComparedToSource] instance.
  IoArgoprojV1alpha1ApplicationStatusSyncComparedToSource({
    this.chart,
    this.directory,
    this.helm,
    this.kustomize,
  ...
  bool operator ==(Object other) =>
      ...
      other is IoArgoprojV1alpha1ApplicationStatusSyncComparedToSource &&
          other.chart == chart &&
  ...
  @override
  String toString() =>
      'IoArgoprojV1alpha1ApplicationStatusSyncComparedToSource[chart=$chart, directory=$directory, helm=$helm, kustomize=$kustomize, path=$path, plugin=$plugin, ref=$ref, repoURL=$repoURL, targetRevision=$targetRevision]';
  ...
  /// Returns a new [IoArgoprojV1alpha1ApplicationStatusSyncComparedToSource] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IoArgoprojV1alpha1ApplicationStatusSyncComparedToSource? fromJson(
      dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoArgoprojV1alpha1ApplicationStatusSyncComparedToSource[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoArgoprojV1alpha1ApplicationStatusSyncComparedToSource[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoArgoprojV1alpha1ApplicationStatusSyncComparedToSource>
      listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <IoArgoprojV1alpha1ApplicationStatusSyncComparedToSource>[];
  ...
  static Map<String, IoArgoprojV1alpha1ApplicationStatusSyncComparedToSource>
      mapFromJson(dynamic json) {
    final map =
        <String, IoArgoprojV1alpha1ApplicationStatusSyncComparedToSource>{};
  ...
  // maps a json object with a list of IoArgoprojV1alpha1ApplicationStatusSyncComparedToSource-objects as value to a dart map
  static Map<String,
          List<IoArgoprojV1alpha1ApplicationStatusSyncComparedToSource>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = IoArgoprojV1alpha1ApplicationStatusSyncComparedToSource
            .listFromJson(
          entry.value,
          growable: growable,
        );
