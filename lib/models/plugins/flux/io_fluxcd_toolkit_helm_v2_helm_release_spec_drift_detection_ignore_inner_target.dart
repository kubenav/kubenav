...
class IoFluxcdToolkitHelmV2HelmReleaseSpecDriftDetectionIgnoreInnerTarget {
  /// Returns a new [IoFluxcdToolkitHelmV2HelmReleaseSpecDriftDetectionIgnoreInnerTarget] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is IoFluxcdToolkitHelmV2HelmReleaseSpecDriftDetectionIgnoreInnerTarget &&
  ...
  @override
  String toString() =>
      'IoFluxcdToolkitHelmV2HelmReleaseSpecDriftDetectionIgnoreInnerTarget[annotationSelector=$annotationSelector, group=$group, kind=$kind, labelSelector=$labelSelector, name=$name, namespace=$namespace, version=$version]';
  ...
  /// Returns a new [IoFluxcdToolkitHelmV2HelmReleaseSpecDriftDetectionIgnoreInnerTarget] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IoFluxcdToolkitHelmV2HelmReleaseSpecDriftDetectionIgnoreInnerTarget?
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoFluxcdToolkitHelmV2HelmReleaseSpecDriftDetectionIgnoreInnerTarget[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoFluxcdToolkitHelmV2HelmReleaseSpecDriftDetectionIgnoreInnerTarget[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoFluxcdToolkitHelmV2HelmReleaseSpecDriftDetectionIgnoreInnerTarget(
  ...
  // maps a json object with a list of IoFluxcdToolkitHelmV2HelmReleaseSpecDriftDetectionIgnoreInnerTarget-objects as value to a dart map
  static Map<
          String,
          List<
              IoFluxcdToolkitHelmV2HelmReleaseSpecDriftDetectionIgnoreInnerTarget>>
