...
class IoFluxcdToolkitHelmV2HelmReleaseSpecPostRenderersInnerKustomizePatchesInnerTarget {
  /// Returns a new [IoFluxcdToolkitHelmV2HelmReleaseSpecPostRenderersInnerKustomizePatchesInnerTarget] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is IoFluxcdToolkitHelmV2HelmReleaseSpecPostRenderersInnerKustomizePatchesInnerTarget &&
  ...
  @override
  String toString() =>
      'IoFluxcdToolkitHelmV2HelmReleaseSpecPostRenderersInnerKustomizePatchesInnerTarget[annotationSelector=$annotationSelector, group=$group, kind=$kind, labelSelector=$labelSelector, name=$name, namespace=$namespace, version=$version]';
  ...
  /// Returns a new [IoFluxcdToolkitHelmV2HelmReleaseSpecPostRenderersInnerKustomizePatchesInnerTarget] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IoFluxcdToolkitHelmV2HelmReleaseSpecPostRenderersInnerKustomizePatchesInnerTarget?
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoFluxcdToolkitHelmV2HelmReleaseSpecPostRenderersInnerKustomizePatchesInnerTarget[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoFluxcdToolkitHelmV2HelmReleaseSpecPostRenderersInnerKustomizePatchesInnerTarget[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoFluxcdToolkitHelmV2HelmReleaseSpecPostRenderersInnerKustomizePatchesInnerTarget(
  ...
  // maps a json object with a list of IoFluxcdToolkitHelmV2HelmReleaseSpecPostRenderersInnerKustomizePatchesInnerTarget-objects as value to a dart map
  static Map<
          String,
          List<
              IoFluxcdToolkitHelmV2HelmReleaseSpecPostRenderersInnerKustomizePatchesInnerTarget>>
