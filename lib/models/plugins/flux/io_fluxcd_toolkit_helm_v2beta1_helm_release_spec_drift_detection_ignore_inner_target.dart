...
class IoFluxcdToolkitHelmV2beta1HelmReleaseSpecDriftDetectionIgnoreInnerTarget {
  /// Returns a new [IoFluxcdToolkitHelmV2beta1HelmReleaseSpecDriftDetectionIgnoreInnerTarget] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is IoFluxcdToolkitHelmV2beta1HelmReleaseSpecDriftDetectionIgnoreInnerTarget &&
  ...
  @override
  String toString() =>
      'IoFluxcdToolkitHelmV2beta1HelmReleaseSpecDriftDetectionIgnoreInnerTarget[annotationSelector=$annotationSelector, group=$group, kind=$kind, labelSelector=$labelSelector, name=$name, namespace=$namespace, version=$version]';
  ...
  /// Returns a new [IoFluxcdToolkitHelmV2beta1HelmReleaseSpecDriftDetectionIgnoreInnerTarget] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IoFluxcdToolkitHelmV2beta1HelmReleaseSpecDriftDetectionIgnoreInnerTarget?
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoFluxcdToolkitHelmV2beta1HelmReleaseSpecDriftDetectionIgnoreInnerTarget[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoFluxcdToolkitHelmV2beta1HelmReleaseSpecDriftDetectionIgnoreInnerTarget[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoFluxcdToolkitHelmV2beta1HelmReleaseSpecDriftDetectionIgnoreInnerTarget(
  ...
  // maps a json object with a list of IoFluxcdToolkitHelmV2beta1HelmReleaseSpecDriftDetectionIgnoreInnerTarget-objects as value to a dart map
  static Map<
          String,
          List<
              IoFluxcdToolkitHelmV2beta1HelmReleaseSpecDriftDetectionIgnoreInnerTarget>>
