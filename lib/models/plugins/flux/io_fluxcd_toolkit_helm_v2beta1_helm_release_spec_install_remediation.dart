...
class IoFluxcdToolkitHelmV2beta1HelmReleaseSpecInstallRemediation {
  /// Returns a new [IoFluxcdToolkitHelmV2beta1HelmReleaseSpecInstallRemediation] instance.
  IoFluxcdToolkitHelmV2beta1HelmReleaseSpecInstallRemediation({
  ...
  bool operator ==(Object other) =>
      ...
      other is IoFluxcdToolkitHelmV2beta1HelmReleaseSpecInstallRemediation &&
  ...
  @override
  String toString() =>
      'IoFluxcdToolkitHelmV2beta1HelmReleaseSpecInstallRemediation[ignoreTestFailures=$ignoreTestFailures, remediateLastFailure=$remediateLastFailure, retries=$retries]';
  ...
  /// Returns a new [IoFluxcdToolkitHelmV2beta1HelmReleaseSpecInstallRemediation] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IoFluxcdToolkitHelmV2beta1HelmReleaseSpecInstallRemediation? fromJson(
      dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoFluxcdToolkitHelmV2beta1HelmReleaseSpecInstallRemediation[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoFluxcdToolkitHelmV2beta1HelmReleaseSpecInstallRemediation[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoFluxcdToolkitHelmV2beta1HelmReleaseSpecInstallRemediation(
  ...
  static List<IoFluxcdToolkitHelmV2beta1HelmReleaseSpecInstallRemediation>
      listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String,
    ...
    final map =
        <String, IoFluxcdToolkitHelmV2beta1HelmReleaseSpecInstallRemediation>{};
  ...
  // maps a json object with a list of IoFluxcdToolkitHelmV2beta1HelmReleaseSpecInstallRemediation-objects as value to a dart map
  static Map<String,
          List<IoFluxcdToolkitHelmV2beta1HelmReleaseSpecInstallRemediation>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
