...
class IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback {
  /// Returns a new [IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback] instance.
  IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback({
    this.cleanupOnFail,
    this.disableHooks,
    this.disableWait,
  ...
  bool operator ==(Object other) =>
      ...
      other is IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback &&
  ...
  @override
  String toString() =>
      'IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback[cleanupOnFail=$cleanupOnFail, disableHooks=$disableHooks, disableWait=$disableWait, disableWaitForJobs=$disableWaitForJobs, force=$force, recreate=$recreate, timeout=$timeout]';
  ...
  /// Returns a new [IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback? fromJson(
      dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback(
  ...
  static List<IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value =
            IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback>
      mapFromJson(dynamic json) {
    final map = <String, IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value =
            IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback.fromJson(
                entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
  ...
  // maps a json object with a list of IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback-objects as value to a dart map
  static Map<String, List<IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map =
        <String, List<IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] =
            IoFluxcdToolkitHelmV2beta1HelmReleaseSpecRollback.listFromJson(
          entry.value,
          growable: growable,
        );
      }
