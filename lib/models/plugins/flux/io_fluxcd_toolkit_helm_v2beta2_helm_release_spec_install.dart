...
class IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall {
  /// Returns a new [IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall] instance.
  IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall({
    this.crds,
  ...
  IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum? crds;
  ...
  bool operator ==(Object other) =>
      ...
      other is IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall &&
          other.crds == crds &&
  ...
  /// Returns a new [IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall? fromJson(
      dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall(
        crds: IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum.fromJson(
            json[r'crds']),
  ...
  static List<IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value =
            IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall>
      mapFromJson(dynamic json) {
    final map = <String, IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall.fromJson(
            entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
  ...
  // maps a json object with a list of IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall-objects as value to a dart map
  static Map<String, List<IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map =
        <String, List<IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] =
            IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstall.listFromJson(
          entry.value,
          growable: growable,
        );
      }
...
/// CRDs upgrade CRDs from the Helm Chart's crds directory according to the CRD upgrade policy provided here. Valid values are `Skip`, `Create` or `CreateReplace`. Default is `Create` and if omitted CRDs are installed but not updated.   Skip: do neither install nor replace (update) any CRDs.   Create: new CRDs are created, existing CRDs are neither updated nor deleted.   CreateReplace: new CRDs are created, existing CRDs are updated (replaced) but not deleted.   By default, CRDs are applied (installed) during Helm install action. With this option users can opt in to CRD replace existing CRDs on Helm install actions, which is not (yet) natively supported by Helm. https://helm.sh/docs/chart_best_practices/custom_resource_definitions.
class IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum {
  /// Instantiate a new enum with the provided [value].
  const IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum._(this.value);
  ...
  static const skip =
      IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum._(r'Skip');
  static const create =
      IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum._(r'Create');
  static const createReplace =
      IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum._(
          r'CreateReplace');

  /// List of all possible values in this [enum][IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum].
  static const values =
      <IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum>[
    skip,
    create,
    createReplace,
  ];

  static IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum? fromJson(
          dynamic value) =>
      IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnumTypeTransformer()
          .decode(value);

  static List<IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum>
      listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value =
            IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum.fromJson(
                row);
        if (value != null) {
          result.add(value);
        }
...
/// Transformation class that can [encode] an instance of [IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum] to String,
/// and [decode] dynamic data back to [IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum].
class IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnumTypeTransformer {
  factory IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnumTypeTransformer() =>
      _instance ??=
          const IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnumTypeTransformer
              ._();

  const IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnumTypeTransformer._();

  String encode(
          IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum data) =>
      data.value;

  /// Decodes a [dynamic value][data] to a IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum.
  ///
  ...
  IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum? decode(dynamic data,
      {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'Skip':
          return IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum.skip;
        case r'Create':
          return IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnum
              .create;
  ...
  /// Singleton [IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnumTypeTransformer] instance.
  static IoFluxcdToolkitHelmV2beta2HelmReleaseSpecInstallCrdsEnumTypeTransformer?
      _instance;
}
