...
class IoFluxcdToolkitHelmV2beta2HelmReleaseSpecPostRenderersInnerKustomize {
  /// Returns a new [IoFluxcdToolkitHelmV2beta2HelmReleaseSpecPostRenderersInnerKustomize] instance.
  ...
  bool operator ==(Object other) =>
      ...
      other is IoFluxcdToolkitHelmV2beta2HelmReleaseSpecPostRenderersInnerKustomize &&
  ...
  @override
  String toString() =>
      'IoFluxcdToolkitHelmV2beta2HelmReleaseSpecPostRenderersInnerKustomize[images=$images, patches=$patches, patchesJson6902=$patchesJson6902, patchesStrategicMerge=$patchesStrategicMerge]';
  ...
  /// Returns a new [IoFluxcdToolkitHelmV2beta2HelmReleaseSpecPostRenderersInnerKustomize] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IoFluxcdToolkitHelmV2beta2HelmReleaseSpecPostRenderersInnerKustomize?
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoFluxcdToolkitHelmV2beta2HelmReleaseSpecPostRenderersInnerKustomize[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoFluxcdToolkitHelmV2beta2HelmReleaseSpecPostRenderersInnerKustomize[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoFluxcdToolkitHelmV2beta2HelmReleaseSpecPostRenderersInnerKustomize(
        images:
  ...
  // maps a json object with a list of IoFluxcdToolkitHelmV2beta2HelmReleaseSpecPostRenderersInnerKustomize-objects as value to a dart map
  static Map<
          String,
          List<
              IoFluxcdToolkitHelmV2beta2HelmReleaseSpecPostRenderersInnerKustomize>>
