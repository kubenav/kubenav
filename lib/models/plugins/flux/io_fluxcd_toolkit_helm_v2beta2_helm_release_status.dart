...
class IoFluxcdToolkitHelmV2beta2HelmReleaseStatus {
  /// Returns a new [IoFluxcdToolkitHelmV2beta2HelmReleaseStatus] instance.
  IoFluxcdToolkitHelmV2beta2HelmReleaseStatus({
  ...
  IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnum?
  ...
  bool operator ==(Object other) =>
      ...
      other is IoFluxcdToolkitHelmV2beta2HelmReleaseStatus &&
  ...
  @override
  String toString() =>
      'IoFluxcdToolkitHelmV2beta2HelmReleaseStatus[conditions=$conditions, failures=$failures, helmChart=$helmChart, history=$history, installFailures=$installFailures, lastAppliedRevision=$lastAppliedRevision, lastAttemptedConfigDigest=$lastAttemptedConfigDigest, lastAttemptedGeneration=$lastAttemptedGeneration, lastAttemptedReleaseAction=$lastAttemptedReleaseAction, lastAttemptedRevision=$lastAttemptedRevision, lastAttemptedRevisionDigest=$lastAttemptedRevisionDigest, lastAttemptedValuesChecksum=$lastAttemptedValuesChecksum, lastHandledForceAt=$lastHandledForceAt, lastHandledReconcileAt=$lastHandledReconcileAt, lastHandledResetAt=$lastHandledResetAt, lastReleaseRevision=$lastReleaseRevision, observedGeneration=$observedGeneration, observedPostRenderersDigest=$observedPostRenderersDigest, storageNamespace=$storageNamespace, upgradeFailures=$upgradeFailures]';
  ...
  /// Returns a new [IoFluxcdToolkitHelmV2beta2HelmReleaseStatus] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IoFluxcdToolkitHelmV2beta2HelmReleaseStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoFluxcdToolkitHelmV2beta2HelmReleaseStatus[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoFluxcdToolkitHelmV2beta2HelmReleaseStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoFluxcdToolkitHelmV2beta2HelmReleaseStatus> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <IoFluxcdToolkitHelmV2beta2HelmReleaseStatus>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IoFluxcdToolkitHelmV2beta2HelmReleaseStatus.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IoFluxcdToolkitHelmV2beta2HelmReleaseStatus> mapFromJson(
      dynamic json) {
    final map = <String, IoFluxcdToolkitHelmV2beta2HelmReleaseStatus>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value =
            IoFluxcdToolkitHelmV2beta2HelmReleaseStatus.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IoFluxcdToolkitHelmV2beta2HelmReleaseStatus-objects as value to a dart map
  static Map<String, List<IoFluxcdToolkitHelmV2beta2HelmReleaseStatus>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map = <String, List<IoFluxcdToolkitHelmV2beta2HelmReleaseStatus>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] =
            IoFluxcdToolkitHelmV2beta2HelmReleaseStatus.listFromJson(
          entry.value,
          growable: growable,
        );
      }
...
/// LastAttemptedReleaseAction is the last release action performed for this HelmRelease. It is used to determine the active remediation strategy.
class IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnum {
  /// Instantiate a new enum with the provided [value].
  const IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnum._(
      this.value);
  ...
  /// List of all possible values in this [enum][IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnum].
  static const values =
      <IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnum>[
    install,
    upgrade,
  ...
  static IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnum?
      fromJson(dynamic value) =>
          IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnumTypeTransformer()
              .decode(value);
...
/// Transformation class that can [encode] an instance of [IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnum] to String,
/// and [decode] dynamic data back to [IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnum].
class IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnumTypeTransformer {
  factory IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnumTypeTransformer() =>
      _instance ??=
          const IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnumTypeTransformer
              ._();

  const IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnumTypeTransformer._();
  ...
  /// Decodes a [dynamic value][data] to a IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnum.
  ///
  ...
  IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnum?
    ...
    if (data != null) {
      switch (data) {
        case r'install':
          return IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnum
              .install;
        case r'upgrade':
          return IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnum
              .upgrade;
  ...
  /// Singleton [IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnumTypeTransformer] instance.
  static IoFluxcdToolkitHelmV2beta2HelmReleaseStatusLastAttemptedReleaseActionEnumTypeTransformer?
      _instance;
}
