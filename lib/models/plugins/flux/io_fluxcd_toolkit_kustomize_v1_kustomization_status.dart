...
class IoFluxcdToolkitKustomizeV1KustomizationStatus {
  /// Returns a new [IoFluxcdToolkitKustomizeV1KustomizationStatus] instance.
  IoFluxcdToolkitKustomizeV1KustomizationStatus({
  ...
  ///
  IoFluxcdToolkitKustomizeV1KustomizationStatusInventory? inventory;
  ...
  bool operator ==(Object other) =>
      ...
      other is IoFluxcdToolkitKustomizeV1KustomizationStatus &&
  ...
  @override
  String toString() =>
      'IoFluxcdToolkitKustomizeV1KustomizationStatus[conditions=$conditions, inventory=$inventory, lastAppliedRevision=$lastAppliedRevision, lastAttemptedRevision=$lastAttemptedRevision, lastHandledReconcileAt=$lastHandledReconcileAt, observedGeneration=$observedGeneration]';
  ...
  /// Returns a new [IoFluxcdToolkitKustomizeV1KustomizationStatus] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IoFluxcdToolkitKustomizeV1KustomizationStatus? fromJson(
      dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoFluxcdToolkitKustomizeV1KustomizationStatus[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoFluxcdToolkitKustomizeV1KustomizationStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<IoFluxcdToolkitKustomizeV1KustomizationStatus> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <IoFluxcdToolkitKustomizeV1KustomizationStatus>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value =
            IoFluxcdToolkitKustomizeV1KustomizationStatus.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IoFluxcdToolkitKustomizeV1KustomizationStatus> mapFromJson(
      dynamic json) {
    final map = <String, IoFluxcdToolkitKustomizeV1KustomizationStatus>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value =
            IoFluxcdToolkitKustomizeV1KustomizationStatus.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IoFluxcdToolkitKustomizeV1KustomizationStatus-objects as value to a dart map
  static Map<String, List<IoFluxcdToolkitKustomizeV1KustomizationStatus>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map = <String, List<IoFluxcdToolkitKustomizeV1KustomizationStatus>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] =
            IoFluxcdToolkitKustomizeV1KustomizationStatus.listFromJson(
          entry.value,
          growable: growable,
        );
      }
