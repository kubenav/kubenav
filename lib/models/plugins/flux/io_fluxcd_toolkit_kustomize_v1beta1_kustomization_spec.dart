...
import 'package:kubenav/models/plugins/flux/io_fluxcd_toolkit_kustomize_v1beta1_kustomization_spec_kube_config.dart';
import 'package:kubenav/models/plugins/flux/io_fluxcd_toolkit_kustomize_v1beta1_kustomization_spec_post_build.dart';
import 'package:kubenav/models/plugins/flux/io_fluxcd_toolkit_kustomize_v1beta1_kustomization_spec_source_ref.dart';

class IoFluxcdToolkitKustomizeV1beta1KustomizationSpec {
  /// Returns a new [IoFluxcdToolkitKustomizeV1beta1KustomizationSpec] instance.
  IoFluxcdToolkitKustomizeV1beta1KustomizationSpec({
    this.decryption,
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  IoFluxcdToolkitKustomizeV1beta1KustomizationSpecKubeConfig? kubeConfig;
  ...
  /// Consider adding a "default:" property in the specification file to hide this note.
  ///
  IoFluxcdToolkitKustomizeV1beta1KustomizationSpecPostBuild? postBuild;
  ...
  IoFluxcdToolkitKustomizeV1beta1KustomizationSpecSourceRef sourceRef;
  ...
  IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnum? validation;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is IoFluxcdToolkitKustomizeV1beta1KustomizationSpec &&
  ...
  @override
  String toString() =>
      'IoFluxcdToolkitKustomizeV1beta1KustomizationSpec[decryption=$decryption, dependsOn=$dependsOn, force=$force, healthChecks=$healthChecks, images=$images, interval=$interval, kubeConfig=$kubeConfig, patches=$patches, patchesJson6902=$patchesJson6902, patchesStrategicMerge=$patchesStrategicMerge, path=$path, postBuild=$postBuild, prune=$prune, retryInterval=$retryInterval, serviceAccountName=$serviceAccountName, sourceRef=$sourceRef, suspend=$suspend, targetNamespace=$targetNamespace, timeout=$timeout, validation=$validation]';
  ...
  /// Returns a new [IoFluxcdToolkitKustomizeV1beta1KustomizationSpec] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IoFluxcdToolkitKustomizeV1beta1KustomizationSpec? fromJson(
      dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoFluxcdToolkitKustomizeV1beta1KustomizationSpec[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoFluxcdToolkitKustomizeV1beta1KustomizationSpec[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoFluxcdToolkitKustomizeV1beta1KustomizationSpec(
        decryption:
        ...
        sourceRef:
            IoFluxcdToolkitKustomizeV1beta1KustomizationSpecSourceRef.fromJson(
                json[r'sourceRef'])!,
        ...
        validation:
            IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnum
  ...
  static List<IoFluxcdToolkitKustomizeV1beta1KustomizationSpec> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <IoFluxcdToolkitKustomizeV1beta1KustomizationSpec>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value =
            IoFluxcdToolkitKustomizeV1beta1KustomizationSpec.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IoFluxcdToolkitKustomizeV1beta1KustomizationSpec>
      mapFromJson(dynamic json) {
    final map = <String, IoFluxcdToolkitKustomizeV1beta1KustomizationSpec>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = IoFluxcdToolkitKustomizeV1beta1KustomizationSpec.fromJson(
            entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
  ...
  // maps a json object with a list of IoFluxcdToolkitKustomizeV1beta1KustomizationSpec-objects as value to a dart map
  static Map<String, List<IoFluxcdToolkitKustomizeV1beta1KustomizationSpec>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map =
        <String, List<IoFluxcdToolkitKustomizeV1beta1KustomizationSpec>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] =
            IoFluxcdToolkitKustomizeV1beta1KustomizationSpec.listFromJson(
          entry.value,
          growable: growable,
        );
      }
...
/// Validate the Kubernetes objects before applying them on the cluster. The validation strategy can be 'client' (local dry-run), 'server' (APIServer dry-run) or 'none'. When 'Force' is 'true', validation will fallback to 'client' if set to 'server' because server-side validation is not supported in this scenario.
class IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnum {
  /// Instantiate a new enum with the provided [value].
  const IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnum._(
      this.value);
  ...
  static const none =
      IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnum._(r'none');
  static const client =
      IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnum._(
          r'client');
  static const server =
      IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnum._(
          r'server');

  /// List of all possible values in this [enum][IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnum].
  static const values =
      <IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnum>[
    none,
    client,
  ...
  static IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnum? fromJson(
          dynamic value) =>
      IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnumTypeTransformer()
          .decode(value);

  static List<IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnum>
      listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
...
/// Transformation class that can [encode] an instance of [IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnum] to String,
/// and [decode] dynamic data back to [IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnum].
class IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnumTypeTransformer {
  factory IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnumTypeTransformer() =>
      _instance ??=
          const IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnumTypeTransformer
              ._();

  const IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnumTypeTransformer._();
  ...
  /// Decodes a [dynamic value][data] to a IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnum.
  ///
  ...
  IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnum? decode(
      dynamic data,
      {bool allowNull = true}) {
    if (data != null) {
      switch (data) {
        case r'none':
          return IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnum
              .none;
        case r'client':
          return IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnum
              .client;
  ...
  /// Singleton [IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnumTypeTransformer] instance.
  static IoFluxcdToolkitKustomizeV1beta1KustomizationSpecValidationEnumTypeTransformer?
      _instance;
}
