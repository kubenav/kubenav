...
import 'package:kubenav/models/plugins/flux/io_fluxcd_toolkit_source_v1beta2_helm_chart_status_artifact.dart';

class IoFluxcdToolkitSourceV1beta2HelmChartStatus {
  /// Returns a new [IoFluxcdToolkitSourceV1beta2HelmChartStatus] instance.
  IoFluxcdToolkitSourceV1beta2HelmChartStatus({
    this.artifact,
  ...
  ///
  IoFluxcdToolkitSourceV1beta2HelmChartStatusArtifact? artifact;
  ...
  bool operator ==(Object other) =>
      ...
      other is IoFluxcdToolkitSourceV1beta2HelmChartStatus &&
  ...
  @override
  String toString() =>
      'IoFluxcdToolkitSourceV1beta2HelmChartStatus[artifact=$artifact, conditions=$conditions, lastHandledReconcileAt=$lastHandledReconcileAt, observedChartName=$observedChartName, observedGeneration=$observedGeneration, observedSourceArtifactRevision=$observedSourceArtifactRevision, url=$url]';
  ...
  /// Returns a new [IoFluxcdToolkitSourceV1beta2HelmChartStatus] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static IoFluxcdToolkitSourceV1beta2HelmChartStatus? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "IoFluxcdToolkitSourceV1beta2HelmChartStatus[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "IoFluxcdToolkitSourceV1beta2HelmChartStatus[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return IoFluxcdToolkitSourceV1beta2HelmChartStatus(
        artifact: IoFluxcdToolkitSourceV1beta2HelmChartStatusArtifact.fromJson(
            json[r'artifact']),
  ...
  static List<IoFluxcdToolkitSourceV1beta2HelmChartStatus> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final result = <IoFluxcdToolkitSourceV1beta2HelmChartStatus>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = IoFluxcdToolkitSourceV1beta2HelmChartStatus.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, IoFluxcdToolkitSourceV1beta2HelmChartStatus> mapFromJson(
      dynamic json) {
    final map = <String, IoFluxcdToolkitSourceV1beta2HelmChartStatus>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value =
            IoFluxcdToolkitSourceV1beta2HelmChartStatus.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of IoFluxcdToolkitSourceV1beta2HelmChartStatus-objects as value to a dart map
  static Map<String, List<IoFluxcdToolkitSourceV1beta2HelmChartStatus>>
      mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    final map = <String, List<IoFluxcdToolkitSourceV1beta2HelmChartStatus>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] =
            IoFluxcdToolkitSourceV1beta2HelmChartStatus.listFromJson(
          entry.value,
          growable: growable,
        );
      }
