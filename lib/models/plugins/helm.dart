...
class Info {
  ...
  factory Info.fromJson(Map<String, dynamic> data) {
    return Info(
      firstDeployed: data.containsKey('first_deployed')
          ? data['first_deployed']
          : null,
      lastDeployed: data.containsKey('last_deployed')
          ? data['last_deployed']
          : null,
...
class Metadata {
  ...
  Metadata({required this.version, required this.appVersion});
  ...
  Map<String, dynamic> toJson() {
    return {'version': version, 'appVersion': appVersion};
  }
}
...
class File {
  ...
  File({required this.name, required this.data});
