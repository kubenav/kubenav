...
final Resource fluxResourceGitRepository = Resource(
  ...
  decodeListData: (ResourcesListData data) {
    ...
    final items = GitrepositorylistSourceV1.fromJson(parsed).items;
  ...
  decodeList: (String data) {
    ...
    return GitrepositorylistSourceV1.fromJson(parsed).items;
  },
          ...
          children: [
            ...
            DetailsItem(
              ...
              details: [
                ...
                DetailsItemModel(name: 'Name', values: item.spec?.ref?.name),
                DetailsItemModel(
                  name: 'Commit',
