...
final Resource fluxResourceHelmRepository = Resource(
  ...
  decodeListData: (ResourcesListData data) {
    ...
    final items = HelmrepositorylistSourceV1.fromJson(parsed).items;
  ...
  decodeList: (String data) {
    ...
    return HelmrepositorylistSourceV1.fromJson(parsed).items;
  },
