...
/// The [ShowYaml] widget is used to show the yaml or json representation of the
/// provided [item]. The [item] is encoded with the [encodeItem] function and
/// displayed in a [CodeField] widget. The user can export the manifest as json
/// or yaml file with the name of the resource.
class ShowYaml extends StatefulWidget {
  const ShowYaml({
    super.key,
    required this.name,
  ...
  final dynamic item;
  final String Function(dynamic item) encodeItem;

  @override
  State<ShowYaml> createState() => _ShowYamlState();
}

class _ShowYamlState extends State<ShowYaml> {
