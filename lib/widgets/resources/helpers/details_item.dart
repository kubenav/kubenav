...
/// [DetailsItemModel] is the structure of a single item in the [DetailsItem].
/// Each item requires a [name] and a [values] parameter. The [values] parameter
/// can be of type `String` or a `List<String>`. The optional [onTap] function
/// can be used to overwrite the behaviour of what happens when the user clicks
/// on a value. It returns the `index` of the value which was clicked.
...
/// [DetailsItem] is a widget which can be used to render a list of  details for
/// a resource. It takes a list of [details] which are of type
