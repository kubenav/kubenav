...
import 'package:kubenav/models/kubernetes/rolebindinglist_rbac_v1.dart';
...
final resourceRoleBinding = Resource(
  ...
  decodeListData: (ResourcesListData data) {
    ...
    final items = RolebindinglistRbacV1.fromJson(parsed).items;
  ...
  decodeList: (String data) {
    ...
    return RolebindinglistRbacV1.fromJson(parsed).items;
  },
