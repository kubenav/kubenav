...
import 'package:kubenav/models/kubernetes/rolelist_rbac_v1.dart';
...
final resourceRole = Resource(
  ...
  decodeListData: (ResourcesListData data) {
    ...
    final items = RolelistRbacV1.fromJson(parsed).items;
  ...
  decodeList: (String data) {
    ...
    return RolelistRbacV1.fromJson(parsed).items;
  },
