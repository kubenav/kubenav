...
import 'package:kubenav/models/kubernetes/serviceaccountlist_v1.dart';
...
final resourceServiceAccount = Resource(
  ...
  decodeListData: (ResourcesListData data) {
    ...
    final items = ServiceaccountlistV1.fromJson(parsed).items;
  ...
  decodeList: (String data) {
    ...
    return ServiceaccountlistV1.fromJson(parsed).items;
  },
