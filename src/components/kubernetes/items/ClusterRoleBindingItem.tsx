...
interface ClusterRoleBindingItemProps extends RouteComponentProps {
  item: V1ClusterRoleBinding;
  section: string;
  type: string;
}

const ClusterRoleBindingItem: React.FunctionComponent<ClusterRoleBindingItemProps> = ({ item, section, type }) => {
  return (
