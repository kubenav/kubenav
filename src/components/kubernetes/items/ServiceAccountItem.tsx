...
interface ServiceAccountItemProps extends RouteComponentProps {
  item: V1ServiceAccount;
  section: string;
  type: string;
}

const ServiceAccountItem: React.FunctionComponent<ServiceAccountItemProps> = ({ item, section, type }) => {
  return (
