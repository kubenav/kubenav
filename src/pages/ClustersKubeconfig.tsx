...
interface IClustersKubeconfigProps extends RouteComponentProps {}

const ClustersKubeconfig: React.FunctionComponent<IClustersKubeconfigProps> = ({ history }) => {
...
export default ClustersKubeconfig;
