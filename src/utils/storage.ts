...
// readAWSTokens returns the tokens required for API requests against AWS.
...
// readCluster returns the saved active cluster from localStorage.
...
// readClusters returns the saved clusters from localStorage.
...
// readGoogleClientID returns the Google client id from localStorage.
...
// saveGoogleTokens saves the returned Google tokens for authenticated API requests to the localStorage.
